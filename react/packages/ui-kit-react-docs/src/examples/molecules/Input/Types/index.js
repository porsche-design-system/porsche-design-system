    ...
    return (
        <ExampleSection title="Types">
            ...
            <ComponentExample
                ...
                examplePath="molecules/Input/Types/InputExampleTypesIcon"
            >
            An input can show an icon on the right.
            </ComponentExample>

            <ComponentExample
                title="Input with Unit"
                examplePath="molecules/Input/Types/InputExampleTypesUnit"
            >
            An input can show a unit on the right, if an icon is not shown. You should probably use <code>basic</code> together with a unit since it aligns much better.
            </ComponentExample>

            <ComponentExample
                title="Disabled"
                examplePath="molecules/Input/Types/InputExampleTypesDisabled"
            >
            ...
            <ComponentExample
                title="Error"
                examplePath="molecules/Input/Types/InputExampleTypesError"
            >
