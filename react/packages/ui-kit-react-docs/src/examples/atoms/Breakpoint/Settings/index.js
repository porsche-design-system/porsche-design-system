...
const Types = () => {
    return (
        <ExampleSection title="Settings">
            ...
            >
        You can use <code>minWidth</code> to render children starting from a specific breakpoint. If you don't see text below try and resize your browser.
            </ComponentExample>
            ...
            >
        You can use <code>maxWidth</code> to render children up to a specific breakpoint. If you don't see text below try and resize your browser.
            </ComponentExample>
