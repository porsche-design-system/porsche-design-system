...
var NavigationMobile = /** @class */ (function(_super) {
    ...
    function NavigationMobile() {
        ...
        _this.renderSectionRow = function(section) {
            ...
            return React.createElement(
                "li",
                { key: section.key, className: lib_1.prefix("nav-mobile__row") },
                React.createElement(
                    index_1.ContentWrapper,
                    { as: "div", className: lib_1.prefix("nav-mobile__item-wrapper") },
                    React.createElement(
                        LinkElementType,
                        tslib_1.__assign(
                            {
                                className: lib_1.prefix("nav-mobile__item"),
                                // tslint:disable-next-line jsx-no-lambda
                                onClick: function() {
                                    return _this.setState({ openedSectionKey: section.key })
                                }
                            },
                            section.props
                        ),
                        ...
                        React.createElement(
                            ...
                            React.createElement(index_1.Icon, {
                                ...
                                className: lib_1.prefix("nav-mobile__icon")
                            })
                        )
                    )
                ),
                section && _this.renderSectionOverlay(section)
            )
        }
        ...
        _this.renderSectionOverlay = function(section) {
            var classesOverlay = classnames_1.default(
                lib_1.prefix("nav-mobile__overlay"),
                _this.state.openedSectionKey === section.key ? lib_1.prefix("nav-mobile__overlay--active") : null
            )
            return React.createElement(
                "div",
                ...
                React.createElement(
                    index_1.ContentWrapper,
                    { as: "div", className: lib_1.prefix("nav-mobile__bgtop") },
                    React.createElement(
                        index_1.Flex,
                        tslib_1.__assign(
                            {
                                ...
                                className: lib_1.prefix("nav-mobile__top")
                            },
                            {
    ...
    NavigationMobile.prototype.render = function() {
        ...
        return React.createElement(
            ...
            React.createElement(
                index_1.Flex,
                { className: lib_1.prefix("nav-mobile__bar"), alignMainAxis: "end" },
                React.createElement(
                    "button",
                    { className: lib_1.prefix("nav-mobile__trigger"), onClick: this.openNav },
                    "Menu"
                )
            ),
            React.createElement(
                "div",
                {
                    className: classnames_1.default(
                        className,
                        lib_1.prefix("nav-mobile__overlay"),
                        this.state.isOpened ? lib_1.prefix("nav-mobile__overlay--active") : null
                    )
                },
                React.createElement(
                    index_1.ContentWrapper,
