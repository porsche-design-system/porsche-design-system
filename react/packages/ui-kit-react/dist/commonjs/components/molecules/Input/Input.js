...
var _Input = function (props) {
    ...
    var labelClasses = classnames_1.default(lib_1.prefix("input"), className);
    var inputClasses = classnames_1.default(lib_1.prefix("input__field"), (_a = {}, _a[lib_1.prefix("input__field--has-value")] = !basic && value && value.length > 0, _a), (_b = {}, _b[lib_1.prefix("input__field--error")] = error, _b), (_c = {}, _c[lib_1.prefix("input__field--number")] = type === "number", _c), (_d = {}, _d[lib_1.prefix("input__field--no-label")] = basic, _d), (_e = {}, _e[lib_1.prefix("input__field--with-icon")] = !!icon, _e));
    var floatingPlaceholderClasses = classnames_1.default(lib_1.prefix("input__label"), (_f = {}, _f[lib_1.prefix("input__label--with-icon")] = !!icon, _f));
    var iconClasses = classnames_1.default(lib_1.prefix("input__icon"), (_g = {}, _g[lib_1.prefix("input__icon--error")] = error, _g));
