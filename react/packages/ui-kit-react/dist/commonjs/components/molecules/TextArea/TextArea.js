...
var _TextArea = function(props) {
    ...
    var inputFieldClasses = classnames_1.default(
        lib_1.prefix("text-area__field"),
        ((_a = {}), (_a[lib_1.prefix("text-area__field--has-value")] = !basic && value && value.length > 0), _a),
        ((_b = {}), (_b[lib_1.prefix("text-area__field--error")] = !!error), _b),
        ((_c = {}), (_c[lib_1.prefix("text-area__field--no-label")] = basic), _c)
    )
    var renderMaxLength = function(max) {
        return React.createElement(
            "span",
            { className: lib_1.prefix("text-area__max-length") },
    ...
    return React.createElement(
        ...
        React.createElement(
            "label",
            { className: lib_1.prefix("text-area") },
