...
var _FlexItem = function(props) {
    ...
    var classes = classnames_1.default(
        lib_1.prefix("flex__child"),
        ((_a = {}), (_a[lib_1.prefix("flex__child--cross-axis-" + alignCrossAxis)] = alignCrossAxis), _a),
        lib_1.mapBreakpointPropToClasses("flex__child--", width),
        lib_1.mapBreakpointPropToClasses("flex__child--offset-", offset),
        className
    )
