...
var _Spacing = function (props) {
    ...
    var classes = classnames_1.default((_a = {}, _a[lib_1.prefix("m--" + margin)] = margin, _a), (_b = {}, _b[lib_1.prefix("mt--" + marginTop)] = marginTop, _b), (_c = {}, _c[lib_1.prefix("ml--" + marginLeft)] = marginLeft, _c), (_d = {}, _d[lib_1.prefix("mb--" + marginBottom)] = marginBottom, _d), (_e = {}, _e[lib_1.prefix("mr--" + marginRight)] = marginRight, _e), (_f = {}, _f[lib_1.prefix("p--" + padding)] = padding, _f), (_g = {}, _g[lib_1.prefix("pt--" + paddingTop)] = paddingTop, _g), (_h = {}, _h[lib_1.prefix("pl--" + paddingLeft)] = paddingLeft, _h), (_j = {}, _j[lib_1.prefix("pb--" + paddingBottom)] = paddingBottom, _j), (_k = {}, _k[lib_1.prefix("pr--" + paddingRight)] = paddingRight, _k), className);
    if (React.Children.count(children) === 1 && !wrap) {
        ...
        return React.Children.map(children, function (child) {
            ...
            return (React.cloneElement(child, tslib_1.__assign({ className: classnames_1.default(className, classes) }, childRest)));
        })[0];
    }
    else {
