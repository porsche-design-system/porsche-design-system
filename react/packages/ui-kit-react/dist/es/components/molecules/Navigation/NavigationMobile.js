...
var NavigationMobile = /** @class */ (function(_super) {
    ...
    function NavigationMobile() {
        ...
        _this.renderSectionRow = function(section) {
            ...
            return React.createElement(
                "li",
                { key: section.key, className: prefix("nav-mobile__row") },
                React.createElement(
                    ContentWrapper,
                    { as: "div", className: prefix("nav-mobile__item-wrapper") },
                    React.createElement(
                        LinkElementType,
                        tslib_1.__assign(
                            {
                        ...
                        React.createElement(
                            ...
                            React.createElement(Icon, {
                                ...
                                className: prefix("nav-mobile__icon")
                            })
                        )
                    )
                ),
        ...
        _this.renderSectionOverlay = function(section) {
            var classesOverlay = cx(
                prefix("nav-mobile__overlay"),
                _this.state.openedSectionKey === section.key ? prefix("nav-mobile__overlay--active") : null
            )
            return React.createElement(
                "div",
                ...
                React.createElement(
                    ContentWrapper,
                    { as: "div", className: prefix("nav-mobile__bgtop") },
                    React.createElement(
                        Flex,
                        tslib_1.__assign(
                            { alignCrossAxis: "center", alignMainAxis: "center", className: prefix("nav-mobile__top") },
                            {
    ...
    NavigationMobile.prototype.render = function() {
        ...
        return React.createElement(
            ...
            React.createElement(
                Flex,
                { className: prefix("nav-mobile__bar"), alignMainAxis: "end" },
                React.createElement(
                    "button",
                    { className: prefix("nav-mobile__trigger"), onClick: this.openNav },
                    "Menu"
                )
            ),
            React.createElement(
