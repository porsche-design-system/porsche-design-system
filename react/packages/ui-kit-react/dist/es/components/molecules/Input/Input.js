...
var _Input = function(props) {
    ...
    var inputClasses = cx(
        prefix("input__field"),
        ((_a = {}), (_a[prefix("input__field--has-value")] = !basic && value && value.length > 0), _a),
        ((_b = {}), (_b[prefix("input__field--error")] = error), _b),
        ((_c = {}), (_c[prefix("input__field--number")] = type === "number"), _c),
        ((_d = {}), (_d[prefix("input__field--no-label")] = basic || placeholder === undefined), _d),
        ((_e = {}), (_e[prefix("input__field--with-icon")] = !!icon), _e)
    )
    var floatingPlaceholderClasses = cx(
        prefix("input__label"),
        ((_f = {}), (_f[prefix("input__label--with-icon")] = !!icon), _f)
    )
