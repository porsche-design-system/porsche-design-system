            ...
            return React.createElement(
                ...
                React.createElement(
                    ReactSelectPlus.default,
                    {
                        ...
                        className: cx(
                            ((_b = {}), (_b[prefix("select-is-basic")] = basic), _b),
                            ((_c = {}), (_c[prefix("select-is-error")] = !!error), _c),
                            ((_d = {}),
                            (_d[prefix("select-has-query")] = this.state.query && this.state.query.length > 0),
                            _d)
                        ),
                    ...
                    !basic && React.createElement("span", { className: prefix("Select-label") }, selectPlaceholder)
                )
            )
        }
        var _b, _c, _d
