    ...
    Select.prototype.render = function () {
        ...
        if (this.isMobile()) {
            return (React.createElement(Input, tslib_1.__assign({ className: className, basic: true, value: this.createCombinedLabelString(selectOptions), placeholder: placeholder || "Select…", icon: "arrow_down_hair", error: !!error, customAttributes: tslib_1.__assign({}, customAttributes, { onFocus: this.focusSelect, onTouchEnd: this.focusSelect, readOnly: true }) }, rest),
                React.createElement("select", { className: prefix("mobile-select"), value: this.getSelectedValues(selectOptions, !!multi), multiple: multi, ref: this.bindSelect, onChange: this.handleSelectChange }, selectOptions.map(function (o) {
                    if ("options" in o) {
            ...
            return (React.createElement(ReactSelectPlus.default, tslib_1.__assign({ arrowRenderer: SelectArrowRenderer, className: cx(className, (_b = {}, _b[prefix("select-is-error")] = !!error, _b), (_c = {}, _c[prefix("select-has-query")] = this.state.query && this.state.query.length > 0, _c)), onChange: this.handleChange, disabled: disabled, clearable: false, searchable: !!multi || !!searchable, options: selectOptions, value: selectValue, multi: multi, placeholder: placeholder, autosize: false, removeSelected: false, noResultsText: noResultsLabel || "", closeOnSelect: !multi, optionRenderer: (multi ? CheckboxOptionRenderer : undefined), onSelectResetsInput: !multi, onCloseResetsInput: true, joinValues: true, onInputChange: this.handleInputChange }, customAttributes, rest)));
        }
        var _b, _c;
    };
    Select.defaultProps = {
