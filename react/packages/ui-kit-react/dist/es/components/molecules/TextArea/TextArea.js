...
var _TextArea = function (props) {
    ...
    var labelClasses = cx(prefix("text-area"), className);
    var inputFieldClasses = cx(prefix("text-area__field"), (_a = {}, _a[prefix("text-area__field--has-value")] = !basic && value && value.length > 0, _a), (_b = {}, _b[prefix("text-area__field--error")] = !!error, _b), (_c = {}, _c[prefix("text-area__field--no-label")] = basic, _c));
    var renderMaxLength = function (max) {
        return (React.createElement("span", { className: prefix("text-area__max-length") },
