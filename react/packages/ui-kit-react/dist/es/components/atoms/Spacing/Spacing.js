...
var _Spacing = function(props) {
    ...
    var classes = cx(
        ((_a = {}), (_a[prefix("m--" + margin)] = margin), _a),
        ((_b = {}), (_b[prefix("mt--" + marginTop)] = marginTop), _b),
        ((_c = {}), (_c[prefix("ml--" + marginLeft)] = marginLeft), _c),
        ((_d = {}), (_d[prefix("mb--" + marginBottom)] = marginBottom), _d),
        ((_e = {}), (_e[prefix("mr--" + marginRight)] = marginRight), _e),
        ((_f = {}), (_f[prefix("p--" + padding)] = padding), _f),
        ((_g = {}), (_g[prefix("pt--" + paddingTop)] = paddingTop), _g),
        ((_h = {}), (_h[prefix("pl--" + paddingLeft)] = paddingLeft), _h),
        ((_j = {}), (_j[prefix("pb--" + paddingBottom)] = paddingBottom), _j),
        ((_k = {}), (_k[prefix("pr--" + paddingRight)] = paddingRight), _k),
        className
    )
    if (React.Children.count(children) === 1 && !wrap) {
        ...
        return React.Children.map(children, function(child) {
            ...
            return React.cloneElement(child, tslib_1.__assign({ className: cx(childrenClassName, classes) }, childRest))
        })[0]
    } else {
