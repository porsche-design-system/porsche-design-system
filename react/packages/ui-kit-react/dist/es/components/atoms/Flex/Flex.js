...
var _Flex = function (props) {
    ...
    var classes = cx(prefix("flex"), (_a = {}, _a[prefix("flex--inline")] = inline, _a), (_b = {}, _b[prefix("flex--direction-" + direction)] = direction, _b), (_c = {}, _c[prefix("flex--main-axis-" + alignMainAxis)] = alignMainAxis, _c), (_d = {}, _d[prefix("flex--cross-axis-" + alignCrossAxis)] = alignCrossAxis, _d), (_e = {}, _e[prefix("flex--align-lines-" + alignLines)] = alignLines, _e), (_f = {}, _f[prefix("m-nl--" + gap)] = gap && gap !== "grid", _f), (_g = {}, _g[prefix("m-nr--" + gap)] = gap && gap !== "grid", _g), (_h = {}, _h[prefix("flex--gap")] = gap && gap === "grid", _h), (_j = {}, _j[prefix("flex--wrap")] = wrap === true, _j), (_k = {}, _k[prefix("flex--nowrap")] = wrap === false, _k), (_l = {}, _l[prefix("flex--wrap-reverse")] = wrap === "reverse", _l), className);
    ...
    if (gap && React.Children.count(children) > 0) {
        augmentedChildren = React.Children.map(children, function (child) {
            ...
            return (React.cloneElement(child, tslib_1.__assign({ className: cx(className, (_b = {}, _b[prefix("pl--" + gap)] = gap && gap !== "grid", _b), (_c = {}, _c[prefix("pr--" + gap)] = gap && gap !== "grid", _c), (_d = {}, _d[prefix("flex__child--gap")] = gap && gap === "grid", _d)) }, childRest)));
            var _b, _c, _d;
        });
    }
