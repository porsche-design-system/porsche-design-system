...
var _FlexItem = function (props) {
    ...
    var classes = cx(prefix("flex__child"), (_a = {}, _a[prefix("flex__child--cross-axis-" + alignCrossAxis)] = alignCrossAxis, _a), mapBreakpointPropToClasses("flex__child--", width), mapBreakpointPropToClasses("flex__child--offset-", offset), className);
