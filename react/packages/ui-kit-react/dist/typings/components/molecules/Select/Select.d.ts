...
export declare class Select extends React.PureComponent<SelectProps, SelectState> {
     ...
     */
    hydrateOptions: (options: SelectOption[] | SelectOptionGroup[] | undefined, value: string | number | string[] | null | undefined) => HydratedSelectOption[] | HydratedSelectOptionGroup[];
    /**
