...
Update `.accessibility-audit-plan.json` → `manualChecklist` and the report (`references/report-template.md` → `accessibility-audit-report-{date}.md` in the project working directory).
