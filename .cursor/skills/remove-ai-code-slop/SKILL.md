...
- Format/lint: **`yarn lint`** and **`yarn format`** from repo root (Biome + Prettier for MD/MDX).
- After substantive component changes, **`yarn build:core-dependencies`** or full **`yarn build`** before cross-package
