...
# Link Tile (Component: p-link-tile)
...
export const metadata = {
  title: 'Link Tile - Porsche Design System',
  description:
    'Learn how to properly use the Link Tile component with best practices and guidelines for effective design and user experience.',
};
