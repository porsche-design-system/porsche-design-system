...
# Input Time (Component: p-input-time)
...
export const Example = () => {
  return (
    <>
      <PInputTime label="Some label" name="some-name"></PInputTime>
    </>
  )
}
```
...
export const metadata = {
  title: 'Input Time - Porsche Design System',
  description:
    'Learn how to properly use the Input Time component with best practices and guidelines for effective design and user experience.',
};
