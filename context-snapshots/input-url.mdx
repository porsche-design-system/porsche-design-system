...
# Input Url (Component: p-input-url)
...
export const metadata = {
  title: 'Input Url - Porsche Design System',
  description: 'Discover detailed examples and insights of the Input Url component.',
};
...
The `p-input-url` can be integrated into a form in two ways: **controlled** or **uncontrolled**, depending on your
needs.
...
In the **uncontrolled** approach, the input behaves similar to a native `<input type="url" />`, automatically managing
