...
export const CDN_BASE_PATH_META_ICONS = 'porsche-design-system/meta-icons'; // previously "metaicons"
export const CDN_BASE_PATH_MARQUE = 'porsche-design-system/marque';
export const CDN_BASE_PATH_STYLES = 'porsche-design-system/styles'; // previously "style"
