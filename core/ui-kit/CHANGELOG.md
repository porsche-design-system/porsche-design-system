...
## [Unreleased]
* Add font-display: swap to prevent flash of invisible text and therefore enhance perceived performance by showing the fallback font 

## [0.18.4] - 2019-04-02
### Bugfix
* Removed title tag on minified version of svg icons
* Fixed svgo path optimization of minified svg icons
