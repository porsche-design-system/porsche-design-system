...
| Tool | Configuration |
| ---- | ------------- |
| **Cursor** | `.cursor/rules/accessibility.mdc`, `.agents/skills/accessibility-audit/SKILL.md` |
| **GitHub Copilot** | `.github/instructions/accessibility.instructions.md`, `.agents/skills/accessibility-audit/SKILL.md` |
| **Claude Code** | `CLAUDE.md`, `.agents/skills/accessibility-audit/SKILL.md` |

Playwright MCP is configured **individually** in each developer's agent settings (not in this repo).

Storefront audit: `npm run start:storefront` → `http://localhost:3000`, then `/accessibility-audit` or follow `.agents/skills/accessibility-audit/SKILL.md`.
