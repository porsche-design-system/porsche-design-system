...
1. Run `./docker.sh run-test-snapshot --ui-kit-angular` (comin soon...)
...
### Publish
1. Switch to __packages/ui-kit-js directory__
1. Run `yarn publish` which will deploy the UI Kit JS artifact to the Artifactory repository.
1. Switch to __packages/ui-kit-react directory__
1. Run `yarn publish` which will deploy the UI Kit React artifact to the Artifactory repository.
1. Switch to __packages/ui-kit-angular directory__
1. Run `yarn publish` which will deploy the UI Kit Angular artifact to the Artifactory repository.
