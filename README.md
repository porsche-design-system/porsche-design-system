...
1. For the different applications, select one of the following commands:
   ...
   - `./docker.sh run-build --core-dependencies` (builds utilities, icons, fonts, marque and assets)- `./docker.sh run-build --fonts` (builds the font set)
   - `./docker.sh run-build --fonts` (builds the email marque)
