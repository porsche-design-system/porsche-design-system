...
const groupsToCheck = [
  {
    name: '/tailwindcss',
    paths: [
      '@porsche-design-system/components-vue/tailwindcss',
      '@porsche-design-system/components-vue/tailwindcss/index.css',
      '@porsche-design-system/components-vue/tailwindcss/index',
