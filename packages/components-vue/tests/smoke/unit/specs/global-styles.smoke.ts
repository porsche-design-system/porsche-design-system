...
const groupsToCheck = [
  {
    name: '/',
    paths: [
      // TODO: How to test against '@porsche-design-system/components-vue'?
      '@porsche-design-system/components-vue/index.css',
      '@porsche-design-system/components-vue/index',
  ...
  },
  {
    name: '/color-scheme',
    paths: [
      '@porsche-design-system/components-vue/color-scheme.css',
      '@porsche-design-system/components-vue/color-scheme',
  ...
  },
  {
    ...
    paths: [
      ...
      '@porsche-design-system/components-vue/font-face',
  ...
  },
  {
    ...
    paths: [
      ...
      '@porsche-design-system/components-vue/normalize',
  ...
  },
  {
    ...
    paths: [
      ...
      '@porsche-design-system/components-vue/variables',
  ...
  },
  {
    name: '/cn',
    paths: [
      '@porsche-design-system/components-vue/cn',
      '@porsche-design-system/components-vue/cn/index.css',
      '@porsche-design-system/components-vue/cn/index',
  ...
  },
  {
    ...
    paths: [
      ...
      '@porsche-design-system/components-vue/cn/font-face',
...
describe('global styles package content', () => {
  ...
  test('index files contain all individual parts', () => {
    const mainIndexPath = requireNode.resolve('@porsche-design-system/components-vue/index.css');
    const mainIndexContent = fs.readFileSync(mainIndexPath, 'utf8');

    const cnIndexPath = requireNode.resolve('@porsche-design-system/components-vue/cn/index.css');
