...
const ESMBuildDirVanillaExtract = path.resolve(__dirname, './../../../../dist/vue-wrapper/vanilla-extract/esm');
...
describe('style package content', () => {
  ...
  test(`should match vanilla-extract content`, () => {
    const styles = nodeRequire('@porsche-design-system/components-vue/vanilla-extract');
