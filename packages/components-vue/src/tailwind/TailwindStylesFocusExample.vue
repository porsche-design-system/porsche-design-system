<template>
  <div class="flex flex-wrap justify-center items-start gap-fluid-md p-fluid-md bg-base-light text-primary-light">
    ...
    <p class="focus-visible:outline outline-state-focus outline-offset-2 rounded-sm pds-text-sm m-0 max-w-[15rem]">
      Lorem Ipsum <a class="focus-visible:outline outline-state-focus outline-offset-2 rounded-sm pds-text-sm text-inherit" href="#">is simply dummy text of the printing</a> and typesetting
      industry.
    </p>
  </div>
  <div class="flex flex-wrap justify-center items-start gap-fluid-md p-fluid-md bg-base-dark text-primary-dark">
    ...
    <p class="focus-visible:outline outline-state-focus outline-offset-2 rounded-sm pds-text-sm text-primary-dark m-0 max-w-[15rem]">
      Lorem Ipsum <a class="focus-visible:outline outline-state-focus outline-offset-2 rounded-sm pds-text-sm text-inherit" href="#">is simply dummy text of the printing</a> and typesetting
      industry.
    </p>
  </div>
