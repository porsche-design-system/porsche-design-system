...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-radio-group/examples/Default.vue](./p-radio-group/examples/Default.vue) |
| Form | The `p-radio-group` can be integrated into a form in two ways: **controlled** or **uncontrolled**, depending on your needs. | [./p-radio-group/examples/Form.vue](./p-radio-group/examples/Form.vue) |
| Slots | Use named slots when `label` or `message` need markup such as a link. | [./p-radio-group/examples/Slots.vue](./p-radio-group/examples/Slots.vue) |
