...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-tag/examples/Default.vue](./p-tag/examples/Default.vue) |
| With slotted button | It is possible to add a `<button>` tag into the `p-tag` component. | [./p-tag/examples/SlottedButton.vue](./p-tag/examples/SlottedButton.vue) |
| With slotted link | It is possible to add an `<a>` tag to the `p-tag` component. | [./p-tag/examples/SlottedLink.vue](./p-tag/examples/SlottedLink.vue) |
| Multiline | The contents of the `p-tag` component are rendered with `white-space: nowrap` by default. | [./p-tag/examples/Multiline.vue](./p-tag/examples/Multiline.vue) |
