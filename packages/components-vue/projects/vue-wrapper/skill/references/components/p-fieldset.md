...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-fieldset/examples/Default.vue](./p-fieldset/examples/Default.vue) |
| Slotted label | Slotted label | [./p-fieldset/examples/SlottedLabel.vue](./p-fieldset/examples/SlottedLabel.vue) |
| Slotted message | Slotted message | [./p-fieldset/examples/SlottedMessage.vue](./p-fieldset/examples/SlottedMessage.vue) |
| Required | Setting `required="true"` on `p-fieldset` only renders the asterisk on the legend and sets `aria-required` on the underlying `<fieldset>` element. | [./p-fieldset/examples/Required.vue](./p-fieldset/examples/Required.vue) |
