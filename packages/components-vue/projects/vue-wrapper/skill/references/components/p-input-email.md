...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-input-email/examples/Default.vue](./p-input-email/examples/Default.vue) |
| Form | The `p-input-email` can be integrated into a form in two ways: **controlled** or **uncontrolled**, depending on your needs. | [./p-input-email/examples/Form.vue](./p-input-email/examples/Form.vue) |
| Slots | Use named slots when `label`, `description` or `message` need markup such as a link. | [./p-input-email/examples/Slots.vue](./p-input-email/examples/Slots.vue) |
