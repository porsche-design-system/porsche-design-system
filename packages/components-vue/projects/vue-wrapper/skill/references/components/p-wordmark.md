...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-wordmark/examples/Default.vue](./p-wordmark/examples/Default.vue) |
| Size | By default, the sizing is fluid, which can be changed to `inherit` a specified value. | [./p-wordmark/examples/Size.vue](./p-wordmark/examples/Size.vue) |
| Custom clickable/focusable area | Sometimes it may be useful to enlarge the clickable/focusable area of the `p-wordmark`. | [./p-wordmark/examples/CustomClickableArea.vue](./p-wordmark/examples/CustomClickableArea.vue) |
