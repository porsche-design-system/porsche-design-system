...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-input-search/examples/Default.vue](./p-input-search/examples/Default.vue) |
| Form | The `p-input-search` can be integrated into a form in two ways: **controlled** or **uncontrolled**, depending on your needs. | [./p-input-search/examples/Form.vue](./p-input-search/examples/Form.vue) |
| Slots | Use named slots when `label`, `description` or `message` need markup such as a link. | [./p-input-search/examples/Slots.vue](./p-input-search/examples/Slots.vue) |
| Used as a Combobox | You can pass an `aria` property to expose extra semantics on the **native input** (see [accessibility](/components/input-search/accessibility)). | [./p-input-search/examples/AriaCombobox.vue](./p-input-search/examples/AriaCombobox.vue) |
