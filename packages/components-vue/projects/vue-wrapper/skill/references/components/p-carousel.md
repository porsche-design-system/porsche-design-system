...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-carousel/examples/Default.vue](./p-carousel/examples/Default.vue) |
| Slides with flexible widths | In case you want to have slides with different widths you can use `slidesPerPage` with a value of `auto`. | [./p-carousel/examples/FlexibleWidths.vue](./p-carousel/examples/FlexibleWidths.vue) |
| Jump to slide (activeSlideIndex) | To control the `p-carousel` from the outside you can specify its `activeSlideIndex` initially but also later. | [./p-carousel/examples/JumpToSlide.vue](./p-carousel/examples/JumpToSlide.vue) |
| Add/remove slides | Slides can be added and removed dynamically. | [./p-carousel/examples/DynamicSlides.vue](./p-carousel/examples/DynamicSlides.vue) |
| Centered Slide and Gradient Customization | The carousel centers the active slide and loops through slides individually rather than by page when multiple slides are visible. | [./p-carousel/examples/FocusOnCenterSlide.vue](./p-carousel/examples/FocusOnCenterSlide.vue) |
| Internationalization (i18n) | Default wordings for screen readers can be overridden or translated by passing an object to the `intl` property. | [./p-carousel/examples/Intl.vue](./p-carousel/examples/Intl.vue) |
