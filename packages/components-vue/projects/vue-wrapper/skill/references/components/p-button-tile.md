...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-button-tile/examples/Default.vue](./p-button-tile/examples/Default.vue) |
| UI behaviour | The component is able to break out of its aspect ratio in case content overflows to be accessibility compliant (see first row in example). | [./p-button-tile/examples/UiBehaviour.vue](./p-button-tile/examples/UiBehaviour.vue) |
| Hyphens | It is possible to overwrite the hyphens style on the host element and use 'soft' hyphens. | [./p-button-tile/examples/Hyphens.vue](./p-button-tile/examples/Hyphens.vue) |
| Footer slot | You can also use a `footer` slot to display additional text below the description, providing more flexibility for custom content. | [./p-button-tile/examples/FooterSlot.vue](./p-button-tile/examples/FooterSlot.vue) |
