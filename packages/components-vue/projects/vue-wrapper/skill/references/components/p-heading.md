...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-heading/examples/Default.vue](./p-heading/examples/Default.vue) |
| Semantics | To provide more contextual HTML semantics you can either pass them with the `tag` property or directly inside a slot. | [./p-heading/examples/Semantics.vue](./p-heading/examples/Semantics.vue) |
| Color | Predefined theme-based colors are available, but `inherit` can also be used to define a custom color. | [./p-heading/examples/Color.vue](./p-heading/examples/Color.vue) |
