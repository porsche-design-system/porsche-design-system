...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-segmented-control/examples/Default.vue](./p-segmented-control/examples/Default.vue) |
| Form | The `p-segmented-control` can be integrated into a form in two ways: **controlled** or **uncontrolled**, depending on your needs. | [./p-segmented-control/examples/Form.vue](./p-segmented-control/examples/Form.vue) |
| With Labels | Additional meta information can be displayed by setting a `label` on each child. | [./p-segmented-control/examples/WithLabels.vue](./p-segmented-control/examples/WithLabels.vue) |
| Slots | Use named slots when `label`, `description` or `message` need markup such as a link. | [./p-segmented-control/examples/Slots.vue](./p-segmented-control/examples/Slots.vue) |
