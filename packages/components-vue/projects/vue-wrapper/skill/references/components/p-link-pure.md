...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-link-pure/examples/Default.vue](./p-link-pure/examples/Default.vue) |
| Link with specific icon | If another icon needs to be implemented, just replace the default icon with another predefined icon. | [./p-link-pure/examples/Icon.vue](./p-link-pure/examples/Icon.vue) |
| Framework routing (anchor nesting) | To support custom anchor tags (e.g. | [./p-link-pure/examples/FrameworkRouting.vue](./p-link-pure/examples/FrameworkRouting.vue) |
...
| Link Pure with custom clickable/focusable area | Sometimes it might be useful to enlarge the clickable/focusable area of a link to fulfill accessibility guidelines. | [./p-link-pure/examples/CustomClickableArea.vue](./p-link-pure/examples/CustomClickableArea.vue) |
