...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-input-month/examples/Default.vue](./p-input-month/examples/Default.vue) |
| Form | The `p-input-month` can be integrated into a form in two ways: **controlled** or **uncontrolled**, depending on your needs. | [./p-input-month/examples/Form.vue](./p-input-month/examples/Form.vue) |
| Slots | Use named slots when `label`, `description` or `message` need markup such as a link. | [./p-input-month/examples/Slots.vue](./p-input-month/examples/Slots.vue) |
