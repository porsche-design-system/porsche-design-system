...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-display/examples/Default.vue](./p-display/examples/Default.vue) |
| Size | There are predefined fluid text sizes for the component which should cover most use cases. | [./p-display/examples/Size.vue](./p-display/examples/Size.vue) |
| Responsive | Responsive | [./p-display/examples/SizeResponsive.vue](./p-display/examples/SizeResponsive.vue) |
| Semantics | To provide more contextual HTML semantics you can either pass them with the `tag` property or directly inside a slot. | [./p-display/examples/Semantics.vue](./p-display/examples/Semantics.vue) |
| Color | Predefined theme-based colors are available, but `inherit` can also be used to define a custom color. | [./p-display/examples/Color.vue](./p-display/examples/Color.vue) |
