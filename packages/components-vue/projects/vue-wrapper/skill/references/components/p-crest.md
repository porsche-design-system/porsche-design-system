...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-crest/examples/Default.vue](./p-crest/examples/Default.vue) |
| Link | The Porsche Crest will be rendered as `<a>`-tag as soon as an `href` is provided. | [./p-crest/examples/Link.vue](./p-crest/examples/Link.vue) |
| Custom clickable/focusable area | Sometimes it may be useful to enlarge the clickable/focusable area of the Porsche Crest. | [./p-crest/examples/CustomClickableArea.vue](./p-crest/examples/CustomClickableArea.vue) |
