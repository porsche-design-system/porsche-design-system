...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-link/examples/Default.vue](./p-link/examples/Default.vue) |
| Framework routing (anchor nesting) | To support custom anchor tags (e.g. | [./p-link/examples/FrameworkRouting.vue](./p-link/examples/FrameworkRouting.vue) |
| Link with specific icon | If an icon needs to be implemented, just set another predefined icon. | [./p-link/examples/Icon.vue](./p-link/examples/Icon.vue) |
