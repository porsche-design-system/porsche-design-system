...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-scroller/examples/Default.vue](./p-scroller/examples/Default.vue) |
| Height | The height of `p-scroller` depends on the height of its content. | [./p-scroller/examples/Height.vue](./p-scroller/examples/Height.vue) |
| Scroll to position | The `p-scroller` component provides the `scrollToPosition` property. | [./p-scroller/examples/ScrollToPosition.vue](./p-scroller/examples/ScrollToPosition.vue) |
