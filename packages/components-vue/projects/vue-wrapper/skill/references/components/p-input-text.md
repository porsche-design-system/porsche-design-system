...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-input-text/examples/Default.vue](./p-input-text/examples/Default.vue) |
| Form | The `p-input-text` can be integrated into a form in two ways: **controlled** or **uncontrolled**, depending on your needs. | [./p-input-text/examples/Form.vue](./p-input-text/examples/Form.vue) |
| Controlled Input (Preventing User Input) | In some cases you may want to fully control the input value (for example to limit or validate user input). | [./p-input-text/examples/Controlled.vue](./p-input-text/examples/Controlled.vue) |
| Slots | Use named slots when `label`, `description` or `message` need markup such as a link. | [./p-input-text/examples/Slots.vue](./p-input-text/examples/Slots.vue) |
