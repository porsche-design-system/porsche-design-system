...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-input-date/examples/Default.vue](./p-input-date/examples/Default.vue) |
| Form | The `p-input-date` can be integrated into a form in two ways: **controlled** or **uncontrolled**, depending on your needs. | [./p-input-date/examples/Form.vue](./p-input-date/examples/Form.vue) |
| Slots | Use named slots when `label`, `description` or `message` need markup such as a link. | [./p-input-date/examples/Slots.vue](./p-input-date/examples/Slots.vue) |
