...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-banner/examples/Default.vue](./p-banner/examples/Default.vue) |
| Customization | Rich content for `heading` and `description` can be provided via named slots. | [./p-banner/examples/Customization.vue](./p-banner/examples/Customization.vue) |
