...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-textarea/examples/Default.vue](./p-textarea/examples/Default.vue) |
| Form | The `p-textarea` can be integrated into a form in two ways: **controlled** or **uncontrolled**, depending on your needs. | [./p-textarea/examples/Form.vue](./p-textarea/examples/Form.vue) |
| Slots | Use named slots when `label`, `description` or `message` need markup such as a link. | [./p-textarea/examples/Slots.vue](./p-textarea/examples/Slots.vue) |
