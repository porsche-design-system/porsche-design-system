...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-text/examples/Default.vue](./p-text/examples/Default.vue) |
| Static Size | There are predefined fluid text sizes for the text component which should cover most use cases. | [./p-text/examples/Size.vue](./p-text/examples/Size.vue) |
| Responsive Size | The `size` property accepts a breakpoint object to render different text sizes per viewport. | [./p-text/examples/SizeResponsive.vue](./p-text/examples/SizeResponsive.vue) |
| Semantics | To provide more contextual HTML semantics you can either pass them with the `tag` property or directly inside a slot. | [./p-text/examples/Semantics.vue](./p-text/examples/Semantics.vue) |
