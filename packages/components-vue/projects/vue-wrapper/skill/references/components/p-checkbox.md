...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-checkbox/examples/Default.vue](./p-checkbox/examples/Default.vue) |
| Form | The `p-checkbox` can be integrated into a form in two ways: **controlled** or **uncontrolled**, depending on your needs. | [./p-checkbox/examples/Form.vue](./p-checkbox/examples/Form.vue) |
| Indeterminate | Mask the visual appearance of a checkbox which has a state in-between checked and unchecked. | [./p-checkbox/examples/Indeterminate.vue](./p-checkbox/examples/Indeterminate.vue) |
| Slots | Use named slots when `label` or `message` need markup such as a link. | [./p-checkbox/examples/Slots.vue](./p-checkbox/examples/Slots.vue) |
| Custom wrapped label (🧪Experimental) | The `p-checkbox` component also supports a custom wrapped `label` by wrapping the component in a `label` tag. | [./p-checkbox/examples/WrappedLabel.vue](./p-checkbox/examples/WrappedLabel.vue) |
