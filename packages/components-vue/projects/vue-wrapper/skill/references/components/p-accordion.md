...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-accordion/examples/Default.vue](./p-accordion/examples/Default.vue) |
| Sticky summary | The summary can be made sticky by adding the experimental property `sticky` to the `p-accordion` tag. | [./p-accordion/examples/StickySummary.vue](./p-accordion/examples/StickySummary.vue) |
| Interactive elements in summary | The summary section supports interactive elements via the `slot="summary-before"` and `slot="summary-after"` attributes. | [./p-accordion/examples/InteractiveElementsInSummary.vue](./p-accordion/examples/InteractiveElementsInSummary.vue) |
