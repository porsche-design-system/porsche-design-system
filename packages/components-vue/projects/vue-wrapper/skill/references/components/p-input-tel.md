...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-input-tel/examples/Default.vue](./p-input-tel/examples/Default.vue) |
| Form | The `p-input-tel` can be integrated into a form in two ways: **controlled** or **uncontrolled**, depending on your needs. | [./p-input-tel/examples/Form.vue](./p-input-tel/examples/Form.vue) |
| Slots | Use named slots when `label`, `description` or `message` need markup such as a link. | [./p-input-tel/examples/Slots.vue](./p-input-tel/examples/Slots.vue) |
