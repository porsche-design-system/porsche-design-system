...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-stepper-horizontal/examples/Default.vue](./p-stepper-horizontal/examples/Default.vue) |
| Framework Implementation | Below you can find an interactive example of an outlined registration process. | [./p-stepper-horizontal/examples/FrameworkImplementation.vue](./p-stepper-horizontal/examples/FrameworkImplementation.vue) |
