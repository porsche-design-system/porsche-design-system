...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-model-signature/examples/Default.vue](./p-model-signature/examples/Default.vue) |
| Safe Zone | The `safe-zone` prop's default is `true`, which ensures a visual balance across all model signatures. | [./p-model-signature/examples/SafeZone.vue](./p-model-signature/examples/SafeZone.vue) |
| Mask: Blend Mode | If `p-model-signature` should be blended with its background, the CSS property [mix-blend-mode](https://developer.mozilla.org/en-US/docs/Web/CSS/mix-blend-mode) can be used (`{{ blendMode }}` will produce the best results). | [./p-model-signature/examples/MaskBlendMode.vue](./p-model-signature/examples/MaskBlendMode.vue) |
| Mask: Image | Mask: Image | [./p-model-signature/examples/MaskImage.vue](./p-model-signature/examples/MaskImage.vue) |
| Mask: Video | Mask: Video | [./p-model-signature/examples/MaskVideo.vue](./p-model-signature/examples/MaskVideo.vue) |
| Custom styling | The `p-model-signature` color can be changed by setting the `color` prop to `inherit` and applying some CSS `color`. | [./p-model-signature/examples/CustomStyling.vue](./p-model-signature/examples/CustomStyling.vue) |
