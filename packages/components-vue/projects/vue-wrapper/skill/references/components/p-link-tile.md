...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-link-tile/examples/Default.vue](./p-link-tile/examples/Default.vue) |
| With video | With video | [./p-link-tile/examples/WithVideo.vue](./p-link-tile/examples/WithVideo.vue) |
| UI behaviour | The component is able to break out of its aspect ratio in case content overflows to be accessibility compliant (see first row in example). | [./p-link-tile/examples/UiBehaviour.vue](./p-link-tile/examples/UiBehaviour.vue) |
| Hyphens | It is possible to overwrite the hyphens style on the host element and use 'soft' hyphens. | [./p-link-tile/examples/Hyphens.vue](./p-link-tile/examples/Hyphens.vue) |
| Footer slot | You can also use a `footer` slot to display additional text below the description, providing more flexibility for custom content. | [./p-link-tile/examples/FooterSlot.vue](./p-link-tile/examples/FooterSlot.vue) |
