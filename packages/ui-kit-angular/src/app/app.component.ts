    ...
    <div id="app">
      ...
      <p-grid>
        ...
        <p-grid-item size="5">
          ...
          <hr>
          <div class="playground light spacing-inline">
            <p-link variant="primary" href="https://ui.porsche.com" hide-label="true">Some label</p-link>
          </div>
          <div class="playground light spacing-inline">
            <p-link href="https://ui.porsche.com" hide-label="true">Some label</p-link>
          </div>
          <div class="playground light spacing-inline">
            <p-link variant="tertiary" href="https://ui.porsche.com" hide-label="true">Some label</p-link>
          </div>
          <div class="playground light spacing-inline">
            <p-link icon="phone" href="https://ui.porsche.com" hide-label="true">Some label</p-link>
          </div>
          <hr>
        </p-grid-item>
        <p-grid-item size="5">
          ...
          <hr>
          <div class="playground dark spacing-inline">
            <p-link variant="primary" href="https://ui.porsche.com" hide-label="true" theme="dark">Some label</p-link>
          </div>
          <div class="playground dark spacing-inline">
            <p-link href="https://ui.porsche.com" hide-label="true" theme="dark">Some label</p-link>
          </div>
          <div class="playground dark spacing-inline">
            <p-link variant="tertiary" href="https://ui.porsche.com" hide-label="true" theme="dark">Some label</p-link>
          </div>
          <div class="playground dark spacing-inline">
            <p-link icon="phone" href="https://ui.porsche.com" hide-label="true" theme="dark">Some label</p-link>
          </div>
          <hr>
        </p-grid-item>
      </p-grid>
