...
@Component({ selector: 'p-button', changeDetection: 0, template: '<ng-content></ng-content>', inputs: ['allyLabel', 'disabled', 'hideLabel', 'icon', 'loading', 'tabbable', 'theme', 'type', 'variant'] })
...
proxyInputs(PButton, ['allyLabel', 'disabled', 'hideLabel', 'icon', 'loading', 'tabbable', 'theme', 'type', 'variant']);
