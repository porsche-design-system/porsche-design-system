...
@Component({ selector: 'p-button-icon', changeDetection: 0, template: '<ng-content></ng-content>', inputs: ['allyLabel', 'disabled', 'hideLabel', 'icon', 'loading', 'tabbable', 'theme', 'type', 'variant'] })
...
proxyInputs(PButtonIcon, ['allyLabel', 'disabled', 'hideLabel', 'icon', 'loading', 'tabbable', 'theme', 'type', 'variant']);
...
@Component({ selector: 'p-link-icon', changeDetection: 0, template: '<ng-content></ng-content>', inputs: ['allyLabel', 'download', 'href', 'icon', 'rel', 'tabbable', 'target', 'theme', 'variant'] })
...
proxyInputs(PLinkIcon, ['allyLabel', 'download', 'href', 'icon', 'rel', 'tabbable', 'target', 'theme', 'variant']);
