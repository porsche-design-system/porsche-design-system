...
export default class Code extends Vue {
  ...
  <p-select-option value="718">
    <img src="https://porsche-design-system.github.io/dummyasset/718.png" />
    718
  </p-select-option>
  <p-select-option value="911">
    <img src="https://porsche-design-system.github.io/dummyasset/911.png" />
    911
  </p-select-option>
  <p-select-option value="taycan">
    <img src="https://porsche-design-system.github.io/dummyasset/taycan.png" />
    Taycan
  </p-select-option>
  <p-select-option value="macan">
    <img src="https://porsche-design-system.github.io/dummyasset/macan.png" />
    Macan
  </p-select-option>
  <p-select-option value="cayenne">
    <img src="https://porsche-design-system.github.io/dummyasset/cayenne.png" />
    Cayenne
  </p-select-option>
  <p-select-option value="panamera">
    <img src="https://porsche-design-system.github.io/dummyasset/panamera.png" />
    Panamera
  </p-select-option>
</p-select>`;
