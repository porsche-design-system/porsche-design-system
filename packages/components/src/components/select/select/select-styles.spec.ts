...
describe('getComponentCss()', () => {
  it.each<Parameters<typeof getComponentCss>>([
    ...
    ['down', false, true, false, 'none', false, 'light', true],
    ...
    ['down', false, true, false, 'none', true, 'light', false],
    ...
    'should return correct css for direction: %s, isOpen: %s, isDisabled: %s, hideLabel: %o, state: %s, compact: %s, theme: %s and hasSlottedImage: %s',
    (...args) => {
