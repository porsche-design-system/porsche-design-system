...
Use the following template, in which you will find an artboard (24 x 24 px) on which all icons are to be designed (max. 3 icon drafts). [Download Icon Template](https://designsystem.porsche.com/sketch/PAG-icon-template.ai)
