...
export default {
  example: figma.code`<p-link-tile-product${heading ? ` [heading]="'${heading}'"` : ''}${price ? ` [price]="'${price}'"` : ''}${description ? ` [description]="'${description}'"` : ''} [aspectRatio]="'${aspectRatio}'"></p-link-tile-product>`,
  imports: [
