...
describe('getComponentCss()', () => {
  ...
  it.each(dataWidth)('should return correct css for width: %o', (width: FlexItemWidth) => {
  ...
  it.each(dataOffset)('should return correct css for offset: %o', (offset: FlexItemOffset) => {
  ...
  it.each(dataAlignSelf)('should return correct css for alignSelf: %o', (alignSelf: FlexItemAlignSelf) => {
  ...
  it.each(dataGrow)('should return correct css for grow: %o', (grow: FlexItemGrow) => {
  ...
  it.each(dataShrink)('should return correct css for shrink: %o', (shrink: FlexItemShrink) => {
  ...
  it.each(dataFlex)('should return correct css for flex: %o', (flex: FlexItemFlex) => {
