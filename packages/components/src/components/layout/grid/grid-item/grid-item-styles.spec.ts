...
describe('getComponentCss()', () => {
  ...
  it.each(dataSizes)('should return correct css for size: %js', (size: GridItemSize) => {
  ...
  it.each(dataOffsets)('should return correct css for offset: %js', (offset: GridItemOffset) => {
  ...
  it.each(dataSizes.map<[GridItemSize, GridItemOffset]>((x, i) => [x, dataOffsetsReversed[i]]))(
    'should return correct css for size: %js and offset: %js',
  ...
  it.each(dataGutters)('should return correct css for gutter: %js', (gutter: GridGutter) => {
