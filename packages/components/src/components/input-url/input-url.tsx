...
const propTypes: PropTypes<typeof InputUrl> = {
  ...
  aria: AllowedTypes.aria<InputUrlAriaAttribute>(FORM_FIELD_ARIA_ATTRIBUTES),
};
...
export class InputUrl {
  ...
  @Prop() public aria?: SelectedAriaAttributes<InputUrlAriaAttribute>;
