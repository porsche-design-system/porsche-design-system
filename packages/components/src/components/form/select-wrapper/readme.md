...
| `hideLabel`         | `hide-label`         | Show or hide label. For better accessibility it is recommended to show the label. | `Partial<{ base: boolean; xs: boolean; s: boolean; m: boolean; l: boolean; xl: boolean; }> & { base: boolean; } \| boolean \| string` | `false`   |
