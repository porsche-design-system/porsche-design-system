...
| `maxNumberOfPageLinks` | `max-number-of-page-links` | The maximum number of page links rendered                | `NumberOfPageLinks \| BreakpointCustomizable<NumberOfPageLinks>` | `{     base: 5,     xs: 7,   }` |
