...
| `maxNumberOfPageLinks` | `max-number-of-page-links` | The maximum number of page links rendered                | `5 | 7 | NumberOfPageLinks | { base: NumberOfPageLinks; xs: NumberOfPageLinks; s: NumberOfPageLinks; m: NumberOfPageLinks; l: NumberOfPageLinks; xl: NumberOfPageLinks; }` | `{     base: 5,     xs: 7,   }` |
