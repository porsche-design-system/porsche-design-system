...
const ModalPage = (): JSX.Element => {
  ...
  get basic() {
    ...
    return `<p-button type="button" accessibility="{ 'aria-haspopup': 'dialog' }">Open Modal</p-button>
<p-modal heading="Some Heading" open="false">
  ...
  scrollable =
`<p-button type="button" accessibility="{ 'aria-haspopup': 'dialog' }">Open Modal</p-button>
