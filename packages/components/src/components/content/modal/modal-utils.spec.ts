...
describe('getFocusableElements()', () => {
  ...
  it('should call getHTMLElements() with correct parameters', () => {
    ...
    expect(spy).toHaveBeenCalledWith(
      host,
      'p-accordion,p-banner,p-button,p-button-pure,p-inline-notification,p-link,p-link-pure,p-link-social,p-marque,p-modal,p-pagination,p-popover,p-select-wrapper,p-select-wrapper-dropdown,p-switch,p-table,p-table-head-cell,p-tabs,p-tabs-bar,p-text-field-wrapper,[href],input:not([disabled]),select:not([disabled]),textarea:not([disabled]),button:not([disabled]),[tabindex]:not([tabindex="-1"]'
    );
  });
  ...
  it('should call getHTMLElements() with correct parameters for prefixed modal', () => {
    ...
    expect(spy).toHaveBeenCalledWith(
      host,
      'prefixed-p-accordion,prefixed-p-banner,prefixed-p-button,prefixed-p-button-pure,prefixed-p-inline-notification,prefixed-p-link,prefixed-p-link-pure,prefixed-p-link-social,prefixed-p-marque,prefixed-p-modal,prefixed-p-pagination,prefixed-p-popover,prefixed-p-select-wrapper,prefixed-p-select-wrapper-dropdown,prefixed-p-switch,prefixed-p-table,prefixed-p-table-head-cell,prefixed-p-tabs,prefixed-p-tabs-bar,prefixed-p-text-field-wrapper,[href],input:not([disabled]),select:not([disabled]),textarea:not([disabled]),button:not([disabled]),[tabindex]:not([tabindex="-1"]'
    );
  });
});
