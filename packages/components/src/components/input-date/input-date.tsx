...
const propTypes: PropTypes<typeof InputDate> = {
  ...
  aria: AllowedTypes.aria<InputDateAriaAttribute>(FORM_FIELD_ARIA_ATTRIBUTES),
};
...
export class InputDate {
  ...
  @Prop() public aria?: SelectedAriaAttributes<InputDateAriaAttribute>;
