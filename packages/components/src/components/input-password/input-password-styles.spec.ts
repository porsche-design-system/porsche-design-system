...
describe('getComponentCss()', () => {
  it.each<Parameters<typeof getComponentCss>>([
    ...
    [false, false, 'success', false, false, false, 'light'],
    [false, true, 'success', true, true, true, 'light'],
    [false, true, 'success', false, true, true, 'light'],
    [false, false, 'error', true, false, false, 'light'],
    [false, false, 'error', false, false, false, 'light'],
    ...
    'should return correct css for disabled: %s, hideLabel: %o, state: %s, passwordToggle: %o, compact: %o, readOnly: %o, theme: %s',
    (...args) => {
