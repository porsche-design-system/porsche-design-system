...
export default {
  example: figma.code`<p-tag variant="${variant}"${icon ? ` icon="${icon}"` : ''}${compact ? ' compact="true"' : ''}>${slotDefault}</p-tag>`,
  imports: ['<!-- Docs: https://designsystem.porsche.com/v4/components/tag/api -->'],
  id: 'p-tag',
