...
describe('getComponentCss()', () => {
  it.each<Parameters<typeof getComponentCss>>([
    [{ aspectRatio: '4:3', size: 'default', weight: 'semi-bold', align: 'bottom', compact: false, hasGradient: true }],
    [{ aspectRatio: '1:1', size: 'inherit', weight: 'regular', align: 'bottom', compact: false, hasGradient: true }],
    [{ aspectRatio: '3:4', size: 'default', weight: 'semi-bold', align: 'top', compact: false, hasGradient: true }],
    [{ aspectRatio: '16:9', size: 'inherit', weight: 'regular', align: 'top', compact: true, hasGradient: false }],
    [
      {
        aspectRatio: '9:16',
        size: 'default',
