import { attachCss, buildResponsiveHostStyles, getCachedComponentCss, getCss, hasSlottedSubline } from '../../../utils';
...
export const addComponentCss = (host: HTMLElement, stretch: BreakpointCustomizable<boolean>): void => {
  ...
  attachCss(host, getCachedComponentCss(host, getComponentCss, hasSlottedSubline(host) ? false : stretch));
};
