...
const getSVGPath = (stepCount: number, numberedCircleColors: NumberedCircleColors, isStateCurrent: boolean): string => {
  ...
  // Full SVG is provided by design and created with illustrator. The file can be found in ./numbers.svg.
  // The second path in every container represents the number
  const svgNumberedCirclePaths = [
    `${svgCirclePath}<path fill="${fillColor}" d="m12.33,8.67l-2.43.91v-.94l2.6-1.03h.85v8.78h-1.02v-7.72Z"/>`,
    ...
    `${svgCirclePath}<path fill="${fillColor}" d="m8.87,13.6l3.54-5.99h1.43v5.89h1.25v.86h-1.25v2.02h-.99v-2.02h-3.98v-.76Zm3.98-.1v-4.98l-2.91,4.98h2.91Z"/>`,
    `${svgCirclePath}<path fill="${fillColor}" d="m9.34,12.45l.42-4.83h4.71v.94h-3.9l-.26,2.95c.38-.43,1-.68,1.79-.68,1.86,0,2.76.9,2.76,2.81,0,2.06-1.03,2.91-2.86,2.91s-2.74-.84-2.81-2.51h.97c.06,1.13.57,1.7,1.84,1.7,1.39,0,1.85-.68,1.85-2.06s-.48-2-1.85-2c-1.07,0-1.54.42-1.75,1.17h-.91v-.39Z"/>`,
    `${svgCirclePath}<path fill="${fillColor}" d="m9.97,11.02l2.22-3.4h1.1l-2.27,3.44c.33-.16.69-.23,1.1-.23,1.84,0,2.76.9,2.76,2.81,0,2.06-1.04,2.91-2.86,2.91s-2.87-.85-2.87-2.91c0-1.08.3-1.8.83-2.61Zm2.05,4.71c1.38,0,1.84-.68,1.84-2.05s-.47-2.01-1.84-2.01-1.85.64-1.85,2.01.46,2.05,1.85,2.05Z"/>`,
