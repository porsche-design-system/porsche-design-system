...
export const getComponentCss = (
  ...
  return getCss(getFunctionalComponentInputBaseStyles(disabled, loading, hideLabel, state, compact, readOnly, null, // Overwrites direction to ltr for rtl languages to prevent issues with the tel input, e.g. cursor jumping to the
