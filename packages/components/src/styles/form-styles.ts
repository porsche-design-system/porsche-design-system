...
// TODO: Combine with getSlottedTextFieldTextareaSelectStyles
export const getTextFieldTextareaSelectStyles = (
  child: ChildSelector,
  state: FormState,
  isLoading: boolean,
  theme: Theme,
  ...
  return {
    ...
    ...(!isLoading &&
      (hoverMediaQuery({
        ...
        [`${child}:not(:disabled):not(:focus):not([readonly]):hover,label:hover~.wrapper ${child}:not(:disabled):not(:focus):not([readonly])${
