...
type ThemedIconFilter = 'info' | 'success' | 'warning' | 'error';

export type ThemedIconFilters = { [key in ThemedIconFilter]: string };

const themeLight = {
  info: 'invert(62%) sepia(61%) saturate(551%) hue-rotate(86deg) brightness(86%) contrast(80%)',
  success: 'invert(31%) sepia(32%) saturate(5493%) hue-rotate(216deg) brightness(90%) contrast(107%)',
...
const themeDark = {
  info: 'invert(59%) sepia(22%) saturate(1342%) hue-rotate(86deg) brightness(96%) contrast(88%)',
  success: 'invert(31%) sepia(32%) saturate(5493%) hue-rotate(216deg) brightness(90%) contrast(107%)',
