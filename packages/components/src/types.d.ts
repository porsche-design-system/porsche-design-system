...
export type { TextAlign } from './components/typography/text-align';
export type { TextColor } from './components/typography/text-color';
export type { TextWeight } from './components/typography/text-weight';
export type { HeadlineVariant, VariantType } from './components/typography/headline/headline-utils';
...
import type { LinkButtonVariant } from './components/link-button-variant';
export type { LinkButtonVariant } from './components/link-button-variant';
export type ButtonVariant = LinkButtonVariant;
export type { ButtonType } from './components/button-type';

export type LinkVariant = LinkButtonVariant;
export type { LinkTarget } from './components/link-target';

export type { AlignLabel, AlignLabelType } from './components/align-label';
