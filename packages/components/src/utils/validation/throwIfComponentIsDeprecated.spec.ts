...
const warningMessage =
  'Component div is deprecated and will be removed with next major release. Use "link" component with corresponding social icon instead.';

describe('with host element', () => {
  it('should throw warning', () => {
    const host = document.createElement('div');
    jest.spyOn(console, 'warn').mockImplementation();
    throwIfComponentIsDeprecated(host);
