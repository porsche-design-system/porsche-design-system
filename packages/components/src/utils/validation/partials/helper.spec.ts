...
describe('getPdsComponentsSelector()', () => {
  it('should return joined TAG_NAMES_WITH_CHUNK if no prefixes are passed', () => {
    expect(getPdsComponentsSelector([''])).toMatchInlineSnapshot(`"p-accordion,p-banner,p-button,p-button-group,p-button-pure,p-button-tile,p-carousel,p-checkbox-wrapper,p-content-wrapper,p-crest,p-display,p-divider,p-fieldset,p-fieldset-wrapper,p-flex,p-flyout,p-flyout-navigation,p-grid,p-heading,p-headline,p-icon,p-inline-notification,p-link,p-link-pure,p-link-social,p-link-tile,p-link-tile-model-signature,p-marque,p-modal,p-model-signature,p-multi-select,p-pagination,p-pin-code,p-popover,p-radio-button-wrapper,p-scroller,p-segmented-control,p-select-wrapper,p-spinner,p-stepper-horizontal,p-switch,p-table,p-tabs,p-tabs-bar,p-tag,p-tag-dismissible,p-text,p-text-field-wrapper,p-text-list,p-textarea-wrapper,p-toast,p-wordmark"`);
  });
