...
export function getHTMLElement<E extends Element = Element>(
  element: HTMLElementOrShadowRoot,
  selector: string
): E | null;
// prettier-ignore
export function getHTMLElement<K extends keyof HTMLElementTagNameMap>(element: HTMLElementOrShadowRoot, selector: K): HTMLElementTagNameMap[K] | null {
...
export function getShadowRootHTMLElement<E extends Element = Element>(
  element: HTMLElementOrShadowRoot,
  selector: string
): E | null;
// prettier-ignore
...
export function getHTMLElementAndThrowIfUndefined<E extends Element = Element>(
  element: HTMLElementOrShadowRoot,
  selector: string
): E | null;
// prettier-ignore
