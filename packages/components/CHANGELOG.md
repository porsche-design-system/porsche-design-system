...
#### Deprecated
- The `tabbable` property of `Button`, `Button Pure` and `Switch` is deprecated and will be removed in `v3.0.0`. 
Please use `tabindex` instead: `<p-button tabindex="-1">Some button</p-button>`
