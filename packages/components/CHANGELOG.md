...
- `Spinner`, `Icon`, `Link Pure`, `Button Pure`, `Link`, `Link Social`, `Button`, `Checkbox Wrapper`,
  ...
  `Inline Notification`, `Banner`, `Toast`, `Grid`, `Flex`, `Pagination`, `Scroller`, `Accordion`, `Tabs`, `Tabs Bar`, `Text`, `Text Field Wrapper`, `Content Wrapper` and `Fieldset Wrapper` matches new design
  language
