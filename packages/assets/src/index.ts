import { CDN_BASE_URL as P_FONTS_CDN_BASE_URL, FONTS_MANIFEST as P_FONTS_MANIFEST, CDN_FONT_CSS_FILE_URL as P_FONTS_CSS_FILE_URL } from '@porsche-design-system/fonts';
