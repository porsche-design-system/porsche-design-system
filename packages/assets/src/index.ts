...
import { STYLE_CDN_URL as P_STYLE_CDN_URL } from '@porsche-design-system/utilities';
...
export const MARQUE_CDN_BASE_URL = P_MARQUE_CDN_BASE_URL;
export const MARQUES_MANIFEST = P_MARQUES_MANIFEST;
export const STYLE_CDN_URL = P_STYLE_CDN_URL;
