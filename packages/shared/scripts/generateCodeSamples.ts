...
const generateCodeSamples = (): void => {
  const codeSamples: CodeSample[] = [
    ...
    },
    {
      ...
      samples: [
        [
          componentsJsPath + '/drilldown-example.html',
          componentsAngularPath + '/drilldown-example.component.ts',
          componentsReactPath + '/DrilldownExample.tsx',
          componentsVuePath + '/DrilldownExample.vue',
        ],
        [
          componentsJsPath + '/drilldown-example-active-identifier.html',
          componentsAngularPath + '/drilldown-example-active-identifier.component.ts',
          componentsReactPath + '/DrilldownExampleActiveIdentifier.tsx',
          componentsVuePath + '/DrilldownExampleActiveIdentifier.vue',
        ],
        [
          componentsJsPath + '/drilldown-example-custom-content.html',
          componentsAngularPath + '/drilldown-example-custom-content.component.ts',
          componentsReactPath + '/DrilldownExampleCustomContent.tsx',
          componentsVuePath + '/DrilldownExampleCustomContent.vue',
        ],
      ],
    },
    {
