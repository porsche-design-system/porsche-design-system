import { getMinifiedCss, getCss, type Styles } from '../../../src/styles/getMinifiedCss';
...
describe('getMinifiedCss()', () => {
  ...
  )('should for %s return %s', (_, __, input: Styles, result: string) => {
