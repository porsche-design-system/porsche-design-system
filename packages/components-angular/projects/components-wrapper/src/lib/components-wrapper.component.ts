...
@Component({ selector: 'p-checkbox-wrapper', changeDetection: 0, template: '<ng-content></ng-content>', inputs: ['hideLabel', 'label', 'message', 'state'] })
...
@ProxyInputs(['color', 'orientation', 'theme'])

@Component({ selector: 'p-divider', changeDetection: 0, template: '<ng-content></ng-content>', inputs: ['color', 'orientation', 'theme'] })
...
@Component({ selector: 'p-radio-button-wrapper', changeDetection: 0, template: '<ng-content></ng-content>', inputs: ['hideLabel', 'label', 'message', 'state'] })
...
@Component({ selector: 'p-select-wrapper', changeDetection: 0, template: '<ng-content></ng-content>', inputs: ['hideLabel', 'label', 'message', 'state'] })
...
@Component({ selector: 'p-text-field-wrapper', changeDetection: 0, template: '<ng-content></ng-content>', inputs: ['hideLabel', 'label', 'message', 'state'] })
