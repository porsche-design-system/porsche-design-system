...
@ProxyInputs(['hideLabel', 'indeterminate', 'label', 'message', 'state'])

@Component({ selector: 'p-checkbox-wrapper', changeDetection: 0, template: '<ng-content></ng-content>', inputs: ['hideLabel', 'indeterminate', 'label', 'message', 'state'] })
