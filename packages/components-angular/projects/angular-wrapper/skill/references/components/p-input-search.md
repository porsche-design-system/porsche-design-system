...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-input-search/examples/Default.ts](./p-input-search/examples/Default.ts) |
| Form | The `p-input-search` can be integrated into a form in two ways: **controlled** or **uncontrolled**, depending on your needs. | [./p-input-search/examples/Form.ts](./p-input-search/examples/Form.ts) |
| Slots | Use named slots when `label`, `description` or `message` need markup such as a link. | [./p-input-search/examples/Slots.ts](./p-input-search/examples/Slots.ts) |
| Used as a Combobox | You can pass an `aria` property to expose extra semantics on the **native input** (see [accessibility](/components/input-search/accessibility)). | [./p-input-search/examples/AriaCombobox.ts](./p-input-search/examples/AriaCombobox.ts) |
