...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-segmented-control/examples/Default.ts](./p-segmented-control/examples/Default.ts) |
| Form | The `p-segmented-control` can be integrated into a form in two ways: **controlled** or **uncontrolled**, depending on your needs. | [./p-segmented-control/examples/Form.ts](./p-segmented-control/examples/Form.ts) |
| With Labels | Additional meta information can be displayed by setting a `label` on each child. | [./p-segmented-control/examples/WithLabels.ts](./p-segmented-control/examples/WithLabels.ts) |
| Slots | Use named slots when `label`, `description` or `message` need markup such as a link. | [./p-segmented-control/examples/Slots.ts](./p-segmented-control/examples/Slots.ts) |
