...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-crest/examples/Default.ts](./p-crest/examples/Default.ts) |
| Link | The Porsche Crest will be rendered as `<a>`-tag as soon as an `href` is provided. | [./p-crest/examples/Link.ts](./p-crest/examples/Link.ts) |
| Custom clickable/focusable area | Sometimes it may be useful to enlarge the clickable/focusable area of the Porsche Crest. | [./p-crest/examples/CustomClickableArea.ts](./p-crest/examples/CustomClickableArea.ts) |
