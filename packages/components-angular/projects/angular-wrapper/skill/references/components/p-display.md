...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-display/examples/Default.ts](./p-display/examples/Default.ts) |
| Size | There are predefined fluid text sizes for the component which should cover most use cases. | [./p-display/examples/Size.ts](./p-display/examples/Size.ts) |
| Responsive | Responsive | [./p-display/examples/SizeResponsive.ts](./p-display/examples/SizeResponsive.ts) |
| Semantics | To provide more contextual HTML semantics you can either pass them with the `tag` property or directly inside a slot. | [./p-display/examples/Semantics.ts](./p-display/examples/Semantics.ts) |
| Color | Predefined theme-based colors are available, but `inherit` can also be used to define a custom color. | [./p-display/examples/Color.ts](./p-display/examples/Color.ts) |
