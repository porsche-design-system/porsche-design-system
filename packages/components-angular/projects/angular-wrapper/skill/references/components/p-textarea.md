...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-textarea/examples/Default.ts](./p-textarea/examples/Default.ts) |
| Form | The `p-textarea` can be integrated into a form in two ways: **controlled** or **uncontrolled**, depending on your needs. | [./p-textarea/examples/Form.ts](./p-textarea/examples/Form.ts) |
| Slots | Use named slots when `label`, `description` or `message` need markup such as a link. | [./p-textarea/examples/Slots.ts](./p-textarea/examples/Slots.ts) |
