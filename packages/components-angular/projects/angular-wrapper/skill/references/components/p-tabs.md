...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-tabs/examples/Default.ts](./p-tabs/examples/Default.ts) |
| Gradient color | If the amount of tabs exceeds the viewport, the component renders arrow-buttons to help with horizontal scrolling. | [./p-tabs/examples/Gradient.ts](./p-tabs/examples/Gradient.ts) |
| Active Tab | You may need to change the initial active tab. | [./p-tabs/examples/ActiveTab.ts](./p-tabs/examples/ActiveTab.ts) |
| Labelling | Use the `aria` property to provide an accessible name and optional description for the tablist. | [./p-tabs/examples/Labelling.ts](./p-tabs/examples/Labelling.ts) |
