...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-banner/examples/Default.ts](./p-banner/examples/Default.ts) |
| Customization | Rich content for `heading` and `description` can be provided via named slots. | [./p-banner/examples/Customization.ts](./p-banner/examples/Customization.ts) |
