...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-input-month/examples/Default.ts](./p-input-month/examples/Default.ts) |
| Form | The `p-input-month` can be integrated into a form in two ways: **controlled** or **uncontrolled**, depending on your needs. | [./p-input-month/examples/Form.ts](./p-input-month/examples/Form.ts) |
| Slots | Use named slots when `label`, `description` or `message` need markup such as a link. | [./p-input-month/examples/Slots.ts](./p-input-month/examples/Slots.ts) |
