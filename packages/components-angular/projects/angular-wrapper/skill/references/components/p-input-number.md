...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-input-number/examples/Default.ts](./p-input-number/examples/Default.ts) |
| Form | The `p-input-number` can be integrated into a form in two ways: **controlled** or **uncontrolled**, depending on your needs. | [./p-input-number/examples/Form.ts](./p-input-number/examples/Form.ts) |
| Slots | Use named slots when `label`, `description` or `message` need markup such as a link. | [./p-input-number/examples/Slots.ts](./p-input-number/examples/Slots.ts) |
