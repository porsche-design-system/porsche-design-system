...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-stepper-horizontal/examples/Default.ts](./p-stepper-horizontal/examples/Default.ts) |
| Framework Implementation | Below you can find an interactive example of an outlined registration process. | [./p-stepper-horizontal/examples/FrameworkImplementation.ts](./p-stepper-horizontal/examples/FrameworkImplementation.ts) |
