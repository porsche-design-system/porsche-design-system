...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-input-password/examples/Default.ts](./p-input-password/examples/Default.ts) |
| Form | The `p-input-password` can be integrated into a form in two ways: **controlled** or **uncontrolled**, depending on your needs. | [./p-input-password/examples/Form.ts](./p-input-password/examples/Form.ts) |
| Show password toggle button | If you want to show the password toggle button, you can pass `toggle="true"`. | [./p-input-password/examples/Toggle.ts](./p-input-password/examples/Toggle.ts) |
| Slots | Use named slots when `label`, `description` or `message` need markup such as a link. | [./p-input-password/examples/Slots.ts](./p-input-password/examples/Slots.ts) |
