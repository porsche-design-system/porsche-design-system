...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-input-tel/examples/Default.ts](./p-input-tel/examples/Default.ts) |
| Form | The `p-input-tel` can be integrated into a form in two ways: **controlled** or **uncontrolled**, depending on your needs. | [./p-input-tel/examples/Form.ts](./p-input-tel/examples/Form.ts) |
| Slots | Use named slots when `label`, `description` or `message` need markup such as a link. | [./p-input-tel/examples/Slots.ts](./p-input-tel/examples/Slots.ts) |
