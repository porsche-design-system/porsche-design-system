...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-wordmark/examples/Default.ts](./p-wordmark/examples/Default.ts) |
| Size | By default, the sizing is fluid, which can be changed to `inherit` a specified value. | [./p-wordmark/examples/Size.ts](./p-wordmark/examples/Size.ts) |
| Custom clickable/focusable area | Sometimes it may be useful to enlarge the clickable/focusable area of the `p-wordmark`. | [./p-wordmark/examples/CustomClickableArea.ts](./p-wordmark/examples/CustomClickableArea.ts) |
