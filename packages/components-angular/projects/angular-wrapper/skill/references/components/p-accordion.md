...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-accordion/examples/Default.ts](./p-accordion/examples/Default.ts) |
| Sticky summary | The summary can be made sticky by adding the experimental property `sticky` to the `p-accordion` tag. | [./p-accordion/examples/StickySummary.ts](./p-accordion/examples/StickySummary.ts) |
| Interactive elements in summary | The summary section supports interactive elements via the `slot="summary-before"` and `slot="summary-after"` attributes. | [./p-accordion/examples/InteractiveElementsInSummary.ts](./p-accordion/examples/InteractiveElementsInSummary.ts) |
