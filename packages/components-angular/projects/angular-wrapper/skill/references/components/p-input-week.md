...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-input-week/examples/Default.ts](./p-input-week/examples/Default.ts) |
| Form | The `p-input-week` can be integrated into a form in two ways: **controlled** or **uncontrolled**, depending on your needs. | [./p-input-week/examples/Form.ts](./p-input-week/examples/Form.ts) |
| Slots | Use named slots when `label`, `description` or `message` need markup such as a link. | [./p-input-week/examples/Slots.ts](./p-input-week/examples/Slots.ts) |
