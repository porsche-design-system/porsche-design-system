...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-fieldset/examples/Default.ts](./p-fieldset/examples/Default.ts) |
| Slotted label | Slotted label | [./p-fieldset/examples/SlottedLabel.ts](./p-fieldset/examples/SlottedLabel.ts) |
| Slotted message | Slotted message | [./p-fieldset/examples/SlottedMessage.ts](./p-fieldset/examples/SlottedMessage.ts) |
| Required | Setting `required="true"` on `p-fieldset` only renders the asterisk on the legend and sets `aria-required` on the underlying `<fieldset>` element. | [./p-fieldset/examples/Required.ts](./p-fieldset/examples/Required.ts) |
