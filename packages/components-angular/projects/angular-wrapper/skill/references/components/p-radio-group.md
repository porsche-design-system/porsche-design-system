...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-radio-group/examples/Default.ts](./p-radio-group/examples/Default.ts) |
| Form | The `p-radio-group` can be integrated into a form in two ways: **controlled** or **uncontrolled**, depending on your needs. | [./p-radio-group/examples/Form.ts](./p-radio-group/examples/Form.ts) |
| Slots | Use named slots when `label` or `message` need markup such as a link. | [./p-radio-group/examples/Slots.ts](./p-radio-group/examples/Slots.ts) |
