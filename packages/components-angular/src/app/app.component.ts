      ...
      <p-grid>
        ...
        <p-grid-item [size]="5">
          ...
          <div class="playground light spacing-inline">
            ...
            <p-button-pure [size]="'inherit'" style="font-size: 48px; line-height: 1.16667;">Inherit</p-button-pure>
          </div>
          <div class="playground light spacing-inline">
        ...
        <p-grid-item [size]="5">
          ...
          <div class="playground dark spacing-inline">
            ...
            <p-button-pure [size]="'inherit'" [theme]="'dark'" style="font-size: 48px; line-height: 1.16667;">Inherit</p-button-pure>
          </div>
          <div class="playground dark spacing-inline">
      ...
      <p-grid>
        ...
        <p-grid-item [size]="5">
          ...
          <div class="playground light spacing-inline">
            ...
            <p-link-pure [size]="'inherit'" [href]="'https://designsystem.porsche.com'" style="font-size: 48px; line-height: 1.16667;">Inherit</p-link-pure>
          </div>
          <div class="playground light spacing-inline">
        ...
        <p-grid-item [size]="5">
          ...
          <div class="playground dark spacing-inline">
            ...
            <p-link-pure [size]="'inherit'" [href]="'https://designsystem.porsche.com'" [theme]="'dark'" style="font-size: 48px; line-height: 1.16667;">Inherit</p-link-pure>
          </div>
          <div class="playground dark spacing-inline">
