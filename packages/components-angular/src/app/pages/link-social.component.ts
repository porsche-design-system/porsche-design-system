...
@Component({
  ...
  template: `
    ...
    <div class="playground light" title="should render without label">
      ...
      <p-link-social [icon]="'logo-facebook'" [hideLabel]="true"><a href="https://www.facebook.com">Some label</a>
      </p-link-social>
    </div>
    <div class="playground dark" title="should render without label on dark theme">
      <p-link-social [href]="'https://www.facebook.com'" [icon]="'logo-facebook'" [hideLabel]="true" [theme]="'dark'">Some label
      </p-link-social>
      <p-link-social [icon]="'logo-facebook'" [hideLabel]="true" [theme]="'dark'"><a href="https://www.facebook.com">Some
        label</a></p-link-social>
    </div>


    <div class="playground light" title="should render with responsive label">
      <p-link-social [hideLabel]="{'base': true, 'xs': false, 's': true, 'm': false, 'l': true, 'xl': false}"
    ...
    <div class="playground light" title="should render with specific icon">
      ...
      <p-link-social [iconSource]="'assets/icon-custom-kaixin.svg'" [href]="'https://www.kaixin.com'">Some label
      </p-link-social>
    </div>
