...
@Component({
  ...
  template: `
    ...
    <div class="playground dark" title="should render on dark theme">
      <p-link-social [href]="'https://www.facebook.com'" [icon]="'logo-facebook'" [theme]="'dark'"
        >Some label</p-link-social
      >
      <p-link-social [icon]="'logo-facebook'" [theme]="'dark'"
        ><a href="https://www.facebook.com">Some label</a></p-link-social
      >
    </div>

    <div class="playground light" title="should render without label">
      <p-link-social [href]="'https://www.facebook.com'" [icon]="'logo-facebook'" [hideLabel]="true"
        >Some label</p-link-social
      >
    ...
    <div class="playground light" title="should render with specific icon">
      ...
      <p-link-social [iconSource]="'assets/icon-custom-kaixin.svg'" [href]="'https://www.kaixin.com'"
        >Some label
      </p-link-social>
    </div>
    ...
    <div class="playground light" title="should render with multiline label">
      ...
      <p-link-social style="width: 240px;" [icon]="'logo-facebook'"
        ><a href="https://www.facebook.com">Lorem ipsum dolor sit amet, consetetur sadipscing</a></p-link-social
      >
    </div>
  `,
