  ...
  template: `
    <div class="playground light" title="should render stepper on light background">
      <p-stepper-horizontal>
        ...
        <p-stepper-horizontal-item [state]="'complete'" disabled>Step Complete Disabled</p-stepper-horizontal-item>
    ...
    <div class="playground dark" title="should render stepper on dark background">
      <p-stepper-horizontal [theme]="'dark'">
        ...
        <p-stepper-horizontal-item [theme]="'dark'" [state]="'complete'" disabled>Step Complete Disabled</p-stepper-horizontal-item>
