...
@Component({
  ...
  template: `
    <div class="playground light" title="should render stepper horizontal with all numbers from 1 to 9">
    ...
    <div class="playground light" title="should render stepper horizontal size medium with all numbers from 1 to 9">
    ...
    <div class="playground light" title="should render stepper horizontal with all states">
      <p-stepper-horizontal>
    ...
    <div class="playground light" title="should render stepper horizontal size medium with all states">
      <p-stepper-horizontal [size]="'medium'">
    ...
    <div class="playground light" title="should render stepper horizontal with arrow left">
    ...
    <div class="playground light" title="should render stepper horizontal size medium with arrow left">
    ...
    <div class="playground light" title="should render stepper horizontal with arrow left and right">
      <p-stepper-horizontal style="max-width: 600px">
        <p-stepper-horizontal-item [state]="'complete'">Scrollable 1</p-stepper-horizontal-item>
        <p-stepper-horizontal-item [state]="'complete'">Scrollable 2</p-stepper-horizontal-item>
        <p-stepper-horizontal-item [state]="'complete'">Scrollable 3</p-stepper-horizontal-item>
    ...
    <div class="playground light" title="should render stepper horizontal size medium with arrow left and right">
      <p-stepper-horizontal [size]="'medium'" style="max-width: 600px">
        <p-stepper-horizontal-item [state]="'complete'">Scrollable 1</p-stepper-horizontal-item>
        <p-stepper-horizontal-item [state]="'complete'">Scrollable 2</p-stepper-horizontal-item>
        <p-stepper-horizontal-item [state]="'complete'">Scrollable 3</p-stepper-horizontal-item>
    ...
    <div class="playground light" title="should render stepper horizontal size BreakpointCustomizable">
    ...
    <div class="playground light" style="padding: 0 50px" title="should render stepper horizontal with parent padding">
      <p-stepper-horizontal>
