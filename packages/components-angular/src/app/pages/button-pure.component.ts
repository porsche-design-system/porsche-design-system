...
@Component({
  ...
  template: `
    ...
    <div class="playground dark" title="should render button without label on dark theme">
      <p-button-pure hide-label="true" theme="dark">Some label</p-button-pure>
      <p-button-pure hide-label="true" disabled="true" theme="dark">Some label</p-button-pure>
      <p-button-pure hide-label="true" loading="true" theme="dark">Some label</p-button-pure>
    </div>


    <div class="playground light" title="should render button with responsive label">
      <p-button-pure hide-label="{'base': true, 'xs': false, 's': true, 'm': false, 'l': true, 'xl': false}">Some label
      </p-button-pure>
      <p-button-pure hide-label="{'base': true, 'xs': false, 's': true, 'm': false, 'l': true, 'xl': false}">Some label
    ...
    <div class="playground light" title="should render button with specific icon">
      ...
      <p-button-pure icon-source="assets/icon-custom-kaixin.svg">Some label</p-button-pure>
    </div>
