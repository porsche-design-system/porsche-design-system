...
@Component({
  ...
  template: `
    ...
    <div class="playground dark auto-layout" title="should render primary with label only on dark theme">
    ...
    <div class="playground dark auto-layout" title="should render primary with label and icon on dark theme">
    ...
    <div class="playground dark auto-layout" title="should render primary without label on dark theme">
      <p-link [variant]="'primary'" [href]="'https://www.porsche.com'" [hideLabel]="true" [icon]="'arrow-right'" [theme]="'dark'"
        >Some label
      </p-link>
      <p-link [variant]="'primary'" [hideLabel]="true" [icon]="'arrow-right'" [theme]="'dark'">
        <a [href]="'https://www.porsche.com'">Some label</a>
      </p-link>
    </div>
    ...
    <div class="playground dark auto-layout" title="should render primary as default with label only on dark theme">
    ...
    <div class="playground dark auto-layout" title="should render primary as default with label and icon on dark theme">
    ...
    <div class="playground dark auto-layout" title="should render primary as default without label on dark theme">
    ...
    <div class="playground dark auto-layout" title="should render secondary with label only on dark theme">
    ...
    <div class="playground dark auto-layout" title="should render secondary with label and icon on dark theme">
    ...
    <div class="playground dark auto-layout" title="should render secondary without label on dark theme">
      <p-link [variant]="'secondary'" [href]="'https://www.porsche.com'" [hideLabel]="true" [icon]="'arrow-right'" [theme]="'dark'"
        >Some label
      </p-link>
      <p-link [variant]="'secondary'" [hideLabel]="true" [icon]="'arrow-right'" [theme]="'dark'"
        ><a [href]="'https://www.porsche.com'">Some label</a></p-link
      >
    </div>
    ...
    >
      <p-link [variant]="'tertiary'" [href]="'https://www.porsche.com'" [hideLabel]="true" [icon]="'arrow-right'" [theme]="'dark'"
        >Some label
      </p-link>
      <p-link [variant]="'tertiary'" [hideLabel]="true" [icon]="'arrow-right'" [theme]="'dark'"
        ><a [href]="'https://www.porsche.com'">Some label</a></p-link
      >
    </div>
    ...
    <div class="playground dark auto-layout" title="should render link with specific icon on dark theme">
      ...
      <p-link [theme]="'dark'" [iconSource]="'./assets/icon-custom-kaixin.svg'" [variant]="'secondary'" [href]="'https://www.porsche.com'"
        >Some label
      </p-link>
    </div>
