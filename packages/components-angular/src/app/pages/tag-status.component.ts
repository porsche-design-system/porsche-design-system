...
@Component({
  ...
  template: `
    ...
    <div class="playground light" title="should show different background colors with button on light background">
      <p-tag-status [color]="'default'"><button>Tag default with link</button>></p-tag-status>
      <p-tag-status [color]="'background-surface'"><button>Tag background-surface with link</button>></p-tag-status>
    </div>

    <div class="playground light" title="should show different background colors with button and icon on light background">
      <p-tag-status [icon]="'car'" [color]="'default'"><button>Tag default with link</button>></p-tag-status>
      <p-tag-status [icon]="'highway'" [color]="'background-surface'"
        ><button>Tag background-surface with link</button>></p-tag-status
      >
    </div>
    ...
    <div class="playground dark" title="should show default tag on dark background">
    ...
    <div class="playground dark" title="should show different background colors and icons on light dark">
    ...
    <div class="playground dark" title="should show different background colors with button on dark background">
      <p-tag-status [theme]="'dark'" [color]="'default'"><button>Tag default with link</button>></p-tag-status>
    ...
    <div class="playground dark" title="should show different background colors with button and icon on dark background">
      <p-tag-status [theme]="'dark'" [icon]="'car'" [color]="'default'"><button>Tag default with link</button>></p-tag-status>
      <p-tag-status [theme]="'dark'" [icon]="'highway'" [color]="'background-surface'"
        ><button>Tag background-surface with link</button>></p-tag-status
      >
    </div>
