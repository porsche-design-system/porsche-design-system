...
@Component({
  ...
  template: `
    ...
    <div class="playground light" title="should show pagination without last page">
      <p-pagination [totalItemsCount]="500" [itemsPerPage]="25" [activePage]="1" [showLastPage]="false"></p-pagination>
    </div>

    <div class="playground light" title="should show pagination with last page selected and without last page">
