...
@Component({
  ...
  template: `
    ...
    <div class="playground light" title="should show text with different color variants">
      ...
      <p-text [color]="'contrast-high'" style="color: deeppink">The quick brown fox jumps over the lazy dog</p-text>
      <p-text [color]="'neutral-contrast-high'" style="color: deeppink">The quick brown fox jumps over the lazy dog</p-text>
      <p-text [color]="'contrast-medium'" style="color: deeppink">The quick brown fox jumps over the lazy dog</p-text>
      <p-text [color]="'neutral-contrast-medium'" style="color: deeppink">The quick brown fox jumps over the lazy dog</p-text>
      <p-text [color]="'contrast-low'" style="color: deeppink">The quick brown fox jumps over the lazy dog</p-text>
      ...
      <p-text [color]="'notification-info'" style="color: deeppink">The quick brown fox jumps over the lazy dog</p-text>
