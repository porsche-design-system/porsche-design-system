...
@Component({
  ...
  template: `
    <div class="playground" title="should show typography in basic latin charset (U+0020-007F 'Basic Latin')">
    ...
    <div class="playground" title="should show typography in basic latin charset (U+0080-00FF 'Latin-1 Supplement')">
    ...
    <div class="playground" title="should show typography in basic latin charset (U+0100-017F 'Latin Extended-A')">
    ...
    <div class="playground" title="should show typography in basic latin charset (U+0180-024F 'Latin Extended-B')">
    ...
    <div class="playground" title="should show typography in basic latin charset (U+0250-02AF 'IPA Extensions')">
    ...
    <div class="playground" title="should show typography in basic latin charset (U+02B0-02FF 'Spacing Modifier Letters')">
    ...
    <div class="playground" title="should show typography in basic latin charset (U+0E00-0E7F 'Thai')">
    ...
    <div class="playground" title="should show typography in basic latin charset (U+1E00-1EFF 'Latin Extended Additional')">
    ...
    <div class="playground" title="should show typography in basic latin charset (U+2000-206F 'General Punctuation')">
    ...
    <div class="playground" title="should show typography in basic latin charset (U+20A0-20CF 'Currency Symbols')">
    ...
    <div class="playground" title="should show typography in basic latin charset (U+2100-214F 'Letterlike Symbols')">
    ...
    <div class="playground" title="should show typography in basic latin charset (U+2150-218F 'Number Forms')">
    ...
    <div class="playground" title="should show typography in basic latin charset (U+2190-21FF 'Arrows')">
    ...
    <div class="playground" title="should show typography in basic latin charset (U+2200-22FF 'Mathematical Operators')">
    ...
    <div class="playground" title="should show typography in basic latin charset (U+25A0-25FF 'Geometric Shapes')">
    ...
    <div class="playground" title="should show typography in basic latin charset (U+2600-26FF 'Miscellaneous Symbols')">
