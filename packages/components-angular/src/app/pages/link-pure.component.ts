  ...
  template: `
    ...
    <div class="playground light" title="should render with responsive label">
      <p-link-pure [href]="'https://www.porsche.com'"
                   [hideLabel]="{'base': true, 'xs': false, 's': true, 'm': false, 'l': true, 'xl': false}">Some label
      </p-link-pure>
      <p-link-pure [href]="'https://www.porsche.com'"
                   [hideLabel]="{'base': true, 'xs': false, 's': true, 'm': false, 'l': true, 'xl': false}">Some label
    ...
    <div class="playground light" title="should render with specific icon">
      ...
      <p-link-pure [href]="'https://www.porsche.com'" [iconSource]="'assets/icon-custom-kaixin.svg'">Some label</p-link-pure>
    </div>
    ...
    <div class="playground light" title="should render with custom clickable area">
      ...
      <p-link-pure [hideLabel]="true" style="padding: 1rem;"><a href="https://www.porsche.com">Some label</a>
      </p-link-pure>
    </div>
