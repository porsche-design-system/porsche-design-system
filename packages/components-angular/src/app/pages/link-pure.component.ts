  ...
  template: `
    ...
    <div class="playground light" title="should render with different size">
      ...
      <p-link-pure [href]="'https://www.porsche.com'" [size]="'inherit'" style="font-size: 48px;"
        >Label size inherit</p-link-pure
      >
      <p-link-pure [size]="'inherit'" style="font-size: 48px;"
        ><a href="https://www.porsche.com">Label slotted size inherit</a></p-link-pure
      >
    </div>
    ...
    <div class="playground light" title="should render with multiline label">
      ...
      <p-link-pure style="width: 240px;"
        ><a href="https://www.porsche.com"
          >Label slotted multiline lorem ipsum dolor sit amet, consetetur sadipscing</a
        ></p-link-pure
      >
    </div>
    ...
    <div class="playground light" title="should render with custom clickable area">
      ...
      <p-link-pure [href]="'https://www.porsche.com'" [hideLabel]="true" style="padding: 1rem;"
        >Label with custom click-area</p-link-pure
      >
      <p-link-pure style="padding: 1rem;"
        ><a href="https://www.porsche.com">Label slotted with custom click-area</a></p-link-pure
      >
    ...
    <div class="playground light" title="should render with no icon">
      <p-link-pure [href]="'https://www.porsche.com'" [icon]="'none'">Label without icon</p-link-pure>
      <p-link-pure [icon]="'none'"><a href="https://www.porsche.com">Label slotted without icon</a></p-link-pure>
    ...
    <div class="playground light" title="should render icon if hide-label and icon none is set">
      <p-link-pure [href]="'https://www.porsche.com'" [hideLabel]="true" [icon]="'none'"
        >Label with hideLabel and no icon</p-link-pure
      >
      <p-link-pure [hideLabel]="true" [icon]="'none'"
        ><a href="https://www.porsche.com">Label slotted with hideLabel and no icon</a></p-link-pure
      >
    ...
    <div class="playground light" title="should align label to the left">
      <p-link-pure [href]="'https://www.porsche.com'" [alignLabel]="'left'">Label aligned left</p-link-pure>
      <p-link-pure [alignLabel]="'left'"><a href="https://www.porsche.com">Label slotted aligned left</a></p-link-pure>
    </div>
    ...
    <div class="playground light stretched-links" title="should render with stretched label">
      <p-link-pure [href]="'https://www.porsche.com'" [stretch]="true">Label stretched</p-link-pure>
      <p-link-pure [href]="'https://www.porsche.com'" [stretch]="true" [alignLabel]="'left'"
        >Label stretched aligned left</p-link-pure
      >
      <p-link-pure [stretch]="true"><a href="https://www.porsche.com">Label slotted stretched</a></p-link-pure>
      <p-link-pure [stretch]="true" [alignLabel]="'left'"
        ><a href="https://www.porsche.com">Label slotted stretched aligned left</a></p-link-pure
      >
    </div>
