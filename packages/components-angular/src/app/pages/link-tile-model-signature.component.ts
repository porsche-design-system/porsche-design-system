...
@Component({
  ...
  template: `
    <div class="playground light auto-layout" title="should render default">
    ...
    <div class="playground light auto-layout" title="should render with description">
    ...
    <div class="playground light auto-layout" title="should render different models">
    ...
    <div class="playground light auto-layout" title="should render different link directions">
    ...
    <div class="playground light auto-layout" title="should render with max width description text">
      <p-link-tile-model-signature
