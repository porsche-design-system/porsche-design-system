...
@Component({
  ...
  template: `
    ...
    <div class="playground light auto-layout" title="should render in indeterminate mode">
      <p-checkbox-wrapper [label]="'Some label'">
    ...
    <div class="playground light auto-layout" title="should render in loading state">
      <p-checkbox-wrapper [label]="'Some label'" [loading]="true">
        <input [type]="'checkbox'" [name]="'some-name'" />
      </p-checkbox-wrapper>
      <p-checkbox-wrapper [label]="'Some label'" [loading]="true">
    ...
    <div class="playground light auto-layout" title="should render with success state and no success message">
    ...
    <div class="playground light auto-layout" title="should render with error state but without error message">
