...
@Component({
  ...
  template: `
    ...
    <div class="playground light" title="should render with multiline label">
      ...
      <p-checkbox-wrapper state="error" label="Lorem ipsum dolor sit amet, consetetur sadipscing"
                          message="Lorem ipsum dolor sit amet, consetetur sadipscing" style="width: 240px;">
        <input type="checkbox" name="some-name"/>
      </p-checkbox-wrapper>
    </div>
  `
