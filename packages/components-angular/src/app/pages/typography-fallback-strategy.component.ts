...
@Component({
  selector: 'page-typography-fallback-strategy',
  template: `
    ...
    <div class="playground" title="should show typography in supported font-weights for greek and coptic charset">
      ...
      <p-text [weight]="'semi-bold'">Ταχίστη αλώπηξ βαφής ψημένη γη, δρασκελίζει υπέρ νωθρού κυνός</p-text>
      <p-text [weight]="'bold'">Ταχίστη αλώπηξ βαφής ψημένη γη, δρασκελίζει υπέρ νωθρού κυνός</p-text>
    </div>

    <div class="playground" title="should show typography in supported font-weights for vietnamese charset">
      <p-text [weight]="'regular'"
        ...
        đau đớn lòng. Lạ gì bỉ sắc tư phong, trời xanh quen với má hồng đánh ghen.</p-text
      >
    ...
    <div class="playground" title="should show typography in supported font-weights for cyril charset">
      ...
      <p-text [weight]="'semi-bold'">Эх, чужак, общий съём цен шляп (юфть) – вдрызг!</p-text>
    ...
    <div class="playground" title="should show typography in supported font-weights for chinese charset">
      ...
      <p-text [weight]="'semi-bold'">保时捷驾驶体验活动在线销售通用条款与条件</p-text>
    ...
    <div class="playground" title="should show typography in supported font-weights for korean charset">
      ...
      <p-text [weight]="'semi-bold'">키스의 고유조건은 입술끼리 만나야 하고 특별한 기술은 필요치 않다</p-text>
      <p-text [weight]="'bold'">키스의 고유조건은 입술끼리 만나야 하고 특별한 기술은 필요치 않다</p-text>
    </div>
  `,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class TypographyFallbackStrategyComponent {}
