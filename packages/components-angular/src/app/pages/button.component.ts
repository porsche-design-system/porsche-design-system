...
@Component({
  ...
  template: `
    ...
    <div class="playground dark auto-layout" title="should render button primary with label only on dark theme">
    ...
    <div class="playground dark auto-layout" title="should render button primary with label and icon on dark theme">
    ...
    <div class="playground dark auto-layout" title="should render button primary without label on dark theme">
    ...
    <div class="playground dark auto-layout" title="should render button primary as default with label only">
    ...
    <div class="playground dark auto-layout" title="should render button primary as default without label on dark theme">
    ...
    <div class="playground dark auto-layout" title="should render button secondary with label only on dark theme">
    ...
    <div class="playground dark auto-layout" title="should render button secondary with label and icon on dark theme">
    ...
    <div class="playground dark auto-layout" title="should render button secondary without label on dark theme">
    ...
    <div class="playground dark auto-layout" title="should render button primary with responsive label on dark theme">
      <p-button
        [theme]="'dark'"
    ...
    <div class="playground dark auto-layout" title="should render button with specific icon on dark theme">
    ...
    <div class="playground dark auto-layout" title="should render button with multiline label on dark theme">
      <p-button [theme]="'dark'" style="width: 15rem">Lorem ipsum dolor sit amet, consetetur sadipscing</p-button>
      <p-button [theme]="'dark'" style="width: 15rem" [icon]="'arrow-right'"
        >Lorem ipsum dolor sit amet, consetetur sadipscing</p-button
      >
      <p-button [theme]="'dark'" style="width: 15rem" [icon]="'arrow-right'" [loading]="true"
        >Lorem ipsum dolor sit amet, consetetur sadipscing</p-button
      >
    </div>
    ...
    >
      <p-button [theme]="'dark'" [variant]="'primary'" style="width: 100%">Some label</p-button>
      <p-button [theme]="'dark'" [variant]="'primary'" [icon]="'arrow-right'" style="width: 100%">Some label</p-button>
      <p-button [theme]="'dark'" [variant]="'primary'" [hideLabel]="true" [icon]="'arrow-right'" style="width: 100%"
        >Some label</p-button
      >
      <p-button [theme]="'dark'" [variant]="'primary'" [loading]="true" style="width: 100%">Some label</p-button>
      <p-button [theme]="'dark'" [variant]="'primary'" [disabled]="true" style="width: 100%">Some label</p-button>
    </div>
  `,
