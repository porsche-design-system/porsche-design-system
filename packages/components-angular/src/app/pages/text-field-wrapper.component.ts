...
@Component({
  ...
  template: `
    ...
    <div class="playground light" title="should render without label and without description">
      <p-text-field-wrapper label="Some label" description="Some description" hide-label="true">
        <input type="text" name="some-name"/>
      </p-text-field-wrapper>
    </div>
    ...
    <div class="playground light" title="should render with placeholder with disabled state">
      <p-text-field-wrapper label="Some label">
        <input type="text" name="some-name" placeholder="Some placeholder" disabled="disabled"/>
      </p-text-field-wrapper>
    </div>
    ...
    <div class="playground light" title="should render with type password in different states">
      ...
      <br>
      <p-text-field-wrapper label="Some label">
        <input type="password" name="some-name" value="some password" disabled="disabled"/>
      </p-text-field-wrapper>
      <br>
      <p-text-field-wrapper label="Some label">
        <input type="password" name="some-name" value="some password" readonly="readonly"/>
      </p-text-field-wrapper>
    </div>
    ...
    <div class="playground light" title="should render with type search in different states">
      ...
      <br>
      <p-text-field-wrapper label="Some label">
        <input type="search" name="some-name" disabled="disabled"/>
      </p-text-field-wrapper>
      <br>
      <p-text-field-wrapper label="Some label">
        <input type="search" name="some-name" readonly="readonly"/>
      </p-text-field-wrapper>
    </div>
    ...
    <div class="playground light"
      ...
      <p-text-field-wrapper label="Lorem ipsum dolor sit amet, consetetur sadipscing"
