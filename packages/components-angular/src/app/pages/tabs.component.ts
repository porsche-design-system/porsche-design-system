...
@Component({
  ...
  template: `
    ...
    <div class="playground dark" title="should render tabs size BreakpointCustomizable on dark background">
      <p-tabs
        [theme]="'dark'"
        [activeTabIndex]="9"
        [size]="{ base: 'small', xs: 'medium', s: 'small', m: 'medium', l: 'small', xl: 'medium' }"
    ...
    <div class="playground light surface" title="should render tabs gradientColor surface on light background">
    ...
    <div class="playground dark surface" title="should render tabs gradientColor surface on dark background">
      <p-tabs [theme]="'dark'" [gradientColor]="'background-surface'">
        <p-tabs-item [label]="'Tab 1'">Tab gradientColor 1</p-tabs-item>
        <p-tabs-item [label]="'Tab 2'">Tab gradientColor 2</p-tabs-item>
        <p-tabs-item [label]="'Tab 3'">Tab gradientColor 3</p-tabs-item>
        <p-tabs-item [label]="'Tab 4'">Tab gradientColor 4</p-tabs-item>
    ...
    <div class="playground light" title="should render tabs with slotted and deeply nested anchor on light background">
      <p-tabs>
    ...
    <div class="playground dark" title="should render tabs with slotted and deeply nested anchor on dark background">
      <p-tabs [theme]="'dark'">
        <p-tabs-item [label]="'Tab 1'">
          <span>
            Some slotted and deeply nested <a [href]="'#'">anchor</a>, <b>bold</b>, <strong>strong</strong>,
