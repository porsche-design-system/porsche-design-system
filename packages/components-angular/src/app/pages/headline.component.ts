...
@Component({
  ...
  template: `
    ...
    <div class="playground light" title="should show headline with different color variants">
    ...
    <div class="playground light" title="should show headline for variant customizable">
      <p-headline [variant]="{ base: 'large', l: 'x-large' }">Lorem ipsum dolor sit amet et.</p-headline>
    </div>

    <div class="playground light" title="should not automatically break words/strings by default">
    ...
    <div class="playground light" title="should consider only font-size definition on host element for variant inherit">
