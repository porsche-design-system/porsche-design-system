...
@Component({
  ...
  template: `<p-headline [variant]="'headline-2'" [tag]="'h2'">Basic</p-headline>
  <hr>
  <p-grid>
    <p-grid-item [size]="2">
  ...
  <p-grid>
    <p-grid-item [size]="5" [offset]="2">
      <div class="playground light spacing-block">
        <p-headline [variant]="'headline-3'" [color]="'default'" style="color: deeppink;">The quick brown fox jumps over
          the lazy dog
        </p-headline>
        <p-headline [variant]="'headline-3'" [color]="'inherit'" style="color: deeppink;">The quick brown fox jumps over
          the lazy dog
        </p-headline>
      </div>
      <hr>
  ...
  <p-grid>
    ...
    <p-grid-item size="5">
      <div class="playground dark spacing-block">
        ...
        <p-text [theme]="'dark'" [color]="'neutral-contrast-medium'" style="color: deeppink;">The quick brown fox jumps
          over the lazy dog
        </p-text>
        ...
        <p-text [theme]="'dark'" [color]="'notification-error'" style="color: deeppink;">The quick brown fox jumps over
          the lazy dog
        </p-text>
