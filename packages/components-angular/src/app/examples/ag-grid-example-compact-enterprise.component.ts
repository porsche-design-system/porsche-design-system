...
@Component({
  selector: 'app-company-logo-renderer-compact',
  standalone: true,
  template: `
...
@Component({
  selector: 'app-company-button-renderer-compact',
  standalone: true,
  template: `
    <span class="cell-centered'">
      <p-link-pure
...
@Component({
  selector: 'ag-grid-example-compact-enterprise',
  template: ` <div>
    <ag-grid-angular
      [modules]="modules"
...
export class AgGridExampleCompactEnterpriseComponent {
