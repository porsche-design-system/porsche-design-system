...
import { PHeading, PText, PTextList, PTextListItem } from '@porsche-design-system/components-react';
...
export const Example = () => {
  return (
    <>
      ...
      <PText className="mt-fluid-md">
        We are committed to ensuring digital accessibility for people with disabilities.
        <br />
        We are continually improving the user experience for everyone, and applying the relevant accessibility standards.
      </PText>

      <PHeading size="medium" className="mt-fluid-sm">
        <h2>
          Measures to support accessibility [optional - choose from list]
        </h2>
      </PHeading>

      <PText className="mt-fluid-md" weight="semi-bold">
      ...
      <PHeading size="medium" className="mt-fluid-md">
        <h2>
          Conformance status
        </h2>
      </PHeading>
      ...
      <PTextList className="mt-fluid-sm">
        <PTextListItem>
          E-mail: 
