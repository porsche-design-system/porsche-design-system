...
### Code Example: `inputNumberExampleForm`
...
### Interactive Story: `inputNumberStorySlots`

```vue
<script setup lang="ts">
  import { PButtonPure, PIcon, PInputNumber, PPopover } from '@porsche-design-system/components-vue';
</script>
