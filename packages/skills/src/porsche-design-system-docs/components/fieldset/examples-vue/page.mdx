...
<script setup lang="ts">
  import { PFieldset, PInputText } from '@porsche-design-system/components-vue';
</script>
...
```vue
<script setup lang="ts">
  import { PFieldset, PRadioGroup, PRadioGroupOption } from '@porsche-design-system/components-vue';
</script>
