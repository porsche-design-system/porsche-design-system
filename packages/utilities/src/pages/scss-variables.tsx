...
const darkThemeColors = {
  ...
  'theme-dark-notification-success-soft': '#e5f3e7',
  'theme-dark-notification-warning': '#ff9b00',
  'theme-dark-notification-warning-soft': '#fff5e5',
  'theme-dark-notification-error': '#fc1717',
  'theme-dark-notification-error-soft': '#fae6e6',
  'theme-dark-notification-neutral': '#2193ff',
  'theme-dark-notification-neutral-soft': '#e5eff8',
