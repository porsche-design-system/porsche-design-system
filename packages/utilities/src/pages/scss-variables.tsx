...
const defaultColors = {
  ...
  'theme-light-notification-success-low-contrast': '#e5f3e7',
  'theme-light-notification-warning': '#ff9b00',
  'theme-light-notification-warning-low-contrast': '#fff5e5',
  'theme-light-notification-error': '#e00000',
  'theme-light-notification-error-low-contrast': '#fae6e6',
  'theme-light-notification-neutral': '#0061bd',
  'theme-light-notification-neutral-low-contrast': '#e5eff8',
...
const darkThemeColors = {
  ...
  'theme-dark-notification-success-low-contrast': '#e5f8e8',
  'theme-dark-notification-warning': '#ff9b00',
  'theme-dark-notification-warning-low-contrast': '#fff5e5',
  'theme-dark-notification-error': '#fc1717',
  'theme-dark-notification-error-low-contrast': '#fee7e7',
  'theme-dark-notification-neutral': '#2193ff',
  'theme-dark-notification-neutral-low-contrast': '#e8f4ff',
