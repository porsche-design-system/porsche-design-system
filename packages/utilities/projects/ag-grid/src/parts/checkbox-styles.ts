...
import { borderWidthThin, colorContrastLower, colorFrostedSoft, colorPrimary, radiusLg, radiusMd } from '../styles';
...
export const checkboxStyleCompact: Part = createPart({
  feature: 'checkboxStyleCompact',
  css: `
    .ag-checkbox-input-wrapper {
