...
import { EmotionFocusVisible } from './app/emotion/EmotionFocusVisible.tsx';
...
import { VanillaExtractFocusVisible } from './app/vanilla-extract/VanillaExtractFocusVisible.tsx';
...
export const routes: RouteConfig[] = [
  ...
  { path: '/emotion/focus-visible', label: 'Emotion - Focus Visible', element: <EmotionFocusVisible /> },
  ...
  { path: '/vanilla-extract/focus-visible', label: 'Emotion - Focus Visible', element: <VanillaExtractFocusVisible /> },
