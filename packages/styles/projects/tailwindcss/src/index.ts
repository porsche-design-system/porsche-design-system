...
export const getTailwindcssTheme = () => {
  return `
    /*
     * Internal bridge variables (--_p-tw-*): a configured Tailwind prefix rewrites custom
     * properties from @theme, but @utility rules keep fixed names such as
     * var(--spacing-fluid-md). Utilities then resolve the wrong or unprefixed variables.
     * Declaring stable --_p-tw-* here (outside @theme) matches @utility references to
     * design tokens regardless of prefix. Semantic colors are updated again under @supports
     * below where scheme classes mirror @layer theme for browsers without light-dark().
     */
    :root {
      --_p-tw-spacing-fluid-md: ${spacingFluidMd};
      --_p-tw-radius-sm: ${radiusSm};
      --_p-tw-animate-skeleton: skeleton ${durationXl} ${easeInOut} infinite;
      --_p-tw-font-weight-normal: ${fontWeightNormal};
      --_p-tw-font-weight-semibold: ${fontWeightSemibold};
      --_p-tw-leading-normal: ${leadingNormal};
      --_p-tw-font-porsche-next: ${fontPorscheNext};
      --_p-tw-text-2xs: ${typescale2Xs};
      --_p-tw-text-xs: ${typescaleXs};
      --_p-tw-text-sm: ${typescaleSm};
      --_p-tw-text-md: ${typescaleMd};
      --_p-tw-text-lg: ${typescaleLg};
      --_p-tw-text-xl: ${typescaleXl};
      --_p-tw-text-2xl: ${typescale2Xl};
      --_p-tw-text-3xl: ${typescale3Xl};
      --_p-tw-text-4xl: ${typescale4Xl};
      --_p-tw-text-5xl: ${typescale5Xl};
      --_p-tw-color-primary: ${colorPrimary};
      --_p-tw-color-frosted: ${colorFrosted};
      --_p-tw-color-frosted-strong: ${colorFrostedStrong};
    }
    /* Same scheme overrides as @layer theme: keep internal colors aligned when light-dark() is unavailable. */
    @supports not (color: light-dark(white, black)) {
      :root, .scheme-light, .scheme-only-light, .scheme-normal, .scheme-light-dark {
        --_p-tw-color-primary: ${colorPrimaryLight};
        --_p-tw-color-frosted: ${colorFrostedLight};
        --_p-tw-color-frosted-strong: ${colorFrostedStrongLight};
      }
      .scheme-dark, .scheme-only-dark {
        --_p-tw-color-primary: ${colorPrimaryDark};
        --_p-tw-color-frosted: ${colorFrostedDark};
        --_p-tw-color-frosted-strong: ${colorFrostedStrongDark};
      }
  ...
  @utility grid-template {
    ...
    --_pds-grid-col: minmax(0, var(--pds-internal-grid-outer-column, calc(var(--pds-internal-grid-safe-zone) - var(--_p-tw-spacing-fluid-md))));
    display: grid;
    ...
    gap: var(--_p-tw-spacing-fluid-md);
  ...
  /* Skeleton */
  @utility skeleton {
    animation: var(--_p-tw-animate-skeleton);
    display: block;
    border-radius: var(--_p-tw-radius-sm);
    background-color: transparent;
    background-image: linear-gradient(to right, var(--_p-tw-color-frosted) 0%, var(--_p-tw-color-frosted-strong) 50%, var(--_p-tw-color-frosted) 100%);
  ...
  @utility prose-text-2xs {
    font: var(--_p-tw-font-weight-normal) var(--_p-tw-text-2xs) / var(--_p-tw-leading-normal) var(--_p-tw-font-porsche-next);
    color: var(--_p-tw-color-primary);
  }
  @utility prose-text-xs {
    font: var(--_p-tw-font-weight-normal) var(--_p-tw-text-xs) / var(--_p-tw-leading-normal) var(--_p-tw-font-porsche-next);
    color: var(--_p-tw-color-primary);
  }
  @utility prose-text-sm {
    font: var(--_p-tw-font-weight-normal) var(--_p-tw-text-sm) / var(--_p-tw-leading-normal) var(--_p-tw-font-porsche-next);
    color: var(--_p-tw-color-primary);
  }
  @utility prose-text-md {
    font: var(--_p-tw-font-weight-normal) var(--_p-tw-text-md) / var(--_p-tw-leading-normal) var(--_p-tw-font-porsche-next);
    color: var(--_p-tw-color-primary);
  }
  @utility prose-text-lg {
    font: var(--_p-tw-font-weight-normal) var(--_p-tw-text-lg) / var(--_p-tw-leading-normal) var(--_p-tw-font-porsche-next);
    color: var(--_p-tw-color-primary);
  }
  @utility prose-text-xl {
    font: var(--_p-tw-font-weight-normal) var(--_p-tw-text-xl) / var(--_p-tw-leading-normal) var(--_p-tw-font-porsche-next);
    color: var(--_p-tw-color-primary);
  }
  @utility prose-text-2xl {
    font: var(--_p-tw-font-weight-normal) var(--_p-tw-text-2xl) / var(--_p-tw-leading-normal) var(--_p-tw-font-porsche-next);
    color: var(--_p-tw-color-primary);
  }
  @utility prose-text-3xl {
    font: var(--_p-tw-font-weight-normal) var(--_p-tw-text-3xl) / var(--_p-tw-leading-normal) var(--_p-tw-font-porsche-next);
    color: var(--_p-tw-color-primary);
  }
  @utility prose-text-4xl {
    font: var(--_p-tw-font-weight-normal) var(--_p-tw-text-4xl) / var(--_p-tw-leading-normal) var(--_p-tw-font-porsche-next);
    color: var(--_p-tw-color-primary);
  }
  @utility prose-text-5xl {
    font: var(--_p-tw-font-weight-normal) var(--_p-tw-text-5xl) / var(--_p-tw-leading-normal) var(--_p-tw-font-porsche-next);
    color: var(--_p-tw-color-primary);
  }
  
  /* Typography: Heading */
  @utility prose-heading-2xs {
    font: var(--_p-tw-font-weight-semibold) var(--_p-tw-text-2xs) / var(--_p-tw-leading-normal) var(--_p-tw-font-porsche-next);
    color: var(--_p-tw-color-primary);
  }
  @utility prose-heading-xs {
    font: var(--_p-tw-font-weight-semibold) var(--_p-tw-text-xs) / var(--_p-tw-leading-normal) var(--_p-tw-font-porsche-next);
    color: var(--_p-tw-color-primary);
  }
  @utility prose-heading-sm {
    font: var(--_p-tw-font-weight-semibold) var(--_p-tw-text-sm) / var(--_p-tw-leading-normal) var(--_p-tw-font-porsche-next);
    color: var(--_p-tw-color-primary);
  }
