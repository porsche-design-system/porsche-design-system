...
/** A leaf carries either a `$`-prefixed variable `name` or a verbatim `raw` body. */
...
/** Serialize a single render node: a variable to `$name: value;` (with optional trailing comment), raw verbatim. */
