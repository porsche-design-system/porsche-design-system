...
export class FlexItem {
   ...
   */
  @Prop() alignSelf?: BreakpointCustomizable<"auto" | "start" | "end" | "center" | "baseline" | "stretch" | any> =
    "auto";

  /**
   * The ability to allow/disallow the flex child to grow.
   */
  @Prop() grow?: BreakpointCustomizable<0 | 1 | any> = 0;

  /**
   * The ability to allow/disallow the flex child to shrink.
   */
  @Prop() shrink?: BreakpointCustomizable<1 | 0 | any> = 1;

  /**
   * The shorthand property for the combined definition of "shrink", "grow" and "basis"
   */
  @Prop() flex?: BreakpointCustomizable<"initial" | "auto" | "none" | "equal" | any> = "initial";
