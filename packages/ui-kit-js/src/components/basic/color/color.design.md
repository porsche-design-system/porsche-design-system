...
### Sketch palette
Feel free to download the [Porsche color palette for Sketch](https://designsystem.porsche.com/latest/porsche-ui-kit-colors.sketchpalette) in order to use it as "Document Colors" or "Global Colors" in your color picker.
