...
| `color`    | `color`    | Basic text color variations depending on theme property.                                                                                                      | `"brand" \| "default" \| "inherit" \| "neutral-1" \| "neutral-2" \| "neutral-3" \| "notification-error" \| "notification-success" \| "notification-warning"` | `'default'` |
...
| `theme`    | `theme`    | Adapts the text color depending on the theme (#/web/components/has no effect when "inherit" is set as color prop).                                                             | `"dark" \| "light"`                                                                                                                                          | `'light'`   |
