...
| `variant`  | `variant`  | Style of the text. Also defines the style for specific breakpoints, like {base: "small", l: "medium"}. You always need to provide a base value when doing this. | `BreakpointValues<TextVariant> \| string`                                                             | `'small'`         |
