...
<Example noTheme={true} className="sg-example">
  <React.Fragment>
    <p-checkbox name="some-name" value="some-value">
      Unchecked <p-icon source="favorite"></p-icon> with an icon
    </p-checkbox>
    <p-checkbox name="some-name" value="some-value" checked="true">
      Checked <p-icon source="favorite"></p-icon> with an icon
    </p-checkbox>
    <p-checkbox name="some-name" value="some-value" disabled="true">
      Disabled <p-icon source="favorite"></p-icon> with an icon
    </p-checkbox>
    <p-checkbox name="some-name" value="some-value" error="true">
      Error <p-icon source="favorite"></p-icon> with an icon
    </p-checkbox>
    <p-checkbox name="some-name" value="some-value" disabled="true" error="true">
      Disabled with an error and <p-icon source="favorite"></p-icon> an icon
    </p-checkbox>
  </React.Fragment>
</Example>
...
<Example noTheme={true} className="sg-example">
  <React.Fragment>
    <p-checkbox name="some-name" value="some-value">
      Unchecked <a href="#">with a link</a>
    </p-checkbox>
    <p-checkbox name="some-name" value="some-value" checked="true">
      Checked <a href="#">with a link</a>
    </p-checkbox>
    <p-checkbox name="some-name" value="some-value" disabled="true">
      Disabled <a href="#">with a link</a>
    </p-checkbox>
    <p-checkbox name="some-name" value="some-value" error="true">
      Error <a href="#">with a link</a>
    </p-checkbox>
    <p-checkbox name="some-name" value="some-value" disabled="true" error="true">
      Disabled with an error and <a href="#">a link</a>
    </p-checkbox>
  </React.Fragment>
</Example>
