...
<Example noTheme={false} className="sg-example">
  {(theme) => {
    return (
      <React.Fragment>
        <p-button-icon label="open section" theme={theme} />
        <p-button-icon label="open section" theme={theme} disabled="true" />
        <p-button-icon label="loading" loading="true" theme={theme} />
      </React.Fragment>
    )
}}
</Example>
...
<Example noTheme={false} className="sg-example">
  {(theme) => {
    return (
      <React.Fragment>
        <p-button-icon label="open section" variant="ghost" theme={theme} />
        <p-button-icon label="open section" variant="ghost" theme={theme} disabled="true" />
        <p-button-icon label="loading" variant="ghost" loading="true" theme={theme} />
      </React.Fragment>
    )
}}
</Example>
...
<Example noTheme={false} className="sg-example">
  {(theme) => {
    return (
      <React.Fragment>
        <p-button-icon label="open section" variant="transparent" theme={theme} />
        <p-button-icon label="open section" variant="transparent" theme={theme} disabled="true" />
        <p-button-icon label="loading" variant="transparent" loading="true" theme={theme} />
      </React.Fragment>
    )
}}
</Example>
...
<Example noTheme={false} className="sg-example">
  {(theme) => {
    return (
      <p-button-icon label="phone call" icon="phone" theme={theme} />
    )
}}
</Example>
