...
<Example noTheme={false} className="sg-example-button-regular">
  {(theme) => {
    return (
      <React.Fragment>
        <p-button-regular icon="icon_phone" theme={theme}>Click Here!</p-button-regular>
      </React.Fragment>
    )
}}
</Example>
    ...
    return (
      <React.Fragment>
        <div style={wrapperStyle}>
          <p-button-regular icon="icon_phone" theme={theme}>Very long text lorem ipsum dolor sit amet consecutor lorem ipsum</p-button-regular>
        </div>
      </React.Fragment>
    )
}}
