...
import { stylesSpacingExample } from '@porsche-design-system/shared/examples';
import { themeLightBackgroundBase } from '@porsche-design-system/components-react/styles';

export const metadata = {
  title: 'Styles: Spacing - Porsche Design System',
  description: 'Spacing styles for the Porsche Design System',
};
...
<ComponentExample
  codeSample={stylesSpacingExample}
...
getStylesSpacingCodeSamples } from '@porsche-design-system/shared'; import { adjustSelectedFramework } from '@/utils';
import ExampleStylesSpacing from '@/pages/patterns/styles/example-spacing.vue';

@Component({ components: { ExampleStylesSpacing }, }) export default class Code extends Vue { codeExample =
getStylesSpacingCodeSamples();
