...
- Forms should **provide 100% keyboard navigation**, which means: Users should be able to jump through the whole form
  using the tab key.
- Always **provide focus states** so users can identify both their starting point and their current position as they move
  through the form. Porsche Design System form components include focus states by default.
