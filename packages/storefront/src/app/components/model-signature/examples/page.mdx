...
import {
  ...
  modelSignatureStoryMaskBlendMode, modelSignatureStoryMaskImage, modelSignatureStoryMaskVideo,
...
export const modelSignatureSafeZoneDefault = JSON.stringify(componentMeta["p-model-signature"].propsMeta.safeZone.defaultValue);
