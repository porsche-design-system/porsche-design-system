...
`aria` property with the `aria-label` value to provide more context for screen reader users. Phrases like "Detail"
...
support screen reader users, define an alternative video description:
