...
example, you might include an icon, a unit, or an action button. If you use a `p-button-pure`, make sure to set the
correct padding. Icons and text should use the `contrast-medium` color to avoid being mistaken for a button.
