...
In the **uncontrolled** approach, the input behaves similarly to a native `<input type="number" />`, automatically
...
<ComponentExample codeSample={inputNumberExampleForm} />
