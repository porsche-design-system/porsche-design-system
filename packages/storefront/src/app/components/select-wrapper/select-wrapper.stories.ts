...
export const selectWrapperStoryWithoutPreselection: Story<'p-select-wrapper'> = {
  state: {
    properties: { label: 'Some label' },
  },
  generator: ({ properties } = {}) => [
...
export const selectWrapperStoryFilter: Story<'p-select-wrapper'> = {
  state: {
    properties: { filter: true, label: 'Some label' },
  },
  generator: ({ properties } = {}) => [
    {
      tag: 'p-select-wrapper',
      ...
      children: [
        {
          ...
          children: [
            ...(Object.entries(options).map(([value, label]) => ({
              tag: 'option',
              properties: { value, ...(value === 'AQ' && { disabled: true }) },
              children: [label],
            })) as ElementConfig<'option'>[]),
          ],
        },
      ],
    },
...
export const selectWrapperStoryOptgroups: Story<'p-select-wrapper'> = {
  state: {
    properties: { label: 'Some label' },
  },
  generator: ({ properties } = {}) => [
      ...
      children: [
        {
          ...
          children: [
            ...
            },
            {
              ...
              children: [
                { tag: 'option', properties: { value: 'g' }, children: ['Option G'] },
                { tag: 'option', properties: { value: 'h' }, children: ['Option H'] },
                { tag: 'option', properties: { value: 'i' }, children: ['Option I'] },
              ],
            },
          ],
        },
...
export const selectWrapperStorySlots: Story<'p-select-wrapper'> = {
  state: {
