...
export const metadata = {
  ...
  description: 'Learn how to use the Porsche Design System\'s Textarea Wrapper component. Explore usage examples, configuration options, and behavior details in a fully controlled setup.'
}
...
<Notification heading="Deprecation hint" heading-tag="h2" state="error">
  ...
  Please use <a href="/components/textarea/">p-textarea</a> instead.
</Notification>
