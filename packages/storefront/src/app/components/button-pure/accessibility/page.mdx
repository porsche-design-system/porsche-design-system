...
| ARIA            | Usage                                                                                                                                         |
| --------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| `aria-label`    | Defines a string value that labels the interactive element. It's required for buttons with `hideLabel="true"`.                                |
...
If the button is used with the `hideLabel` prop, the `aria` prop is **required** to provide a meaningful label.
