...
import { inputTelStorySlots } from '@/app/components/input-tel/input-tel.stories';
...
<ComponentExample codeSample={inputTelExampleForm} />
...
<ComponentStory story={inputTelStorySlots} />
