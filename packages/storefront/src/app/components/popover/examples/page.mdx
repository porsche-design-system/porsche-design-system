...
import {
  popoverControlled,
  popoverControlledAiTagGenerated,
  popoverControlledAiTagModified,
} from '@/app/components/popover/popover.stories';
...
<TableOfContents headings={['Controlled', 'AI Tag Examples']} />
...
This example shows how to use the `p-popover` component with an AI tag to mark contents as "AI-generated" to provide
additional information, such as its source or context.

### For content generated entirely with AI

<ComponentStory story={popoverControlledAiTagGenerated} />

### For content that has been modified with AI

<ComponentStory story={popoverControlledAiTagModified} />
