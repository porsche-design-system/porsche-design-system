...
import { popoverControlled, popoverControlledAiTag } from '@/app/components/popover/popover.stories';
...
<TableOfContents headings={['Controlled', 'AI Tag Example']} />
...
**The following considerations must be also taken into account:**
...
<ComponentStory story={popoverControlledAiTag} />
