...
import Accessibility from '@/app/components/accordion/accessibility/page.mdx';
...
import { accordionStoryInteractiveSummary } from '@/app/components/accordion/examples/interactive-elements-in-summary/story';
import StickyDescription from '@/app/components/accordion/examples/sticky-summary/example.mdx';
import { accordionStoryStickySummary } from '@/app/components/accordion/examples/sticky-summary/story';
import Usage from '@/app/components/accordion/usage/page.mdx';
