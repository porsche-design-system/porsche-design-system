...
export const metadata = {
  ...
  description: 'Learn how to use the Porsche Design System\'s Select component. Explore usage examples, configuration options, and behavior details in a fully controlled setup.'
}

# Select <ComponentStatus tagName="p-select"></ComponentStatus>

The `p-select` component is a versatile custom form element that enables the selection of a single option. It can be
