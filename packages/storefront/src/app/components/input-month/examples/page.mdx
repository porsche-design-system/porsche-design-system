...
import { inputMonthStorySlots } from '@/app/components/input-month/input-month.stories';
...
In the **uncontrolled** approach, the input behaves similarly to a native `<input type="month" />`, automatically
...
<ComponentExample codeSample={inputMonthExampleForm} />
...
<ComponentStory story={inputMonthStorySlots} />
