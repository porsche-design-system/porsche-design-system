...
import ColorCssVarDescription from '@/app/components/icon/examples/color-css-var/example.mdx';
import { iconStoryColorCSSVar } from '@/app/components/icon/examples/color-css-var/story';
import ColorDescription from '@/app/components/icon/examples/color/example.mdx';
import { iconStoryColor } from '@/app/components/icon/examples/color/story';
...
import ResponsiveSizeDescription from '@/app/components/icon/examples/responsive-size/example.mdx';
import { iconStoryResponsiveSize } from '@/app/components/icon/examples/responsive-size/story';
import SizeCssVarDescription from '@/app/components/icon/examples/size-css-var/example.mdx';
import { iconStorySizeCSSVar } from '@/app/components/icon/examples/size-css-var/story';
import SizeDescription from '@/app/components/icon/examples/size/example.mdx';
import { iconStorySize } from '@/app/components/icon/examples/size/story';
