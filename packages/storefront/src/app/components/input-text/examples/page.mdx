...
import { inputTextExample, inputTextExampleControlled } from '@porsche-design-system/shared/examples';
...
The `p-input-text` component is a form-associated custom element that integrates seamlessly with forms. Leveraging the
...
<ComponentExample codeSample={inputTextExample} />

## Controlled

In the controlled approach, the `p-input-text` value is externally managed. While the internal value will be updated
