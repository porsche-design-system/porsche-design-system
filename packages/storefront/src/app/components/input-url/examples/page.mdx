...
import { inputUrlStorySlots } from '@/app/components/input-url/input-url.stories';
...
In the **uncontrolled** approach, the input behaves similarly to a native `<input type="url" />`, automatically
...
<ComponentExample codeSample={inputUrlExampleForm} />
...
<ComponentStory story={inputUrlStorySlots} />
