...
import { inputWeekStorySlots } from '@/app/components/input-week/input-week.stories';
...
In the **uncontrolled** approach, the input behaves similarly to a native `<input type="week" />`, automatically
...
<ComponentExample codeSample={inputWeekExampleForm} />
...
<ComponentStory story={inputWeekStorySlots} />
