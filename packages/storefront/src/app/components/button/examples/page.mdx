...
<Notification heading="Attention" heading-tag="h2" state="warning">
  ...
  it relies on the <Link href="https://developer.mozilla.org/en-US/docs/Web/API/ElementInternals">ElementInternals</Link> API, which has limited
  ...
  to be passed as an argument to the <code>requestSubmit()</code> function (<Link href="https://github.com/WICG/webcomponents/issues/814">WICG/webcomponents#814</Link>).
