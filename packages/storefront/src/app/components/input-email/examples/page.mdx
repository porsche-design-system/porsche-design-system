...
import { inputEmailStorySlots } from '@/app/components/input-email/input-email.stories';
...
In the **uncontrolled** approach, the input behaves similarly to a native `<input type="email" />`, automatically
...
<ComponentExample codeSample={inputEmailExampleForm} />
...
<ComponentStory story={inputEmailStorySlots} />
