...
export const metadata = {
  title: 'Tailwind CSS: Drop Shadow - Porsche Design System',
  description:
    'Learn how to properly use the Drop Shadow style with best practices and guidelines for effective design and user experience.',
};
