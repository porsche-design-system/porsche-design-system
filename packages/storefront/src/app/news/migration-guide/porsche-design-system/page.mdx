...
- Design Tokens are exposed as CSS variables, and all component styles are built directly upon them
  - [Colors](/stylesheets/color/examples/)
...
- Removed deprecated prop `width`, instead the component is aligned with the **[Porsche Grid](/stylesheets/grid/)**
  "extended" by default.
...
- Removed deprecated prop `wrap-content`. The component is always aligned with the
  **[Porsche Grid](/stylesheets/grid/)** now, adjustable by prop `width`.
