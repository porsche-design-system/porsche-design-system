...
export const metadata = {
  ...
  description: 'Learn how to migrate from Porsche Design System v2 to v3.'
}

# Migration Guide

<TableOfContents headings={['Migrate from Porsche Design System v2 to v3','Notable New Features','👹 Breaking Changes','🤡 Component deprecations','🤖 Property deprecations','👾 Property value deprecations']} />
...
<Notification heading="Deprecation hint" headingTag="h3" state="error">
  Porsche Design System **v2** support will end on **June 30th, 2023** (until EOL date only critical bug fixing takes place).

  **Please make sure that upgrading to Porsche Design System v3 is feasible before the EOL date.**
</Notification>
...
- Event `update` is deprecated, use new event `change`.
