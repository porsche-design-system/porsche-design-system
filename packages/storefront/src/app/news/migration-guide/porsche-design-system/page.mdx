...
### Legacy Border-Radius Support (My Porsche App)

If you need to maintain visual consistency with the **My Porsche App** (legacy styles), you can force the previous
border-radius specifications by importing an optional CSS override.

To enable this, add the following import to your **main CSS file** after the mandatory global styles:
