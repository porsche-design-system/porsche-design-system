...
import { PDisplay, PLinkTile, PCarousel, PLinkPure, PText } from '@porsche-design-system/components-react/ssr';
...
{/* <Image className="row-start-1 col-start-1 w-full h-[90vh] object-cover" src="assets/design-system-hero-image.jpg" width={1052} height={1398} alt="Some wireframes" /> */}
  ...
  slot="background"
    ...
    <PDisplay className="z-20 mt-lg ms-lg row-start-1 col-start-1 max-w-3xl dark:text-primary text-background-base" size="large" color="inherit">
    ...
    <a
          ...
          tabindex="-1"
        >
    <div className="backdrop-blur-sm bg-background-surface max-w-lg bottom-0 left-0 m-4 p-6 bg-white rounded-lg shadow-lg flex justify-between items-center gap-4"
         style={{ marginBottom: '5%', marginLeft: '5%' }}>
      <div className="flex flex-col">
      <PText size="small"  weight="semi-bold">Release Note</PText>
      <PText size="small" color="contrast-medium">Checkout the latest release v3.22.0</PText>
      </div>
      ...
      <article className="mt-2xl col-span-full xs:col-start-4 xs:col-end-10">
        ...
        This is your all-in-one toolkit for creating high-quality, visually stunning web applications.
        With intuitive Figma libraries, robust Web Components, and comprehensive guidelines, it’s built 
        and tested to embody Porsche’s signature quality and design principles.
        </PText>
        ...
        <div className="relative bg-background-surface-dark rounded-lg overflow-hidden group aspect-[16/9]">
          ...
          >
            ...
            <div className="absolute bottom-0 w-full bg-white/70 px-md py-md flex justify-between box-border text-background-base dark:text-primary">
              ...
              <PLinkPure size="medium" hideLabel={true} href="https://porsche.com" tabindex="0" color="inherit">
              </PLinkPure>
            </div>
          </a>
        </div>
    ...
    <div className="flex-shrink-0">
      ...
      <div className="mt-2xl mb-2xl grid gap-md sm:grid-cols-2 col-span-full xs:col-start-2 xs:col-end-12">
        ...
        <div>
          ...
          We value your feedback, ideas, and contributions to help create the best possible experience
          with the Porsche Design System. Ready to get involved? Start by exploring our contributing 
          guidelines!
          </PText>
          <PLinkPure className="mt-md" size="small" href="https://porsche.com" tabindex="0" color="inherit">
      ...
      <div className="bg-background-surface rounded-lg mt-xl mb-xl pb-32 grid gap-md sm:grid-cols-full col-span-full xs:col-start-1 xs:col-end-13">
        <article className="mt-2xl mb-xl max-w-prose mx-auto ">
          ...
          The design system offers a variety of benefits compared individual solutions: Saving time and effort while accelerating the development process through reusable components, consistent guidelines, and seamless integration.
          </PText>
        </article>
          <PCarousel width="extended">
            <div>      
              <article className="place-items-center min-h-[600px] mt-sm mb-sm grid gap-md sm:grid-cols-2 col-span-full xs:col-start-2 xs:col-end-12 bg-background-base rounded-lg p-[100px]">
                ...
                The ability to update styles, tokens, and components at any time ensures flexibility, continuous improvement, and alignment with evolving design trends.              
                </PText>
                </div>
                <div className="relative w-full h-full">
                  <Image
            ...
            <div>      
              <article className="place-items-center min-h-[600px] mt-sm mb-sm grid gap-md sm:grid-cols-2 col-span-full xs:col-start-2 xs:col-end-12 bg-background-base rounded-lg p-[100px]">
                ...
                <PText size="large" className="" color="contrast-medium" align="left">
                Ensures an inclusive experience by meeting accessibility standards, enhancing usability, compliance, and overall satisfaction for people with diverse abilities.                
                </PText>
                </div>
                <div className="relative w-full h-full">
                  <Image
            ...
            <div>      
              <article className="place-items-center min-h-[600px] mt-sm mb-sm grid gap-md sm:grid-cols-2 col-span-full xs:col-start-2 xs:col-end-12 bg-background-base rounded-lg p-[100px]">
                ...
                <PText size="large" className="" color="contrast-medium" align="left">
                Built on Porsche's design guidelines, it ensures alignment with the brand’s identity, delivering a cohesive and premium user experience.
                </PText>
                </div>
                <div className="relative w-full h-full">
                  <Image
      ...
      <div className="mt-xl grid gap-md sm:grid-cols-2 col-span-full xs:col-start-2 xs:col-end-12">
        ...
        <div className="mt-md mb-xl flex flex-col gap-md items-start">
          <PLinkPure icon="external" size="medium" href="https://porsche.com" tabindex="0" color="inherit">
            Github Repository
          </PLinkPure>
          <PLinkPure icon="external" size="medium" href="https://porsche.com" tabindex="0" color="inherit">
