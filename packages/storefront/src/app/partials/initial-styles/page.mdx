...
<PartialDocs name="getInitialStyles" location="head" partialCalls={[
  {
    params: [],
  },
  {
...
<Notification heading="Hint" headingTag="h3" state="success">
  ...
  By entering `document.porscheDesignSystem` in the browser console of your application, it's possible to find out which prefixes are used.
</Notification>
