...
export const metadata = {
  title: 'Partials: Font Face Stylesheet - Porsche Design System',
  description: 'Learn how to optimize the font loading behaviour in your app.',
}
...
<Notification heading="Deprecation hint" headingTag="h2" state="warning">
...
<PartialDocs name="getFontFaceStylesheet" location="head" partialCalls={[
  {
    params: [],
  },
  {
