...
export const metadata = {
  title: 'Partials: Loader Script - Porsche Design System',
  description: 'Learn how to integrate the Porsche Design System loader script into your app.',
};
...
When using `porsche-design-system/components-{angular|react}` our core loader gets bundled into your application. This
...
<PartialDocs
  ...
  partialCalls={[
    ...
    {
      comment: 'Alternative: With custom prefix',
      params: [
        {
          key: 'prefix',
          value: 'custom-prefix',
    ...
    {
      comment: 'Alternative: With multiple custom prefixes',
      params: [
        {
          key: 'prefix',
...
@Component export default class Code extends Vue { public params = [ { value: "" }, { value: "{ prefix: 'my-prefix' }",
comment: 'with custom prefix' }, { value: "{ prefix: ['my-prefix', 'another-prefix'] }", comment: 'with multiple custom
prefixes' }, ]; }

</script> */}

{/\* <style scoped lang="scss"> :deep(table code::before) { content: '' !important; }
