...
export const metadata = {
  title: 'Next.js: Form - Porsche Design System',
  description: 'Form integration in Next.js with the Porsche Design System.',
};
...
Porsche Design System form components can be integrated into Next.js using different techniques based on your state
...
A complete example of how to integrate form components with Next.js can be explored here:

<WebsiteViewer sourceCodePath="frameworks/next-js" viewPath="next-js" title="Next.js: Demo application" />
