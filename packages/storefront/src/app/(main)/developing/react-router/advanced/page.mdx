...
<TableOfContents headings={['Global Theme', 'SSR', 'Prefixing']} />
...
The sub-package `@porsche-design-system/components-react/ssr` is a specialized build of the Porsche Design System
