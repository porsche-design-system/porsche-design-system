...
First, we need to understand how a web component works before we can look at how to optimize its bootstrapping behavior.
...
<Notification heading="Hint" headingTag="h4" state="warning">
  This works especially well in a plain HTML and Vanilla JS setup, since the `index.js` would otherwise be bundled by
