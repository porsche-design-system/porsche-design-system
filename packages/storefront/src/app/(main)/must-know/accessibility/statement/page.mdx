...
import { statementStory } from '@/app/(main)/must-know/accessibility/statement/statement.story';
import Link from 'next/link';

export const metadata = {
  title: 'Accessibility: Statement - Porsche Design System',
  description:
    'An accessibility statement is a powerful declaration of commitment. Here we provide a template for an accessibility statement.',
};
