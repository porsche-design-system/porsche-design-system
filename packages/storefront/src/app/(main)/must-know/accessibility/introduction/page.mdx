...
When generating or modifying UI with GitHub Copilot, Claude Code, or Cursor, install the
...
so agents apply **WCAG 2.2 AA** and **EN 301 549** from the start. See the
[**AI Agent Context**](/must-know/accessibility/ai-agent-context/) guide for APM-based installation.
...
For AI coding assistants, install generation context via
[AI Agent Context](/must-know/accessibility/ai-agent-context/) and run product audits via
