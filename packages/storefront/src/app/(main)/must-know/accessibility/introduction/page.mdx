...
For your own product applications, you can run **AI-assisted accessibility audits** with GitHub Copilot and the
[accessibility-agents](https://github.com/porsche-design-system/accessibility-agents) web audit bundle. See the
[**Web Accessibility Audit**](/must-know/accessibility/ai-accessibility-audit/) guide for installation with
`install-web-audit.sh`, prerequisites, and example prompts.
