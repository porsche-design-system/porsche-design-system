...
For your own product applications, you can run **AI-assisted accessibility audits** with browser automation and
axe-core. See the [**AI Accessibility Audit**](/must-know/accessibility/ai-accessibility-audit/) guide for
prerequisites, tooling, and example prompts.
