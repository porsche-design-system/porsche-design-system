...
import { inputPasswordA11yExamples } from '@/app/(main)/components/input-password/accessibility/stories';
...
<A11yIntegrationExamples examples={inputPasswordA11yExamples} />
## Limitations
