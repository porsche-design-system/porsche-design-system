...
import { ariaOnComponentHostVsAriaPropA11yExample } from '@/app/(main)/components/input-password/accessibility/examples/aria-on-component-host-vs-aria-prop/example';
