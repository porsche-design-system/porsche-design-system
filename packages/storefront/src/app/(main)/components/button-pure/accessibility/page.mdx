...
"Detail," or "Show" can be unclear when read out of context by a screen reader. In such instances, provide an
...
```js
<p-button-pure icon="plus">Add</p-button-pure>
```

✅ Recommended

```js
<p-button-pure icon="plus" aria="{ 'aria-label': 'Add item XYZ to shopping cart' }">Add</p-button-pure>

// or use descriptive visible text

<p-button-pure icon="plus">Add item XYZ to cart</p-button-pure>
```
