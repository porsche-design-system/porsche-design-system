...
import { stepperHorizontalA11yExamples } from '@/app/(main)/components/stepper-horizontal/accessibility/stories';
...
<A11yIntegrationExamples examples={stepperHorizontalA11yExamples} />
## Tests
