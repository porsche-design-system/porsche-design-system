...
import { segmentedControlA11yExamples } from '@/app/(main)/components/segmented-control/accessibility/stories';
...
<A11yIntegrationExamples examples={segmentedControlA11yExamples} />
## Tests
