...
```js
<p-heading tag="h1" size="xl">Configure your Porsche</p-heading>
<p-heading tag="h4" size="md">Delivery options</p-heading>
```
...
```js
<p-heading tag="h1" size="xl">Configure your Porsche</p-heading>
<p-heading tag="h2" size="md">Delivery options</p-heading>
```
