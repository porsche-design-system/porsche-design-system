...
export const metadata = {
  ...
  description: 'Guidance for using the Select component effectively in design and development.'
}
...
- Use it to search and choose a single option from a list — for example to trigger an action based on the selection or
to navigate the user to a new position — and recommend a default option for most users.
