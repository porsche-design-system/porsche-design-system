...
<p-popover>
  <button slot="button" type="button" aria-label="Specification details">i</button>
  Additional specification details.
</p-popover>
```

Custom slotted buttons do not receive managed `aria-expanded` state. See Limitations below.
