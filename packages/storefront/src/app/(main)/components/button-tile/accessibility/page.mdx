...
import { buttonTileA11yExamples } from '@/app/(main)/components/button-tile/accessibility/stories';
...
<A11yIntegrationExamples examples={buttonTileA11yExamples} />
...
To support screen reader users, define an alternative video description:
