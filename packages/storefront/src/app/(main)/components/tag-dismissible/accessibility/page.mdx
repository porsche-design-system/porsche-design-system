...
import { tagDismissibleA11yExamples } from '@/app/(main)/components/tag-dismissible/accessibility/stories';
...
<A11yIntegrationExamples examples={tagDismissibleA11yExamples} />
## Tests
