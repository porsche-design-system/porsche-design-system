...
```js
<p-tag-dismissible><p-icon name="watch-sport-chrono"></p-icon></p-tag-dismissible>
```

✅ Recommended

```js
<p-tag-dismissible label="Sport Chrono Package"><p-icon name="watch-sport-chrono"></p-icon></p-tag-dismissible>
```
