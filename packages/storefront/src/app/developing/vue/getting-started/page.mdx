...
<TableOfContents
  headings={['Quick start', 'Integration', 'Plugin', 'When are Porsche Design System components initialized?']}
/>

## Quick start

To build your own [Vue](https://vuejs.org/guide/quick-start.html) application using the Porsche Design System's Vue
