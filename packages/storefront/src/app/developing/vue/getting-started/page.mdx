...
- FOUC (Flash of Unstyled Content) handling
- Normalize styles
...
[China CDN](/developing/vue/advanced#china-cdn) for more details.
...
When using Tailwind, use the Tailwind-specific import instead of the default:
...
This import includes the Tailwind theme, color variables, fonts, and base styles (like FOUC handling). The default CSS
file `@porsche-design-system/components-vue` is not needed with Tailwind.
