...
To build a [Vue](https://vuejs.org/guide/quick-start.html) application using Porsche Design System Components, follow
these steps. This guide is based on the following dependencies:
