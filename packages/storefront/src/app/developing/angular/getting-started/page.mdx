...
To build your own Angular application using the Porsche Design System Components
`@porsche-design-system/components-angular`, follow these steps:
...
The following integration example uses a standard Angular setup.
...
Create a configuration file for PostCSS. This file, typically named `.postcssrc.json`, tells PostCSS to use the Tailwind
CSS plugin.
