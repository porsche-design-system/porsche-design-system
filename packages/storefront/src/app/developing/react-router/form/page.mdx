...
<div className="flex flex-wrap gap-static-md mt-fluid-lg">
  <PLinkPure icon="external">
    {/* prettier-ignore */}
    <Link href={`https://github.com/porsche-design-system/examples/tree/v${localPorscheDesignSystemMajorVersion}/frameworks/react-router`}>Source Code</Link>
  </PLinkPure>
  <PLinkPure icon="external">
    <Link
      href={`https://porsche-design-system.github.io/examples/v${localPorscheDesignSystemMajorVersion}/react-router`}
    >
      View Fullscreen
    </Link>
  </PLinkPure>
...
<iframe
  ...
  src={`https://porsche-design-system.github.io/examples/v${localPorscheDesignSystemMajorVersion}/react-router`}
/>
