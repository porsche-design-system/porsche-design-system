...
<div className="flex flex-wrap gap-static-md mt-fluid-lg">
  <PLinkPure icon="external">
    {/* prettier-ignore */}
    <Link href={`https://github.com/porsche-design-system/examples/tree/v${majorVersion}/frameworks/next-js`}>Source Code</Link>
  </PLinkPure>
  <PLinkPure icon="external">
    <Link href={`https://porsche-design-system.github.io/examples/v${majorVersion}/next-js`}>View Fullscreen</Link>
  </PLinkPure>
</div>
...
<iframe
  ...
  src={`https://porsche-design-system.github.io/examples/v${majorVersion}/next-js`}
/>
