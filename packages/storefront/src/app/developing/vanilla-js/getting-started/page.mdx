...
To build your own Vanilla JS application using the Porsche Design System Components
`@porsche-design-system/components-js`, follow these steps:
...
The following integration example uses a standard Vanilla JS with Vite + TypeScript (optional) setup.
