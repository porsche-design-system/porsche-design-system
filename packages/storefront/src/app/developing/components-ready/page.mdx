...
<TableOfContents headings={["Basic Example","Advanced Example","Testing","Component Readiness Explained","Basic Example (When Defined)"]} />
...
<Notification heading="Attention" state="warning">
  Before proceeding, consider using the `whenDefined` function from the [CustomElementRegistry](https://developer.mozilla.org/en-US/docs/Web/API/CustomElementRegistry">) API.
  If you're unsure, review our [comparison](/developing/components-ready#component-readiness-explained) and [example usage](/developing/components-ready#basic-example-when-defined) for guidance.
</Notification>
