...
export const metadata = {
  title: 'Security: Vulnerabilities - Porsche Design System',
  description: 'Learn how the Porsche Design System protects your app from common vulnerabilities and exposures (CVE).',
}
