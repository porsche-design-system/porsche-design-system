...
which uses the same button, it becomes instantly available because it is already cached in the browser. This means
fewer network requests and shorter loading times for the second and every subsequent application.
