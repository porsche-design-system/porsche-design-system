...
export const metadata = {
  title: 'Performance: Loading Behaviour - Porsche Design System',
  description:
    'Learn how to prevent Flash of Unstyled Content (FOUC) and Flash of Unstyled Text (FOUT) to boost your application.',
};

# Performance

<TableOfContents headings={['Prevent Flash of Unstyled Content (FOUC)', 'Prevent Flash of Unstyled Text (FOUT)']} />
...
- [Add FOUC CSS rule](/must-know/initialization/vanilla-js/#preparation)
