...
export const metadata = {
  title: 'Definition of Done - Porsche Design System',
  description: 'We value high quality and transparency - our Definition of Done (DOD) criteria.',
};

# Definition Of Done

<TableOfContents headings={['Current Criteria','Potential Future Criteria','Legend']} />

We value high quality and transparency. Thus we consider a task or ticket only done when all of the following criteria
are fulfilled as our **Definition of Done** (DOD).
