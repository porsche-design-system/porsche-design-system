...
export const metadata = {
  title: 'Initialization: Next JS - Porsche Design System',
  description: 'Learn how to initialize and set up the Porsche Design System in your Next.js app.',
};
...
When looking at Next.js, we need to cover two different scenarios: the **server side** and the **client side**.
