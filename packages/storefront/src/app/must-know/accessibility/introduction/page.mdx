...
export const metadata = {
  ...
  description: 'Accessibility is a key aspect of the Porsche Design System. Learn more about the importance of accessibility and how we ensure compliance.',
}

# Accessibility

<TableOfContents headings={["What is Accessibility","Why it matters","How we reach and sustain accessibility compliance","Further information"]} />
...
<PLink href="https://ux.porsche.com/d/6VNB3CeLHcJz/accessibility#/accessibility/introduction">Accessibility of digital products at Porsche</PLink>
