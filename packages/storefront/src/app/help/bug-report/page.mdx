...
import {OpenBugTemplateInStackBlitz} from "@/components/common/OpenBugTemplateInStackBlitz";
import {fetchPdsVersions} from "@/utils/fetchPdsVersions";

export const metadata = {
  title: 'Bug Report - Porsche Design System',
  description: 'If you encounter a bug by using the Porsche Design System, please report it to us and help us improve.',
}

# Bug Report

<TableOfContents headings={["Introduction","Reproduction","GitHub Workflow"]} />
...
<OpenBugTemplateInStackBlitz pdsVersions={await fetchPdsVersions()} />

StackBlitz Workflow:

1. Before making any changes in StackBlitz, please fork the setup:
   ![fork stackblitz reproduction example](assets/stackblitz-fork.png)
2. Add your minimal reproduction example.
3. Make sure to save your changes:
   ![save stackblitz reproduction example](assets/stackblitz-save.png)
4. Once your reproduction example is set and saved, copy the **Editor URL**:
   ![share stackblitz reproduction example](assets/stackblitz-share.png)
