  ...
  <div class="wrapper">
    ...
    <div class="motion-example-wrapper">
      ...
      <p class="description">
        ...
        middle, and then gently decelerates towards the end. It's a commonly used easing curve that provides a natural
        and visually pleasing animation transition.
      </p>
      <div class="moving-standard tile" @click="onClick"></div>
    </div>
    <div class="motion-example-wrapper">
      <h4 class="heading heading--small">Acceleration: 0%, Deceleration: 80%</h4>
      <p class="description">
        Objects rush onto the screen with maximum speed, then gradually ease into a gentle slowdown until they come to a
        stop.
      </p>
      <div class="moving-in tile" @click="onClick"></div>
    </div>
    <div class="motion-example-wrapper">
      ...
      <div class="moving-out tile" @click="onClick"></div>
    </div>
  </div>
</template>
...
<script lang="ts">
  ...
  @Component
  export default class ExampleStylesMotionCurves extends Vue {
