...
Have you ever had a problem using a desktop site on a mobile phone, or seen the message "This content is not available in your area", or couldn't read a text because the font-size and contrast was to low? Those are all accessibility issues we have to face with and find practical solutions.
