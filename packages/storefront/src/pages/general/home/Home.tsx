          ...
          <Spacing marginTop={24} className="p-spacing-mt--0-m">
            <Grid.Child size={{base: 12, m: 8}}>
              <Text type="3-regular">
                ...
                products. Ready to use as reusable Sketch
                libraries, coded React components or HTML and CSS elements. Everything built and tested following the
                Porsche quality standards and corporate
                design principles.
              </Text>
              <Spacing marginTop={8}>
                <Text>
