...
export const Playground = ({
  ...
  return (
    <div className="playground mt-fluid-md border-thin border-contrast-20 rounded-lg">
      <div
        className={`demo p-static-lg border-b-thin border-contrast-20 bg-${backgroundColor} rounded-t-lg`}
