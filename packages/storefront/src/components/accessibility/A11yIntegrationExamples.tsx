...
import {
  A11yIntegrationExamplesClient,
  type CompleteFrameworkMarkup,
  type ResolvedAccessibilityExample,
} from './A11yIntegrationExamplesClient';
...
): CompleteFrameworkMarkup =>
  Object.fromEntries(
    frameworks.map((framework) => [framework, resolveExamplePayload(payload, framework, { tag, key, side, framework })])
  ) as CompleteFrameworkMarkup;
