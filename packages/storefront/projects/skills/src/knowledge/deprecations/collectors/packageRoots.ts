 ...
 * actually gets — the shipped SCSS partials, the generated Tailwind theme, and the Emotion /
 * vanilla-extract sources — rather than reaching across the monorepo by relative path.
 *
...
export const scssRoot = (): string => packageRoot('@porsche-design-system/scss');
export const tailwindcssRoot = (): string => packageRoot('@porsche-design-system/tailwindcss');
export const emotionRoot = (): string => packageRoot('@porsche-design-system/emotion');
export const vanillaExtractRoot = (): string => packageRoot('@porsche-design-system/vanilla-extract');
