...
export const config: StorefrontConfig = {
  ...
  Components: {
    ...
    Color: {
      // @ts-ignore
      Examples: [() => import('@/../components/src/components/color/color.examples.md')],
      // @ts-ignore
      Usage: [() => import('@/../components/src/components/color/color.usage.md')],
    },
    'Content Wrapper': {
      // @ts-ignore
    ...
    Spacing: {
      // @ts-ignore
      Examples: [() => import('@/../components/src/components/spacing/spacing.examples.md')],
      // @ts-ignore
      Usage: [() => import('@/../components/src/components/spacing/spacing.usage.md')],
    },
    'Segmented Control': {
      // @ts-ignore
    ...
    Typography: {
      // @ts-ignore
      Text: [() => import('@/../components/src/components/typography/text/text.code.md')],
      // @ts-ignore
      Headline: [() => import('@/../components/src/components/typography/headline/headline.code.md')],
      // @ts-ignore
      Usage: [() => import('@/../components/src/components/typography/typography.usage.md')],
      Props: [
        // @ts-ignore
        () => import('@/../components/src/components/typography/headline/headline.props.md'),
        // @ts-ignore
        () => import('@/../components/src/components/typography/text/text.props.md'),
      ],
    },
  },
  Help: {
