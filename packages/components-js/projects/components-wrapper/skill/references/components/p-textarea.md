...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-textarea/examples/Default.html](./p-textarea/examples/Default.html) |
| Form | The `p-textarea` can be integrated into a form in two ways: **controlled** or **uncontrolled**, depending on your needs. | [./p-textarea/examples/Form.html](./p-textarea/examples/Form.html) |
| Slots | Use named slots when `label`, `description` or `message` need markup such as a link. | [./p-textarea/examples/Slots.html](./p-textarea/examples/Slots.html) |
