...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-checkbox/examples/Default.html](./p-checkbox/examples/Default.html) |
| Form | The `p-checkbox` can be integrated into a form in two ways: **controlled** or **uncontrolled**, depending on your needs. | [./p-checkbox/examples/Form.html](./p-checkbox/examples/Form.html) |
| Indeterminate | Mask the visual appearance of a checkbox which has a state in-between checked and unchecked. | [./p-checkbox/examples/Indeterminate.html](./p-checkbox/examples/Indeterminate.html) |
| Slots | Use named slots when `label` or `message` need markup such as a link. | [./p-checkbox/examples/Slots.html](./p-checkbox/examples/Slots.html) |
| Custom wrapped label (🧪Experimental) | The `p-checkbox` component also supports a custom wrapped `label` by wrapping the component in a `label` tag. | [./p-checkbox/examples/WrappedLabel.html](./p-checkbox/examples/WrappedLabel.html) |
