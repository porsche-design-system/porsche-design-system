...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-wordmark/examples/Default.html](./p-wordmark/examples/Default.html) |
| Size | By default, the sizing is fluid, which can be changed to `inherit` a specified value. | [./p-wordmark/examples/Size.html](./p-wordmark/examples/Size.html) |
| Custom clickable/focusable area | Sometimes it may be useful to enlarge the clickable/focusable area of the `p-wordmark`. | [./p-wordmark/examples/CustomClickableArea.html](./p-wordmark/examples/CustomClickableArea.html) |
