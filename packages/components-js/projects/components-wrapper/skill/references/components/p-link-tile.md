...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-link-tile/examples/Default.html](./p-link-tile/examples/Default.html) |
| With video | With video | [./p-link-tile/examples/WithVideo.html](./p-link-tile/examples/WithVideo.html) |
| UI behaviour | The component is able to break out of its aspect ratio in case content overflows to be accessibility compliant (see first row in example). | [./p-link-tile/examples/UiBehaviour.html](./p-link-tile/examples/UiBehaviour.html) |
| Hyphens | It is possible to overwrite the hyphens style on the host element and use 'soft' hyphens. | [./p-link-tile/examples/Hyphens.html](./p-link-tile/examples/Hyphens.html) |
| Footer slot | You can also use a `footer` slot to display additional text below the description, providing more flexibility for custom content. | [./p-link-tile/examples/FooterSlot.html](./p-link-tile/examples/FooterSlot.html) |
