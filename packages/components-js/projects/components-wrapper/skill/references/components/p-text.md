...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-text/examples/Default.html](./p-text/examples/Default.html) |
| Static Size | There are predefined fluid text sizes for the text component which should cover most use cases. | [./p-text/examples/Size.html](./p-text/examples/Size.html) |
| Responsive Size | The `size` property accepts a breakpoint object to render different text sizes per viewport. | [./p-text/examples/SizeResponsive.html](./p-text/examples/SizeResponsive.html) |
| Semantics | To provide more contextual HTML semantics you can either pass them with the `tag` property or directly inside a slot. | [./p-text/examples/Semantics.html](./p-text/examples/Semantics.html) |
