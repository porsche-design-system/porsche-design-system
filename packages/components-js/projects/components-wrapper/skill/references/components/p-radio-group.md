...
- Don't use a radio Button for a large number of items (≥ 7), use the [Select](/components/select) or [Segmented Control](/components/segmented-control) component instead.
...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-radio-group/examples/Default.html](./p-radio-group/examples/Default.html) |
| Form | The `p-radio-group` can be integrated into a form in two ways: **controlled** or **uncontrolled**, depending on your needs. | [./p-radio-group/examples/Form.html](./p-radio-group/examples/Form.html) |
| Slots | Use named slots when `label` or `message` need markup such as a link. | [./p-radio-group/examples/Slots.html](./p-radio-group/examples/Slots.html) |
