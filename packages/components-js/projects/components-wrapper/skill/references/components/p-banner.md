...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-banner/examples/Default.html](./p-banner/examples/Default.html) |
| Customization | Rich content for `heading` and `description` can be provided via named slots. | [./p-banner/examples/Customization.html](./p-banner/examples/Customization.html) |
