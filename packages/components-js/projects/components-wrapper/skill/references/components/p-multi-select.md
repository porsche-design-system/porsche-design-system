...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-multi-select/examples/Default.html](./p-multi-select/examples/Default.html) |
| Form | The `p-multi-select` can be integrated into a form in two ways: **controlled** or **uncontrolled**, depending on your needs. | [./p-multi-select/examples/Form.html](./p-multi-select/examples/Form.html) |
| Slots | Use named slots when `label`, `description` or `message` need markup such as a link. | [./p-multi-select/examples/Slots.html](./p-multi-select/examples/Slots.html) |
| Set Value | The `p-multi-select` component behaves like regular form elements. | [./p-multi-select/examples/SetValue.html](./p-multi-select/examples/SetValue.html) |
| With optgroups | With optgroups | [./p-multi-select/examples/Optgroups.html](./p-multi-select/examples/Optgroups.html) |
| Custom asynchronous filtering | The `p-multi-select` component automatically filters options based on user input. | [./p-multi-select/examples/AsyncFilter.html](./p-multi-select/examples/AsyncFilter.html) |
| Custom option rendering | By default, `p-multi-select-option` only allows `#text` nodes. | [./p-multi-select/examples/SelectedSlot.html](./p-multi-select/examples/SelectedSlot.html) |
