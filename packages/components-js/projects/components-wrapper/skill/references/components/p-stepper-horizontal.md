...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-stepper-horizontal/examples/Default.html](./p-stepper-horizontal/examples/Default.html) |
| Framework Implementation | Below you can find an interactive example of an outlined registration process. | [./p-stepper-horizontal/examples/FrameworkImplementation.html](./p-stepper-horizontal/examples/FrameworkImplementation.html) |
