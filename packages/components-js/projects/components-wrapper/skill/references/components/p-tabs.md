...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-tabs/examples/Default.html](./p-tabs/examples/Default.html) |
| Gradient color | If the amount of tabs exceeds the viewport, the component renders arrow-buttons to help with horizontal scrolling. | [./p-tabs/examples/Gradient.html](./p-tabs/examples/Gradient.html) |
| Active Tab | You may need to change the initial active tab. | [./p-tabs/examples/ActiveTab.html](./p-tabs/examples/ActiveTab.html) |
| Labelling | Use the `aria` property to provide an accessible name and optional description for the tablist. | [./p-tabs/examples/Labelling.html](./p-tabs/examples/Labelling.html) |
