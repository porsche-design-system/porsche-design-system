...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-flyout/examples/Default.html](./p-flyout/examples/Default.html) |
| Sticky content with Custom CSS Property (Experimental) | In order to display some sticky element within the flyout content you can use the experimental `--p-flyout-sticky-top` CSS custom property to account for the height of the header. | [./p-flyout/examples/StickyTop.html](./p-flyout/examples/StickyTop.html) |
| Flyout Form | The following example demonstrates how a form can be used within a flyout component: | [./p-flyout/examples/Form.html](./p-flyout/examples/Form.html) |
| Custom Styling | The Flyout exposes read-only CSS Variables (prefixed with `--ref-`). | [./p-flyout/examples/CustomStyling.html](./p-flyout/examples/CustomStyling.html) |
