...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-display/examples/Default.html](./p-display/examples/Default.html) |
| Size | There are predefined fluid text sizes for the component which should cover most use cases. | [./p-display/examples/Size.html](./p-display/examples/Size.html) |
| Responsive | Responsive | [./p-display/examples/SizeResponsive.html](./p-display/examples/SizeResponsive.html) |
| Semantics | To provide more contextual HTML semantics you can either pass them with the `tag` property or directly inside a slot. | [./p-display/examples/Semantics.html](./p-display/examples/Semantics.html) |
| Color | Predefined theme-based colors are available, but `inherit` can also be used to define a custom color. | [./p-display/examples/Color.html](./p-display/examples/Color.html) |
