...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-modal/examples/Default.html](./p-modal/examples/Default.html) |
| Scrollable modal with sticky footer | If the modal's content does not fit within the available space, the content becomes scrollable and the footer area remains sticky. | [./p-modal/examples/Scrollable.html](./p-modal/examples/Scrollable.html) |
| Modal as alert dialog | The `p-modal` component can be used as an alert dialog. | [./p-modal/examples/AlertDialog.html](./p-modal/examples/AlertDialog.html) |
| Custom styling | The modal component has some values that can be overridden via CSS custom properties (aka CSS variables). | [./p-modal/examples/CustomStyling.html](./p-modal/examples/CustomStyling.html) |
