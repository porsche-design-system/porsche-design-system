...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-link/examples/Default.html](./p-link/examples/Default.html) |
| Framework routing (anchor nesting) | To support custom anchor tags (e.g. | [./p-link/examples/FrameworkRouting.html](./p-link/examples/FrameworkRouting.html) |
| Link with specific icon | If an icon needs to be implemented, just set another predefined icon. | [./p-link/examples/Icon.html](./p-link/examples/Icon.html) |
