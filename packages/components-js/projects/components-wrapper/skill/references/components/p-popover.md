...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-popover/examples/Default.html](./p-popover/examples/Default.html) |
| Slotted button | The `p-popover` component can also be used with a **slotted button** via the `button` slot, allowing you to provide a custom button element. | [./p-popover/examples/SlottedButton.html](./p-popover/examples/SlottedButton.html) |
