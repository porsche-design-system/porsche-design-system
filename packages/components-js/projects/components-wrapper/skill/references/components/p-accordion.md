...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-accordion/examples/Default.html](./p-accordion/examples/Default.html) |
| Sticky summary | The summary can be made sticky by adding the experimental property `sticky` to the `p-accordion` tag. | [./p-accordion/examples/StickySummary.html](./p-accordion/examples/StickySummary.html) |
| Interactive elements in summary | The summary section supports interactive elements via the `slot="summary-before"` and `slot="summary-after"` attributes. | [./p-accordion/examples/InteractiveElementsInSummary.html](./p-accordion/examples/InteractiveElementsInSummary.html) |
