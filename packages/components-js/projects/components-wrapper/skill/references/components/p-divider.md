...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-divider/examples/Default.html](./p-divider/examples/Default.html) |
| Vertical | **Hint:** The component has not an implicit vertical height unless we set a container which provides it or define the height on the component itself. | [./p-divider/examples/Vertical.html](./p-divider/examples/Vertical.html) |
| Responsive | You can change the divider's direction by using different major breakpoints `xs`, `s`, `m`, `l`, `xl`. | [./p-divider/examples/Responsive.html](./p-divider/examples/Responsive.html) |
