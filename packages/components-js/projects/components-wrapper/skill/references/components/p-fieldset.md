...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-fieldset/examples/Default.html](./p-fieldset/examples/Default.html) |
| Slotted label | Slotted label | [./p-fieldset/examples/SlottedLabel.html](./p-fieldset/examples/SlottedLabel.html) |
| Slotted message | Slotted message | [./p-fieldset/examples/SlottedMessage.html](./p-fieldset/examples/SlottedMessage.html) |
| Required | Setting `required="true"` on `p-fieldset` only renders the asterisk on the legend and sets `aria-required` on the underlying `<fieldset>` element. | [./p-fieldset/examples/Required.html](./p-fieldset/examples/Required.html) |
