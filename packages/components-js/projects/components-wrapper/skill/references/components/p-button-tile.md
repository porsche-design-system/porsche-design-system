...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-button-tile/examples/Default.html](./p-button-tile/examples/Default.html) |
| UI behaviour | The component is able to break out of its aspect ratio in case content overflows to be accessibility compliant (see first row in example). | [./p-button-tile/examples/UiBehaviour.html](./p-button-tile/examples/UiBehaviour.html) |
| Hyphens | It is possible to overwrite the hyphens style on the host element and use 'soft' hyphens. | [./p-button-tile/examples/Hyphens.html](./p-button-tile/examples/Hyphens.html) |
| Footer slot | You can also use a `footer` slot to display additional text below the description, providing more flexibility for custom content. | [./p-button-tile/examples/FooterSlot.html](./p-button-tile/examples/FooterSlot.html) |
