...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-input-url/examples/Default.html](./p-input-url/examples/Default.html) |
| Form | The `p-input-url` can be integrated into a form in two ways: **controlled** or **uncontrolled**, depending on your needs. | [./p-input-url/examples/Form.html](./p-input-url/examples/Form.html) |
| Slots | Use named slots when `label`, `description` or `message` need markup such as a link. | [./p-input-url/examples/Slots.html](./p-input-url/examples/Slots.html) |
