...
| Form | The `p-input-search` can be integrated into a form in two ways: **controlled** or **uncontrolled**, depending on your needs. | [./examples/Form.html](./examples/Form.html) |
...
| Used as a Combobox | You can pass an `aria` property to expose extra semantics on the **native input** (see [accessibility](/components/input-search/accessibility)). | [./examples/AriaCombobox.html](./examples/AriaCombobox.html) |
