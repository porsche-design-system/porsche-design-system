...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-heading/examples/Default.html](./p-heading/examples/Default.html) |
| Semantics | To provide more contextual HTML semantics you can either pass them with the `tag` property or directly inside a slot. | [./p-heading/examples/Semantics.html](./p-heading/examples/Semantics.html) |
| Color | Predefined theme-based colors are available, but `inherit` can also be used to define a custom color. | [./p-heading/examples/Color.html](./p-heading/examples/Color.html) |
