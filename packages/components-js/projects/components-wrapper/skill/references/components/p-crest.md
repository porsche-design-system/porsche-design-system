...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-crest/examples/Default.html](./p-crest/examples/Default.html) |
| Link | The Porsche Crest will be rendered as `<a>`-tag as soon as an `href` is provided. | [./p-crest/examples/Link.html](./p-crest/examples/Link.html) |
| Custom clickable/focusable area | Sometimes it may be useful to enlarge the clickable/focusable area of the Porsche Crest. | [./p-crest/examples/CustomClickableArea.html](./p-crest/examples/CustomClickableArea.html) |
