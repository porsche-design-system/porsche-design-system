...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-input-week/examples/Default.html](./p-input-week/examples/Default.html) |
| Form | The `p-input-week` can be integrated into a form in two ways: **controlled** or **uncontrolled**, depending on your needs. | [./p-input-week/examples/Form.html](./p-input-week/examples/Form.html) |
| Slots | Use named slots when `label`, `description` or `message` need markup such as a link. | [./p-input-week/examples/Slots.html](./p-input-week/examples/Slots.html) |
