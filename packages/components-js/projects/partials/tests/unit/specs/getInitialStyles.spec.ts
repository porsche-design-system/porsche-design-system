...
const normalizeCss = `*{font-family:'Porsche Next','Arial Narrow',Arial,'Heiti SC',SimHei,sans-serif;line-height:calc(6px + 2.125ex);text-size-adjust:none;-webkit-text-size-adjust:none}p{hyphens:auto;font-weight:400;overflow-wrap:break-word}h1,h2,h3,h4,h5,h6{font-weight:400}a{color:inherit;text-decoration:underline}b,strong{font-weight:700}em,i{font-style:normal}a,button,input,select,textarea{outline:1px solid transparent;outline-offset:1px}a:focus,button:focus,input:focus,select:focus,textarea:focus{outline-color:currentColor}a:focus:not(:focus-visible),button:focus:not(:focus-visible),input:focus:not(:focus-visible),select:focus:not(:focus-visible),textarea:focus:not(:focus-visible){outline-color:transparent}input::-webkit-outer-spin-button,input::-webkit-inner-spin-button,input[type=\"search\"]::-webkit-search-decoration{appearance:none;-webkit-appearance:none}input[type=\"search\"]::-webkit-search-cancel-button{display:none}input[type=\"text\"]::-webkit-contacts-auto-fill-button,input[type=\"text\"]::-webkit-credentials-auto-fill-button{margin-right:2.4375rem}input::-webkit-calendar-picker-indicator{filter:filter:invert(2%) sepia(15%) saturate(2672%) hue-rotate(193deg) brightness(92%) contrast(101%)}[theme=\"dark\"] input::-webkit-calendar-picker-indicator{filter:invert(82%) sepia(10%) saturate(66%) hue-rotate(215deg) brightness(106%) contrast(108%)}input::-webkit-calendar-picker-indicator:hover,input::-webkit-calendar-picker-indicator:hover{cursor:pointer}@media(hover:hover){a{transition:color var(--p-transition-duration,.24s) ease}a:hover{color:rgba(148,149,152,0.20)}[data-theme=\"dark\"] a:hover{color:rgba(126,127,130,0.20)}}`;
