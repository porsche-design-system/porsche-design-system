...
describe('format: sha256', () => {
  it('should return hash for core styles', async () => {
    ...
    expect(result).toMatchInlineSnapshot(`"'sha256-B54E2Ir4xxgH/Z0vhVtcu7y+/tqjQ0We4E7JJe0F4AU='"`);
  });
  ...
  it('should return hash for core styles with custom prefix', async () => {
    ...
    expect(result).toMatchInlineSnapshot(`"'sha256-quSfUSZ9HZ3ntlcqqO1PCgXrkR7kgMx4lLtAdv0Ju04='"`);
  });
  ...
  it('should return hash for core styles with multiple custom prefixes', async () => {
    ...
    expect(result).toMatchInlineSnapshot(`"'sha256-+qHLAhDxKujtNS7ZGfUqkrS131Db46R8jhIdSmqtA7g='"`);
  });
});
