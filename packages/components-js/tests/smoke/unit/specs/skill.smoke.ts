...
const distDir = path.resolve(__dirname, '../../../../dist/components-wrapper');
const canonicalBinPath = path.resolve(distDir, '../../../storefront/projects/skills/bin/pds-skill.js');

describe('components-wrapper skill distribution', () => {
  test.each(['skills/pds-knowledge-js/SKILL.md', 'bin/pds-skill.js'])('should contain %s', (file) => {
