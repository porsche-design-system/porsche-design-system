...
describe('webmanifest', () => {
  ...
  it('should have webmanifest contents', () => {
    const expectedResult =
      '{"icons":[{"src":"https://cdn.ui.porsche.com/porsche-design-system/meta-icons/android-chrome-192x192.8f29b66.png","sizes":"192x192","type":"image/png"},{"src":"https://cdn.ui.porsche.com/porsche-design-system/meta-icons/android-chrome-512x512.0e1a31f.png","sizes":"512x512","type":"image/png"}]}';
    expect(getManifestContent(manifestPath)).toBe(expectedResult);
  });

  it('should have webmanifestCN contents', () => {
    const expectedResult =
      '{"icons":[{"src":"https://cdn.ui.porsche.cn/porsche-design-system/meta-icons/android-chrome-192x192.8f29b66.png","sizes":"192x192","type":"image/png"},{"src":"https://cdn.ui.porsche.cn/porsche-design-system/meta-icons/android-chrome-512x512.0e1a31f.png","sizes":"512x512","type":"image/png"}]}';
