...
const scenario = async (page: Page, theme: Theme, scheme?: PrefersColorScheme): Promise<void> => {
  ...
  // Focus states
  await forceFocusVisibleState(page, '.focus p-input-password:not(.force-label) input');
  await forceFocusVisibleState(page, '.focus p-input-password.force-label >>> label');
