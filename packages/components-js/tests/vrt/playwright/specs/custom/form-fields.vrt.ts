...
<div>
  ...
  await forceFocusVisibleState(page, '.focus input');
  await forceFocusVisibleState(page, '.focus select');
  await forceFocusVisibleState(page, '.focus textarea');
  await forceFocusVisibleState(page, '.focus p-select >>> button');
  await forceFocusVisibleState(page, '.focus p-multi-select >>> input');
  await forceFocusVisibleState(page, `.focus p-pin-code >>> #${valueOfForAttribute}`);
