...
| `hideLabel`   | `hide-label`  | Show or hide label and description text. For better accessibility it is recommended to show the label. | `BreakpointValues<boolean> \| boolean \| string` | `false`  |
