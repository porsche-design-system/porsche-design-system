...
#### Added
- Icons (active-cabin-ventilation, battery-full, bell, bookmark, car-battery, charging-active, charging-state, climate, climate-control, garage, horn, key, map, parking-brake, parking-light, preheating, send, shopping-bag, sidelights, user-manual, vehicle, wrenches)

#### Changed
- Icons (arrow-first, arrow-last, battery-empty, card, charging-station, question)
