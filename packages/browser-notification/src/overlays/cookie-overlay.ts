...
((): void => {
  ...
  const locales: Locales = {
    ...
    ru: {
      ...
      content: "Файлы cookie отключены в вашем браузере. Для доступа к этому сайту необходимо активировать файлы cookie в настройках браузера, закрыть окно и снова открыть этот сайт.",
    },
    fr: {
    ...
    it: {
      ...
      content: "I cookie sono disabilitati nel tuo browser. Per accedere a questo sito è necessario attivare i cookie nelle impostazioni del browser, chiudere la finestra e riaprire questo sito.",
    },
    pt: {
      title: "Ative os cookies para usar este site",
      content: "Os cookies estão desativados no seu navegador. Para acessar este site é necessário ativar os cookies nas configurações do navegador, fechar a janela e abrir este site novamente.",
    },
    es: {
      title: "Activar cookies para usar este sitio",
      content: "Las cookies están deshabilitadas en su navegador. Para acceder a este sitio es necesario activar las cookies en la configuración de los navegadores, cerrar la ventana y volver a abrir este sitio.",
    },
    ja: {
      title: "このサイトを使用するにはCookieをアクティブ化してください",
      content: "ブラウザでCookieが無効になっています。このサイトにアクセスするには、ブラウザの設定でCookieを有効にし、ウィンドウを閉じてこのサイトを再度開く必要があります。",
    },
    ko: {
      title: "이 사이트를 사용하려면 쿠키를 활성화하십시오",
      content: "귀하의 브라우저에서 쿠키가 비활성화되어 있습니다. 이 사이트에 액세스하려면 브라우저 설정에서 쿠키를 활성화하고 창을 닫고 이 사이트를 다시 열어야 합니다.",
    },
    zh: {
      title: "请启用浏览器cookies",
    ...
    nl: {
      ...
      content: "Cookies zijn uitgeschakeld in uw browser. Om toegang te krijgen tot deze site is het noodzakelijk om cookies te activeren in de browserinstellingen, het venster te sluiten en deze site opnieuw te openen.",
    },
    pl: {
      title: "Aktywuj pliki cookie, aby korzystać z tej witryny",
      content: "Pliki cookie są wyłączone w Twojej przeglądarce. Aby uzyskać dostęp do tej witryny, należy aktywować pliki cookie w ustawieniach przeglądarki, zamknąć okno i ponownie otworzyć tę witrynę.",
    },
    cs: {
      title: "Chcete-li používat tento web, aktivujte soubory cookie",
      content: "Soubory cookie jsou ve vašem prohlížeči zakázány. Pro přístup na tyto stránky je nutné aktivovat cookies v nastavení prohlížeče, zavřít okno a znovu otevřít tyto stránky.",
    },
    da: {
      title: "Aktiver cookies for at bruge dette websted",
      content: "Cookies er deaktiveret i din browser. For at få adgang til denne side er det nødvendigt at aktivere cookies i browserens indstillinger, lukke vinduet og åbne denne side igen.",
    },
    et: {
      title: "Selle saidi kasutamiseks aktiveerige küpsised",
      content: "Küpsised on teie brauseris keelatud. Sellele saidile pääsemiseks tuleb brauseri seadetes aktiveerida küpsised, sulgeda aken ja avada see sait uuesti.",
    },
    fi: {
      title: "Aktivoi evästeet käyttääksesi tätä sivustoa",
      content:"Evästeet ovat poissa käytöstä selaimessasi. Tälle sivustolle pääsy edellyttää evästeiden aktivointia selaimen asetuksista, sulkea ikkuna ja avaa tämä sivusto uudelleen.",
    },
    lt: {
      title: "Norėdami naudotis šia svetaine, suaktyvinkite slapukus",
      content: "Jūsų naršyklėje slapukai išjungti. Norint pasiekti šią svetainę, būtina naršyklės nustatymuose suaktyvinti slapukus, uždaryti langą ir vėl atidaryti šią svetainę.",
    },
    lv: {
      title: "Lai izmantotu šo vietni, aktivizējiet sīkfailus",
      content: "Jūsu pārlūkprogrammā sīkfaili ir atspējoti. Lai piekļūtu šai vietnei, pārlūkprogrammas iestatījumos ir jāaktivizē sīkfaili, aizveriet logu un vēlreiz atveriet šo vietni.",
    },
    no: {
      title: "Aktiver informasjonskapsler for å bruke denne siden",
      content: "Informasjonskapsler er deaktivert i nettleseren din. For å få tilgang til denne siden er det nødvendig å aktivere informasjonskapsler i nettleserens innstillinger, lukke vinduet og åpne denne siden igjen.",
    },
    sl: {
      title: "Aktivirajte piškotke za uporabo te strani",
      content: "Piškotki so v vašem brskalniku onemogočeni. Za dostop do te strani morate v nastavitvah brskalnika aktivirati piškotke, zapreti okno in ponovno odpreti to spletno mesto.",
    },
    sv: {
      title: "Aktivera cookies för att använda denna webbplats",
      content: "Cookies är inaktiverade i din webbläsare. För att komma åt denna sida är det nödvändigt att aktivera cookies i webbläsarens inställningar, stäng fönstret och öppna denna sida igen.",
    },
    tr: {
      title: "Bu siteyi kullanmak için çerezleri etkinleştirin",
      content: "Tarayıcınızda çerezler devre dışı. Bu siteye erişmek için tarayıcı ayarlarında çerezleri etkinleştirmek, pencereyi kapatmak ve bu siteyi tekrar açmak gerekir.",
    },
    uk: {
