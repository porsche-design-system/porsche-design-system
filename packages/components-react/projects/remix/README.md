...
- [Fly app deployment](https://fly.io) with [Docker](https://docker.com/)
...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create remix-c924
  fly apps create remix-c924-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app remix-c924
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app remix-c924-staging
  ```
...
- Create a persistent volume for the sqlite database for both your staging and production environments. Run the
  ...
  ```sh
  fly volumes create data --size 1 --app remix-c924
  fly volumes create data --size 1 --app remix-c924-staging
  ```
