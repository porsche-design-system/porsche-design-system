/* Auto Generated File */
import { PButtonTile, PLinkTile, PorscheDesignSystemProvider, PStepperHorizontal, PStepperHorizontalItem } from '@porsche-design-system/components-react/ssr';

const OverviewFlakyPage = (): JSX.Element => {
  const style = `
    p-link-tile,
    p-button-tile,
