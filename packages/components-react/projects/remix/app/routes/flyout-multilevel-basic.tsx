/* Auto Generated File */
import { PFlyoutMultilevel, PFlyoutMultilevelItem } from '@porsche-design-system/components-react/ssr';

const FlyoutMultilevelBasicPage = (): JSX.Element => {
  return (
    <>
...
export default FlyoutMultilevelBasicPage;
