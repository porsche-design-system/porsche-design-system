...
const TypographyFallbackStrategyPage: NextPage = (): JSX.Element => {
  return (
    <>
      ...
      <div className="playground" title="should show typography in supported font-weights for greek and coptic charset">
        ...
        <PText weight="semi-bold">Ταχίστη αλώπηξ βαφής ψημένη γη, δρασκελίζει υπέρ νωθρού κυνός</PText>
        <PText weight="bold">Ταχίστη αλώπηξ βαφής ψημένη γη, δρασκελίζει υπέρ νωθρού κυνός</PText>
      </div>

      <div className="playground" title="should show typography in supported font-weights for vietnamese charset">
        <PText weight="regular"
          >Trăm năm trong cõi người ta, chữ tài chữ phận khéo là ghét nhau. Trải qua một cuộc bể dâu, những điều trông thấy mà
          đau đớn lòng. Lạ gì bỉ sắc tư phong, trời xanh quen với má hồng đánh ghen.</PText
        >
      ...
      <div className="playground" title="should show typography in supported font-weights for cyril charset">
        ...
        <PText weight="semi-bold">Эх, чужак, общий съём цен шляп (юфть) – вдрызг!</PText>
      ...
      <div className="playground" title="should show typography in supported font-weights for chinese charset">
        ...
        <PText weight="semi-bold">保时捷驾驶体验活动在线销售通用条款与条件</PText>
        <PText weight="bold">保时捷驾驶体验活动在线销售通用条款与条件</PText>
      </div>

      <div className="playground" title="should show typography in supported font-weights for japanese charset">
        <PText weight="regular">
      ...
      <div className="playground" title="should show typography in supported font-weights for korean charset">
        <PText weight="regular">키스의 고유조건은 입술끼리 만나야 하고 특별한 기술은 필요치 않다</PText>
        <PText weight="semi-bold">키스의 고유조건은 입술끼리 만나야 하고 특별한 기술은 필요치 않다</PText>
...
export default TypographyFallbackStrategyPage;
