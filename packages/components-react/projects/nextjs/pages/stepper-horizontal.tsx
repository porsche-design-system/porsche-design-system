...
const StepperHorizontalPage: NextPage = (): JSX.Element => {
  return (
    <>
      <div className="playground light" title="should render stepper horizontal with all numbers from 1 to 9 on light background">
        <PStepperHorizontal>
      ...
      <div className="playground dark" title="should render stepper horizontal with all numbers from 1 to 9 on dark background">
      ...
      >
        <PStepperHorizontal theme="dark" size="medium">
          <PStepperHorizontalItem>Medium 1</PStepperHorizontalItem>
          <PStepperHorizontalItem>Medium 2</PStepperHorizontalItem>
          <PStepperHorizontalItem>Medium 3</PStepperHorizontalItem>
          <PStepperHorizontalItem>Medium 4</PStepperHorizontalItem>
      ...
      <div className="playground light" title="should render stepper horizontal with all states on light background">
        <PStepperHorizontal>
      ...
      <div className="playground dark" title="should render stepper horizontal with all states on dark background">
        <PStepperHorizontal theme="dark">
          <PStepperHorizontalItem state="current">Current small</PStepperHorizontalItem>
          <PStepperHorizontalItem state="warning">Warning small</PStepperHorizontalItem>
          <PStepperHorizontalItem state="complete">Complete small</PStepperHorizontalItem>
      ...
      <div className="playground light" title="should render stepper horizontal size medium with all states on light background">
        <PStepperHorizontal size="medium">
      ...
      <div className="playground dark" title="should render stepper horizontal size medium with all states on dark background">
        <PStepperHorizontal theme="dark" size="medium">
          <PStepperHorizontalItem state="current">Current medium</PStepperHorizontalItem>
          <PStepperHorizontalItem state="warning">Warning medium</PStepperHorizontalItem>
          <PStepperHorizontalItem state="complete">Complete medium</PStepperHorizontalItem>
      ...
      <div className="playground light" title="should render stepper horizontal with arrow left on light background">
      ...
      <div className="playground dark" title="should render stepper horizontal with arrow left on dark background">
      ...
      <div className="playground light" title="should render stepper horizontal size medium with arrow left on light background">
      ...
      <div className="playground dark" title="should render stepper horizontal size medium with arrow left on dark background">
        <PStepperHorizontal theme="dark" size="medium" style={{ maxWidth: '600px' }}>
          <PStepperHorizontalItem state="complete">Scrollable 1</PStepperHorizontalItem>
          <PStepperHorizontalItem state="complete">Scrollable 2</PStepperHorizontalItem>
          <PStepperHorizontalItem state="complete">Scrollable 3</PStepperHorizontalItem>
          <PStepperHorizontalItem state="complete">Scrollable 4</PStepperHorizontalItem>
      ...
      <div className="playground light" title="should render stepper horizontal with arrow left and right on light background">
        <PStepperHorizontal style={{ maxWidth: '600px' }}>
          <PStepperHorizontalItem state="complete">Scrollable 1</PStepperHorizontalItem>
          <PStepperHorizontalItem state="complete">Scrollable 2</PStepperHorizontalItem>
          <PStepperHorizontalItem state="complete">Scrollable 3</PStepperHorizontalItem>
      ...
      <div className="playground light" title="should render stepper horizontal size BreakpointCustomizable on light background">
      ...
      <div className="playground dark" title="should render stepper horizontal size BreakpointCustomizable on dark background">
        <PStepperHorizontal
          theme="dark"
