      ...
      generatePackageJson({
        ...
        baseContents: (pkg) => ({
          ...
          exports: {
            ...
            './tailwindcss/cn': './tailwindcss/cn/index.css',
            './tailwindcss/cn/index.css': './tailwindcss/cn/index.css',
            './tailwindcss/cn/index': './tailwindcss/cn/index.css',
            ...
            './fouc.css': './global-styles/fouc.css',
            './fouc': './global-styles/fouc.css',
