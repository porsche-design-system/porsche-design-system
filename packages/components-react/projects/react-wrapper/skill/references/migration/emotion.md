...
Include the global styles once in your `main.tsx` to initialize the color-scheme utilities.
...
```diff
- import { … } from '@porsche-design-system/components-react/styles';
+ import { … } from '@porsche-design-system/components-react/emotion';
```
