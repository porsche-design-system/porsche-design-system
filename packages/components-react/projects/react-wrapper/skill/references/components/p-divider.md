...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-divider/examples/Default.tsx](./p-divider/examples/Default.tsx) |
| Vertical | **Hint:** The component has not an implicit vertical height unless we set a container which provides it or define the height on the component itself. | [./p-divider/examples/Vertical.tsx](./p-divider/examples/Vertical.tsx) |
| Responsive | You can change the divider's direction by using different major breakpoints `xs`, `s`, `m`, `l`, `xl`. | [./p-divider/examples/Responsive.tsx](./p-divider/examples/Responsive.tsx) |
