...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-input-url/examples/Default.tsx](./p-input-url/examples/Default.tsx) |
| Form | The `p-input-url` can be integrated into a form in two ways: **controlled** or **uncontrolled**, depending on your needs. | [./p-input-url/examples/Form.tsx](./p-input-url/examples/Form.tsx) |
| Slots | Use named slots when `label`, `description` or `message` need markup such as a link. | [./p-input-url/examples/Slots.tsx](./p-input-url/examples/Slots.tsx) |
