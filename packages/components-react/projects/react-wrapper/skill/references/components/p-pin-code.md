...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-pin-code/examples/Default.tsx](./p-pin-code/examples/Default.tsx) |
| Form | The `p-pin-code` can be integrated into a form in two ways: **controlled** or **uncontrolled**, depending on your needs. | [./p-pin-code/examples/Form.tsx](./p-pin-code/examples/Form.tsx) |
| Copy+Paste and autocomplete | By default, only one input can be changed at a time. | [./p-pin-code/examples/CopyPaste.tsx](./p-pin-code/examples/CopyPaste.tsx) |
| Slots | Use named slots when `label`, `description` or `message` need markup such as a link. | [./p-pin-code/examples/Slots.tsx](./p-pin-code/examples/Slots.tsx) |
