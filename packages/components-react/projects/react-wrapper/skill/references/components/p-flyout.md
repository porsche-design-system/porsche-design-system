...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-flyout/examples/Default.tsx](./p-flyout/examples/Default.tsx) |
| Sticky content with Custom CSS Property (Experimental) | In order to display some sticky element within the flyout content you can use the experimental `--p-flyout-sticky-top` CSS custom property to account for the height of the header. | [./p-flyout/examples/StickyTop.tsx](./p-flyout/examples/StickyTop.tsx) |
| Flyout Form | The following example demonstrates how a form can be used within a flyout component: | [./p-flyout/examples/Form.tsx](./p-flyout/examples/Form.tsx) |
| Custom Styling | The Flyout exposes read-only CSS Variables (prefixed with `--ref-`). | [./p-flyout/examples/CustomStyling.tsx](./p-flyout/examples/CustomStyling.tsx) |
