...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-input-week/examples/Default.tsx](./p-input-week/examples/Default.tsx) |
| Form | The `p-input-week` can be integrated into a form in two ways: **controlled** or **uncontrolled**, depending on your needs. | [./p-input-week/examples/Form.tsx](./p-input-week/examples/Form.tsx) |
| Slots | Use named slots when `label`, `description` or `message` need markup such as a link. | [./p-input-week/examples/Slots.tsx](./p-input-week/examples/Slots.tsx) |
