...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-multi-select/examples/Default.tsx](./p-multi-select/examples/Default.tsx) |
| Form | The `p-multi-select` can be integrated into a form in two ways: **controlled** or **uncontrolled**, depending on your needs. | [./p-multi-select/examples/Form.tsx](./p-multi-select/examples/Form.tsx) |
| Slots | Use named slots when `label`, `description` or `message` need markup such as a link. | [./p-multi-select/examples/Slots.tsx](./p-multi-select/examples/Slots.tsx) |
| Set Value | The `p-multi-select` component behaves like regular form elements. | [./p-multi-select/examples/SetValue.tsx](./p-multi-select/examples/SetValue.tsx) |
| With optgroups | With optgroups | [./p-multi-select/examples/Optgroups.tsx](./p-multi-select/examples/Optgroups.tsx) |
| Custom asynchronous filtering | The `p-multi-select` component automatically filters options based on user input. | [./p-multi-select/examples/AsyncFilter.tsx](./p-multi-select/examples/AsyncFilter.tsx) |
| Custom option rendering | By default, `p-multi-select-option` only allows `#text` nodes. | [./p-multi-select/examples/SelectedSlot.tsx](./p-multi-select/examples/SelectedSlot.tsx) |
