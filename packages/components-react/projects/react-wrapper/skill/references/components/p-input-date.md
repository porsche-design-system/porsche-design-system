...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-input-date/examples/Default.tsx](./p-input-date/examples/Default.tsx) |
| Form | The `p-input-date` can be integrated into a form in two ways: **controlled** or **uncontrolled**, depending on your needs. | [./p-input-date/examples/Form.tsx](./p-input-date/examples/Form.tsx) |
| Slots | Use named slots when `label`, `description` or `message` need markup such as a link. | [./p-input-date/examples/Slots.tsx](./p-input-date/examples/Slots.tsx) |
