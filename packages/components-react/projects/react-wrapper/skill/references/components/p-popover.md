...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-popover/examples/Default.tsx](./p-popover/examples/Default.tsx) |
| Slotted button | The `p-popover` component can also be used with a **slotted button** via the `button` slot, allowing you to provide a custom button element. | [./p-popover/examples/SlottedButton.tsx](./p-popover/examples/SlottedButton.tsx) |
