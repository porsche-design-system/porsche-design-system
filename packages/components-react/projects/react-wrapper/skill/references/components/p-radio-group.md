...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-radio-group/examples/Default.tsx](./p-radio-group/examples/Default.tsx) |
| Form | The `p-radio-group` can be integrated into a form in two ways: **controlled** or **uncontrolled**, depending on your needs. | [./p-radio-group/examples/Form.tsx](./p-radio-group/examples/Form.tsx) |
| Slots | Use named slots when `label` or `message` need markup such as a link. | [./p-radio-group/examples/Slots.tsx](./p-radio-group/examples/Slots.tsx) |
