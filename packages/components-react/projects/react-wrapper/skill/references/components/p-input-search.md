...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-input-search/examples/Default.tsx](./p-input-search/examples/Default.tsx) |
| Form | The `p-input-search` can be integrated into a form in two ways: **controlled** or **uncontrolled**, depending on your needs. | [./p-input-search/examples/Form.tsx](./p-input-search/examples/Form.tsx) |
| Slots | Use named slots when `label`, `description` or `message` need markup such as a link. | [./p-input-search/examples/Slots.tsx](./p-input-search/examples/Slots.tsx) |
| Used as a Combobox | You can pass an `aria` property to expose extra semantics on the **native input** (see [accessibility](/components/input-search/accessibility)). | [./p-input-search/examples/AriaCombobox.tsx](./p-input-search/examples/AriaCombobox.tsx) |
