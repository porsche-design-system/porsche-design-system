...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-tag/examples/Default.tsx](./p-tag/examples/Default.tsx) |
| With slotted button | It is possible to add a `<button>` tag into the `p-tag` component. | [./p-tag/examples/SlottedButton.tsx](./p-tag/examples/SlottedButton.tsx) |
| With slotted link | It is possible to add an `<a>` tag to the `p-tag` component. | [./p-tag/examples/SlottedLink.tsx](./p-tag/examples/SlottedLink.tsx) |
| Multiline | The contents of the `p-tag` component are rendered with `white-space: nowrap` by default. | [./p-tag/examples/Multiline.tsx](./p-tag/examples/Multiline.tsx) |
