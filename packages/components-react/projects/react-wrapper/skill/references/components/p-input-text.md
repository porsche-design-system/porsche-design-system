...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-input-text/examples/Default.tsx](./p-input-text/examples/Default.tsx) |
| Form | The `p-input-text` can be integrated into a form in two ways: **controlled** or **uncontrolled**, depending on your needs. | [./p-input-text/examples/Form.tsx](./p-input-text/examples/Form.tsx) |
| Controlled Input (Preventing User Input) | In some cases you may want to fully control the input value (for example to limit or validate user input). | [./p-input-text/examples/Controlled.tsx](./p-input-text/examples/Controlled.tsx) |
| Slots | Use named slots when `label`, `description` or `message` need markup such as a link. | [./p-input-text/examples/Slots.tsx](./p-input-text/examples/Slots.tsx) |
