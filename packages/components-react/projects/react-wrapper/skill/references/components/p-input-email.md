...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-input-email/examples/Default.tsx](./p-input-email/examples/Default.tsx) |
| Form | The `p-input-email` can be integrated into a form in two ways: **controlled** or **uncontrolled**, depending on your needs. | [./p-input-email/examples/Form.tsx](./p-input-email/examples/Form.tsx) |
| Slots | Use named slots when `label`, `description` or `message` need markup such as a link. | [./p-input-email/examples/Slots.tsx](./p-input-email/examples/Slots.tsx) |
