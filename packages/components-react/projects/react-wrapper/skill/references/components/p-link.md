...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-link/examples/Default.tsx](./p-link/examples/Default.tsx) |
| Framework routing (anchor nesting) | To support custom anchor tags (e.g. | [./p-link/examples/FrameworkRouting.tsx](./p-link/examples/FrameworkRouting.tsx) |
| Link with specific icon | If an icon needs to be implemented, just set another predefined icon. | [./p-link/examples/Icon.tsx](./p-link/examples/Icon.tsx) |
