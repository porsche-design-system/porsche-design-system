...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-flag/examples/Default.tsx](./p-flag/examples/Default.tsx) |
| Size via Prop | The `size` property offers a set of predefined sizes that cover most use cases. | [./p-flag/examples/Size.tsx](./p-flag/examples/Size.tsx) |
| Size via CSS Variable | For full control over the flag's dimensions, use the custom CSS variable `--p-flag-size`, which accepts any valid CSS length value. | [./p-flag/examples/SizeCssVar.tsx](./p-flag/examples/SizeCssVar.tsx) |
| Responsive Size | The `size` property supports `BreakpointCustomizable` values, allowing you to define different sizes for each major breakpoint (`xs`, `s`, `m`, `l`, `xl`). | [./p-flag/examples/ResponsiveSize.tsx](./p-flag/examples/ResponsiveSize.tsx) |
