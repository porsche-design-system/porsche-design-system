...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-wordmark/examples/Default.tsx](./p-wordmark/examples/Default.tsx) |
| Size | By default, the sizing is fluid, which can be changed to `inherit` a specified value. | [./p-wordmark/examples/Size.tsx](./p-wordmark/examples/Size.tsx) |
| Custom clickable/focusable area | Sometimes it may be useful to enlarge the clickable/focusable area of the `p-wordmark`. | [./p-wordmark/examples/CustomClickableArea.tsx](./p-wordmark/examples/CustomClickableArea.tsx) |
