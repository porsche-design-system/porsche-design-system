...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-stepper-horizontal/examples/Default.tsx](./p-stepper-horizontal/examples/Default.tsx) |
| Framework Implementation | Below you can find an interactive example of an outlined registration process. | [./p-stepper-horizontal/examples/FrameworkImplementation.tsx](./p-stepper-horizontal/examples/FrameworkImplementation.tsx) |
