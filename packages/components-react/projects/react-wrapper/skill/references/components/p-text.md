...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-text/examples/Default.tsx](./p-text/examples/Default.tsx) |
| Static Size | There are predefined fluid text sizes for the text component which should cover most use cases. | [./p-text/examples/Size.tsx](./p-text/examples/Size.tsx) |
| Responsive Size | The `size` property accepts a breakpoint object to render different text sizes per viewport. | [./p-text/examples/SizeResponsive.tsx](./p-text/examples/SizeResponsive.tsx) |
| Semantics | To provide more contextual HTML semantics you can either pass them with the `tag` property or directly inside a slot. | [./p-text/examples/Semantics.tsx](./p-text/examples/Semantics.tsx) |
