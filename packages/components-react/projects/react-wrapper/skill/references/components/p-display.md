...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-display/examples/Default.tsx](./p-display/examples/Default.tsx) |
| Size | There are predefined fluid text sizes for the component which should cover most use cases. | [./p-display/examples/Size.tsx](./p-display/examples/Size.tsx) |
| Responsive | Responsive | [./p-display/examples/SizeResponsive.tsx](./p-display/examples/SizeResponsive.tsx) |
| Semantics | To provide more contextual HTML semantics you can either pass them with the `tag` property or directly inside a slot. | [./p-display/examples/Semantics.tsx](./p-display/examples/Semantics.tsx) |
| Color | Predefined theme-based colors are available, but `inherit` can also be used to define a custom color. | [./p-display/examples/Color.tsx](./p-display/examples/Color.tsx) |
