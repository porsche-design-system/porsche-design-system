...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-model-signature/examples/Default.tsx](./p-model-signature/examples/Default.tsx) |
| Safe Zone | The `safe-zone` prop's default is `true`, which ensures a visual balance across all model signatures. | [./p-model-signature/examples/SafeZone.tsx](./p-model-signature/examples/SafeZone.tsx) |
| Mask: Blend Mode | If `p-model-signature` should be blended with its background, the CSS property [mix-blend-mode](https://developer.mozilla.org/en-US/docs/Web/CSS/mix-blend-mode) can be used (`{{ blendMode }}` will produce the best results). | [./p-model-signature/examples/MaskBlendMode.tsx](./p-model-signature/examples/MaskBlendMode.tsx) |
| Mask: Image | Mask: Image | [./p-model-signature/examples/MaskImage.tsx](./p-model-signature/examples/MaskImage.tsx) |
| Mask: Video | Mask: Video | [./p-model-signature/examples/MaskVideo.tsx](./p-model-signature/examples/MaskVideo.tsx) |
| Custom styling | The `p-model-signature` color can be changed by setting the `color` prop to `inherit` and applying some CSS `color`. | [./p-model-signature/examples/CustomStyling.tsx](./p-model-signature/examples/CustomStyling.tsx) |
