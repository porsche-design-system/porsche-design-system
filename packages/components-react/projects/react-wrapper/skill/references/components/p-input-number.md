...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-input-number/examples/Default.tsx](./p-input-number/examples/Default.tsx) |
| Form | The `p-input-number` can be integrated into a form in two ways: **controlled** or **uncontrolled**, depending on your needs. | [./p-input-number/examples/Form.tsx](./p-input-number/examples/Form.tsx) |
| Slots | Use named slots when `label`, `description` or `message` need markup such as a link. | [./p-input-number/examples/Slots.tsx](./p-input-number/examples/Slots.tsx) |
