...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-fieldset/examples/Default.tsx](./p-fieldset/examples/Default.tsx) |
| Slotted label | Slotted label | [./p-fieldset/examples/SlottedLabel.tsx](./p-fieldset/examples/SlottedLabel.tsx) |
| Slotted message | Slotted message | [./p-fieldset/examples/SlottedMessage.tsx](./p-fieldset/examples/SlottedMessage.tsx) |
| Required | Setting `required="true"` on `p-fieldset` only renders the asterisk on the legend and sets `aria-required` on the underlying `<fieldset>` element. | [./p-fieldset/examples/Required.tsx](./p-fieldset/examples/Required.tsx) |
