...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-accordion/examples/Default.tsx](./p-accordion/examples/Default.tsx) |
| Sticky summary | The summary can be made sticky by adding the experimental property `sticky` to the `p-accordion` tag. | [./p-accordion/examples/StickySummary.tsx](./p-accordion/examples/StickySummary.tsx) |
| Interactive elements in summary | The summary section supports interactive elements via the `slot="summary-before"` and `slot="summary-after"` attributes. | [./p-accordion/examples/InteractiveElementsInSummary.tsx](./p-accordion/examples/InteractiveElementsInSummary.tsx) |
