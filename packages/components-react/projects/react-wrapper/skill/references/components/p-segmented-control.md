...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-segmented-control/examples/Default.tsx](./p-segmented-control/examples/Default.tsx) |
| Form | The `p-segmented-control` can be integrated into a form in two ways: **controlled** or **uncontrolled**, depending on your needs. | [./p-segmented-control/examples/Form.tsx](./p-segmented-control/examples/Form.tsx) |
| With Labels | Additional meta information can be displayed by setting a `label` on each child. | [./p-segmented-control/examples/WithLabels.tsx](./p-segmented-control/examples/WithLabels.tsx) |
| Slots | Use named slots when `label`, `description` or `message` need markup such as a link. | [./p-segmented-control/examples/Slots.tsx](./p-segmented-control/examples/Slots.tsx) |
