...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-link-tile-product/examples/Default.tsx](./p-link-tile-product/examples/Default.tsx) |
| Framework routing (anchor nesting) | To support framework routing you can provide the link as a slotted element by using the `anchor` slot instead of using the `href` property. | [./p-link-tile-product/examples/FrameworkRouting.tsx](./p-link-tile-product/examples/FrameworkRouting.tsx) |
