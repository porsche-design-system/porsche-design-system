...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-textarea/examples/Default.tsx](./p-textarea/examples/Default.tsx) |
| Form | The `p-textarea` can be integrated into a form in two ways: **controlled** or **uncontrolled**, depending on your needs. | [./p-textarea/examples/Form.tsx](./p-textarea/examples/Form.tsx) |
| Slots | Use named slots when `label`, `description` or `message` need markup such as a link. | [./p-textarea/examples/Slots.tsx](./p-textarea/examples/Slots.tsx) |
