...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-input-time/examples/Default.tsx](./p-input-time/examples/Default.tsx) |
| Form | The `p-input-time` can be integrated into a form in two ways: **controlled** or **uncontrolled**, depending on your needs. | [./p-input-time/examples/Form.tsx](./p-input-time/examples/Form.tsx) |
| Slots | Use named slots when `label`, `description` or `message` need markup such as a link. | [./p-input-time/examples/Slots.tsx](./p-input-time/examples/Slots.tsx) |
