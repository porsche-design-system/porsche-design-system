...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-input-password/examples/Default.tsx](./p-input-password/examples/Default.tsx) |
| Form | The `p-input-password` can be integrated into a form in two ways: **controlled** or **uncontrolled**, depending on your needs. | [./p-input-password/examples/Form.tsx](./p-input-password/examples/Form.tsx) |
| Show password toggle button | If you want to show the password toggle button, you can pass `toggle="true"`. | [./p-input-password/examples/Toggle.tsx](./p-input-password/examples/Toggle.tsx) |
| Slots | Use named slots when `label`, `description` or `message` need markup such as a link. | [./p-input-password/examples/Slots.tsx](./p-input-password/examples/Slots.tsx) |
