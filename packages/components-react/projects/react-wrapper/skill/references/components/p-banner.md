...
| --- | --- | --- |
| Default | Minimal default configuration. | [./p-banner/examples/Default.tsx](./p-banner/examples/Default.tsx) |
| Customization | Rich content for `heading` and `description` can be provided via named slots. | [./p-banner/examples/Customization.tsx](./p-banner/examples/Customization.tsx) |
