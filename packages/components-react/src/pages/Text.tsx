...
export const TextPage = (): JSX.Element => {
  return (
    <>
      <div className="playground light" title="should show whole text in thin and bold">
      ...
      <div className="playground light" title="should show text with different color variants">
      ...
      <div className="playground light" title="should show text with different alignments">
      ...
      <div className="playground light" title="should show text with different slotted tags in same layout as default">
      ...
      <div className="playground light" title="should show text in different sizes">
      ...
      <div className="playground light" title="should show text in different sizes on different viewports">
