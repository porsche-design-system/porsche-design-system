...
export const generatedRoutes: RouteType[] = [
  ...
  },
  {
    name: 'Button Pure',
    path: '/button-pure',
    component: ButtonPurePage,
  },
  {
    name: 'Checkbox Wrapper',
    path: '/checkbox-wrapper',
    component: CheckboxWrapperPage,
  },
  {
    name: 'Content Wrapper',
    path: '/content-wrapper',
    component: ContentWrapperPage,
  },
  {
    name: 'Divider',
    path: '/divider',
  ...
  },
  {
    ...
    component: InlineNotificationPage,
  },
  {
    name: 'Link',
    path: '/link',
  ...
  },
  {
    name: 'Link Pure',
    path: '/link-pure',
    component: LinkPurePage,
  },
  {
    name: 'Link Social',
    path: '/link-social',
    component: LinkSocialPage,
  },
  {
    name: 'Marque',
    path: '/marque',
  ...
  },
  {
    ...
    component: ModalFullscreenBreakpointPage,
  },
  {
    name: 'Modal Full Width Slot',
    path: '/modal-full-width-slot',
    component: ModalFullWidthSlotPage,
  },
  {
    name: 'Modal No Heading',
    path: '/modal-no-heading',
    component: ModalNoHeadingPage,
  },
  {
    name: 'Modal Prefixed',
    path: '/modal-prefixed',
    component: ModalPrefixedPage,
  },
  {
    name: 'Modal Scrollable',
    path: '/modal-scrollable',
    component: ModalScrollablePage,
  },
  {
    name: 'Modal Slotted Heading',
    path: '/modal-slotted-heading',
    component: ModalSlottedHeadingPage,
  },
  {
    name: 'Pagination',
    path: '/pagination',
  ...
  },
  {
    ...
    component: RadioButtonWrapperPage,
  },
  {
    name: 'Select Wrapper',
    path: '/select-wrapper',
    component: SelectWrapperPage,
  },
  {
    name: 'Spinner',
    path: '/spinner',
  ...
  },
  {
    ...
    component: TextareaWrapperPage,
  },
  {
    name: 'Text Field Wrapper',
    path: '/text-field-wrapper',
    component: TextFieldWrapperPage,
  },
  {
    name: 'Text List',
    path: '/text-list',
