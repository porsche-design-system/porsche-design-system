  ...
  return (
    <>
      ...
      <div className="playground light" title="should show different background colors with button on light background">
        <PTagStatus color="default"><button>Tag default with link</button>></PTagStatus>
        <PTagStatus color="background-surface"><button>Tag background-surface with link</button>></PTagStatus>
      </div>

      <div className="playground light" title="should show different background colors with button and icon on light background">
        <PTagStatus icon="car" color="default"><button>Tag default with link</button>></PTagStatus>
        <PTagStatus icon="highway" color="background-surface"
          ><button>Tag background-surface with link</button>></PTagStatus
        >
      </div>
      ...
      <div className="playground dark" title="should show default tag on dark background">
      ...
      <div className="playground dark" title="should show different background colors and icons on light dark">
      ...
      <div className="playground dark" title="should show different background colors with button on dark background">
        <PTagStatus theme="dark" color="default"><button>Tag default with link</button>></PTagStatus>
      ...
      <div className="playground dark" title="should show different background colors with button and icon on dark background">
        <PTagStatus theme="dark" icon="car" color="default"><button>Tag default with link</button>></PTagStatus>
        <PTagStatus theme="dark" icon="highway" color="background-surface"
          ><button>Tag background-surface with link</button>></PTagStatus
        >
      </div>
