...
// TODO: renders slightly different compared to JS and Angular version (regression looks still good, maybe use vrt tolerance or ensure dom noes + styles are exactly the same in all framework implementations?)
