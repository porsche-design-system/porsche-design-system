...
const ESMBuildDirVanillaExtract = path.resolve(__dirname, './../../../dist/react-wrapper/vanilla-extract/esm');
...
describe('style package content', () => {
  ...
  test(`should match vanilla-extract content`, () => {
    const styles = nodeRequire('@porsche-design-system/components-react/vanilla-extract');
