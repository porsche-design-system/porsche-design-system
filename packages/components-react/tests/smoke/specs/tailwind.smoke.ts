...
const groupsToCheck = [
  {
    name: '/tailwindcss',
    paths: [
      '@porsche-design-system/components-react/tailwindcss',
      '@porsche-design-system/components-react/tailwindcss/index.css',
      '@porsche-design-system/components-react/tailwindcss/index',
  ...
  },
  {
    name: '/tailwindcss/cn',
    paths: [
      '@porsche-design-system/components-react/tailwindcss/cn',
      '@porsche-design-system/components-react/tailwindcss/cn/index.css',
      '@porsche-design-system/components-react/tailwindcss/cn/index',
