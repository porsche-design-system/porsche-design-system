...
export const getFontFaceCSS = (opts?: Options): string => {
  const url = `${opts?.cdn === 'cn' ? 'https://cdn.ui.porsche.cn' : 'https://cdn.ui.porsche.com'}/porsche-design-system/styles/${opts?.cdn === 'cn' ? 'font-face.min.cn.abdac883866edfff1d135131399118d9.css' : 'font-face.min.02a9c7ba97467baa51aa8a2ac5d1a777.css'}`;
