...
Within certain limits, it's also allowed to mix the Porsche Color Themes –
let's say, for example, you could integrate a larger Dark Theme area in your Light Theme 
to visually distinguish the footer from the content.
...
**Step 1**
Define, together with your team, which Porsche Color Theme you want to go for,
taking different factors into account, such as target group, use flows (visual
entry and exit of your application) or business goals, for example. Generally,
the Porsche Light Theme is the first choice.
To quickstart, you're welcome to use the Porsche UI Kit [Sketch layout template](#/basics/getting-started/start-designing).

**Step 2**
Build up your screen design, sticking to your Porsche Color Theme of choice.
