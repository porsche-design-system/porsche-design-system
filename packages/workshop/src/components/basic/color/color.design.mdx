...
The Porsche UI color palette includes both Brand Colors and Neutral Colors. They must always be used in full tone (100% opacity).
...
– going from tile background colors to text or icon colors.

The basic set consists of **8 grey shades** that are based on a pre-defined mixing ratio of black
(with reduced opacity in steady increments) in combination with a slightly touch of blue.
