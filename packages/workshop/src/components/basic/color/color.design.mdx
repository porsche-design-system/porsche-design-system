...
When designing Porsche UI applications, the first decision to make should be
...
**Porsche Dark Theme**. Depending on which Theme you're using, you should stick
...
Accordingly, the components provided within the Porsche UI Kit are optimized for 
the different color themes (see "light" and "dark" symbol namings in Sketch).
...
| [Color Badge] 	| **Porsche Red**        	| #D5001C 	| 213/0/28        	| Active state (such as selected items)  |
| [Color Badge] 	| **Porsche Dark Red**    	| #960014 	| 150/0/20       	| Hover state  |
| [Color Badge] 	| **Grey 4**            	| #96989A 	| 150/152/154     	| Disabled state  |

#### Additional elements
If you want to be on the "Level AA safe side" when coloring further architectonical elements, such as
dividers, smaller surfaces or 
...
1. Theming wählen → Theme-Mix möglich (Bsp. Einschübe/abgesetzte Bereiche auf Dunkel)
2. Informationslevel
