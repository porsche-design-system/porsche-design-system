...
## Static and flexible spacings

The Porsche UI Kit provides both static and flexible spacing. The two systems are built on the same definitions to complement the overall consistency but serve different roles. Additional increments can be added for specific needs as long as the 8 px spacing system is followed.

### Fixed spacing 
Spacings that do not need to change across different screen sizes.

| Variable      	| px    	| rem  	| example 	|
|------------	|-------	|------	|---------	|
| **spacing-4**  	| 4 px  	| 0.25 	| ![spacing 4](assets/workshop/layout/spacing/assets/spacing-4.png) |
| **spacing-8**  	| 8 px  	| 0.5  	| ![spacing 8](assets/workshop/layout/spacing/assets/spacing-8.png) |
| **spacing-16** 	| 16 px 	| 1    	| ![spacing 16](assets/workshop/layout/spacing/assets/spacing-16.png) |
| **spacing-24** 	| 24 px 	| 1.5  	| ![spacing 24](assets/workshop/layout/spacing/assets/spacing-24.png) |
| **spacing-32** 	| 32 px 	| 2    	| ![spacing 32](assets/workshop/layout/spacing/assets/spacing-32.png) |
| **spacing-40** 	| 40 px 	| 2.5  	| ![spacing 40](assets/workshop/layout/spacing/assets/spacing-40.png) |
| **spacing-48** 	| 48 px 	| 3    	| ![spacing 48](assets/workshop/layout/spacing/assets/spacing-48.png) |
| **spacing-56** 	| 56 px 	| 3.5  	| ![spacing 56](assets/workshop/layout/spacing/assets/spacing-56.png) |
| **spacing-64** 	| 64 px 	| 4    	| ![spacing 64](assets/workshop/layout/spacing/assets/spacing-64.png) |
| **spacing-72** 	| 72 px 	| 4.5  	| ![spacing 72](assets/workshop/layout/spacing/assets/spacing-72.png) |
| **spacing-80** 	| 80 px 	| 5    	| ![spacing 80](assets/workshop/layout/spacing/assets/spacing-80.png) |

### Flexible spacing 
Spacings that changes in accordance with the screen size at defined breakpoint widths.

| Variable | 320 - 759 px | 760 - 999 px | 1000 - 1299 px | 1300 - 1759 px | 1760  px or larger  |
| -------- | --- | --- | --- | --- | --- |
