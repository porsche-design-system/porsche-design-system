...
/**
 * A flex item of a flex container.
 */
export const FlexItem: React.FunctionComponent<FlexItemProps> = (props) => {
  ...
  const classes = cx(
    prefix("flex__item"),
    mapBreakpointPropToClasses("flex__item--align-self", alignSelf),
    mapBreakpointPropToClasses("flex__item--width", width),
    mapBreakpointPropToClasses("flex__item--offset", offset),
    mapBreakpointPropToClasses("flex__item--shrink", shrink),
    mapBreakpointPropToClasses("flex__item--grow", grow),
    mapBreakpointPropToClasses("flex__item-", flex),
    className
  );
