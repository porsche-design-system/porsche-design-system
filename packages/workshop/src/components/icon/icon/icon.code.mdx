...
The default icon size has a box of 24x24px (1.5rem) which corresponds to the default copytext line-height. If larger sizes are needed, choose from one of the predefined sizes.
