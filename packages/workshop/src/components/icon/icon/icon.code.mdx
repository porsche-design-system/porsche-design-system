...
<Example noTheme>
  {(theme) => {
    return (
      <React.Fragment>
        <Icon name="icon_360_Grad.min.svg" />
      </React.Fragment>
    )
}}
</Example>
...
<Example noTheme>
  {(theme) => {
    return (
      <React.Fragment>
        <Icon name="icon_360_Grad.min.svg" size="x-small" />
        <Icon name="icon_360_Grad.min.svg" size="small" />
        <Icon name="icon_360_Grad.min.svg" size="medium" />
        <Icon name="icon_360_Grad.min.svg" size="large" />
        <Icon name="icon_360_Grad.min.svg" size="x-large" />
      </React.Fragment>
    )
}}
</Example>
